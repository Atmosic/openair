namespace eval MPC_FLS_SECURE {
    namespace export BASE
    proc BASE {} {
	return 0x50114000
    }
    namespace export BLK_MAX
    proc BLK_MAX { {base [::MPC_FLS_SECURE::BASE]}} {
	return [expr { [expr $base] + 0x10 }]
    }
    namespace eval BLK_MAX {
	namespace export REG_ADDR
	proc REG_ADDR { {base [::MPC_FLS_SECURE::BASE]} } {
	    return [expr { [expr $base] + 0x10 }]
	}
	namespace eval BLK_MAX {
    ...
    proc BLK_CFG { {base [::MPC_FLS_SECURE::BASE]}} {
    ...
    proc BLK_IDX { {base [::MPC_FLS_SECURE::BASE]}} {
