namespace eval CMSDK_SHA2_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40103000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval SHA_EN {
    ...
    proc SIDELOAD_CTRL { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    namespace eval SIDELOAD_CTRL {
        ...
        namespace eval SIDELOAD_PTR_CLR {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    proc CMD { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    namespace export MESSAGE_LENGTH_LO
    proc MESSAGE_LENGTH_LO { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0xc }]
    }
    namespace eval MESSAGE_LENGTH_LO {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0xc }]
        }
        namespace eval LENGTH_LO {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export MESSAGE_LENGTH_HI
    proc MESSAGE_LENGTH_HI { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x10 }]
    }
    namespace eval MESSAGE_LENGTH_HI {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x10 }]
        }
        namespace eval LENGTH_HI {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export WIPE_V
    proc WIPE_V { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x14 }]
    }
    namespace eval WIPE_V {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x14 }]
        }
    ...
    namespace export FIFO_PUSH
    proc FIFO_PUSH { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x18 }]
    }
    namespace eval FIFO_PUSH {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x18 }]
        }
    ...
    namespace export DIGEST0
    proc DIGEST0 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x1c }]
    }
    namespace eval DIGEST0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x1c }]
        }
    ...
    namespace export DIGEST1
    proc DIGEST1 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x20 }]
    }
    namespace eval DIGEST1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x20 }]
        }
    ...
    namespace export DIGEST2
    proc DIGEST2 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x24 }]
    }
    namespace eval DIGEST2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x24 }]
        }
    ...
    namespace export DIGEST3
    proc DIGEST3 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x28 }]
    }
    namespace eval DIGEST3 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x28 }]
        }
    ...
    namespace export DIGEST4
    proc DIGEST4 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x2c }]
    }
    namespace eval DIGEST4 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x2c }]
        }
    ...
    namespace export DIGEST5
    proc DIGEST5 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x30 }]
    }
    namespace eval DIGEST5 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x30 }]
        }
    ...
    namespace export DIGEST6
    proc DIGEST6 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x34 }]
    }
    namespace eval DIGEST6 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x34 }]
        }
    ...
    namespace export DIGEST7
    proc DIGEST7 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x38 }]
    }
    namespace eval DIGEST7 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x38 }]
        }
    ...
    namespace export KEY_0
    proc KEY_0 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x3c }]
    }
    namespace eval KEY_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x3c }]
        }
    ...
    namespace export KEY_1
    proc KEY_1 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x40 }]
    }
    namespace eval KEY_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x40 }]
        }
    ...
    namespace export KEY_2
    proc KEY_2 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x44 }]
    }
    namespace eval KEY_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x44 }]
        }
    ...
    namespace export KEY_3
    proc KEY_3 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x48 }]
    }
    namespace eval KEY_3 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x48 }]
        }
    ...
    namespace export KEY_4
    proc KEY_4 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x4c }]
    }
    namespace eval KEY_4 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x4c }]
        }
    ...
    namespace export KEY_5
    proc KEY_5 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x50 }]
    }
    namespace eval KEY_5 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x50 }]
        }
    ...
    namespace export KEY_6
    proc KEY_6 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x54 }]
    }
    namespace eval KEY_6 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x54 }]
        }
    ...
    namespace export KEY_7
    proc KEY_7 { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x58 }]
    }
    namespace eval KEY_7 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x58 }]
        }
    ...
    proc STATUS { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    namespace eval STATUS {
        ...
        namespace eval HASH_COMPUTE_BUSY {
            namespace export SHIFT
            proc SHIFT {} {
                return 13
            }
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
    ...
    namespace export ERR_CODE
    proc ERR_CODE { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x70 }]
    }
    namespace eval ERR_CODE {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x70 }]
        }
    ...
    namespace export TXCOUNT_LO
    proc TXCOUNT_LO { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x74 }]
    }
    namespace eval TXCOUNT_LO {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x74 }]
        }
        namespace eval COUNT_LO {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export TXCOUNT_HI
    proc TXCOUNT_HI { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x78 }]
    }
    namespace eval TXCOUNT_HI {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x78 }]
        }
        namespace eval COUNT_HI {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export SHA_TXCOUNT_LO
    proc SHA_TXCOUNT_LO { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x7c }]
    }
    namespace eval SHA_TXCOUNT_LO {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x7c }]
        }
    ...
    namespace export SHA_TXCOUNT_HI
    proc SHA_TXCOUNT_HI { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x80 }]
    }
    namespace eval SHA_TXCOUNT_HI {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x80 }]
        }
    ...
    namespace export ID
    proc ID { {base [::CMSDK_SHA2_NONSECURE::BASE]} } {
