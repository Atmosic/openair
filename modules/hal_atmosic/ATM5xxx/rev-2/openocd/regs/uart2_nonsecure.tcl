namespace eval CMSDK_UART2_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40168000
    }
    namespace export DATA
    proc DATA { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval DATA {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval DATA {
    ...
    proc STATE { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CTRL { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc INTSTATUS_CLEAR { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc BAUDDIV { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc RX_LWM { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc TX_LWM { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc RX_FIFO_SPACES { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc TX_FIFO_SPACES { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc HW_FLOW_OVRD { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc BAUD_RATE_DETECT { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc BAUD_DIV_CEIL { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc BRD_STAT { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc INTMASK { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc RX_FIFO_ENTRIES { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc INTSTATUS_SET { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc TX_CTRL { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc RX_CTRL { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID4 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID5 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID6 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID7 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID0 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID1 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID2 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc PID3 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CID0 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CID1 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CID2 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CID3 { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_UART2_NONSECURE::BASE]} } {
