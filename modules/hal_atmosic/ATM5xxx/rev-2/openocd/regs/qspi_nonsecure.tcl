namespace eval CMSDK_QSPI_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x4014f000
    }
    namespace export TRANSACTION_SETUP
    proc TRANSACTION_SETUP { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval TRANSACTION_SETUP {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc READ_DATA { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc OVERRIDE_DIN { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc MODE { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    namespace export SCRATCHPAD
    proc SCRATCHPAD { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_2 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_3 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_4 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    namespace eval REMOTE_AHB_SETUP_4 {
        ...
        namespace eval ALLOW_READS_DURING_WRITE {
            namespace export SHIFT
            proc SHIFT {} {
                return 28
            }
    ...
    proc REMOTE_AHB_SETUP_5 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_6 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_7 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    namespace export REMOTE_AHB_SETUP_8
    proc REMOTE_AHB_SETUP_8 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x30 }]
    }
    namespace eval REMOTE_AHB_SETUP_8 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x30 }]
        }
        namespace eval PP_STALL_WIP_MSB {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval OPCODE_DUALREAD {
            namespace export SHIFT
            proc SHIFT {} {
                return 8
            }
        ...
        namespace eval OPCODE_QUADREAD {
            namespace export SHIFT
            proc SHIFT {} {
                return 16
            }
    ...
    namespace export REMOTE_AHB_SETUP_9
    proc REMOTE_AHB_SETUP_9 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x34 }]
    }
    namespace eval REMOTE_AHB_SETUP_9 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x34 }]
        }
    ...
    namespace export REMOTE_AHB_SETUP_10
    proc REMOTE_AHB_SETUP_10 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x38 }]
    }
    namespace eval REMOTE_AHB_SETUP_10 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x38 }]
        }
        ...
        namespace eval MAX_CNT_TWEL {
            ...
            namespace export READ
            proc READ {reg_val} {
                return [expr {($reg_val & 0x0003ff00) >> 8}]
            }
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 8) & 0x0003ff00}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x0003ff00) | (($field_val << 8) & 0x0003ff00)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x0003ff00) | (($field_val << 8) & 0x0003ff00)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 8) & ~0x0003ff00)}]
    ...
    namespace export REMOTE_AHB_SETUP_11
    proc REMOTE_AHB_SETUP_11 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x3c }]
    }
    namespace eval REMOTE_AHB_SETUP_11 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x3c }]
        }
        namespace eval SLIP_ONE_CYCLE {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval TURBO_MULTIPLIER {
            namespace export SHIFT
            proc SHIFT {} {
                return 4
            }
        ...
        namespace eval ALLOW_EARLY_TERMINATE0 {
            namespace export SHIFT
            proc SHIFT {} {
                return 7
            }
        ...
        namespace eval ALLOW_EARLY_TERMINATE1 {
            namespace export SHIFT
            proc SHIFT {} {
                return 8
            }
    ...
    namespace export REMOTE_PREFETCH_SETUP
    proc REMOTE_PREFETCH_SETUP { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x40 }]
    }
    namespace eval REMOTE_PREFETCH_SETUP {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x40 }]
        }
        namespace eval CL_SIZE {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval CSN_EXT_VAL {
            ...
            namespace export READ
            proc READ {reg_val} {
                return [expr {($reg_val & 0x00003ff0) >> 4}]
            }
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 4) & 0x00003ff0}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x00003ff0) | (($field_val << 4) & 0x00003ff0)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x00003ff0) | (($field_val << 4) & 0x00003ff0)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 4) & ~0x00003ff0)}]
        ...
        namespace eval SOFT_EN_DEF_BFULL {
            namespace export SHIFT
            proc SHIFT {} {
                return 14
            }
        ...
        namespace eval SOFT_DEFNUM_OF_BFULL {
            namespace export SHIFT
            proc SHIFT {} {
                return 16
            }
        ...
        namespace eval ENABLE_PREFETCH {
            namespace export SHIFT
            proc SHIFT {} {
                return 20
            }
        ...
        namespace eval WAIT_ONGOING_THLD {
            namespace export SHIFT
            proc SHIFT {} {
                return 24
            }
        ...
        namespace eval WAIT_ONGOING_FETCH_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 28
            }
    ...
    namespace export REMOTE_CACHE_SETUP
    proc REMOTE_CACHE_SETUP { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x44 }]
    }
    namespace eval REMOTE_CACHE_SETUP {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x44 }]
        }
        namespace eval CACHEABLE_LOW {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval CACHEABLE_UPPER {
            namespace export SHIFT
            proc SHIFT {} {
                return 16
            }
        ...
        namespace eval CACHE_ON_WRITE_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 31
            }
    ...
    namespace export REMOTE_STATUS
    proc REMOTE_STATUS { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x48 }]
    }
    namespace eval REMOTE_STATUS {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x48 }]
        }
        namespace eval PREFETCH_BUSY {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export REMOTE_PREFETCH_STATUS
    proc REMOTE_PREFETCH_STATUS { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x4c }]
    }
    namespace eval REMOTE_PREFETCH_STATUS {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x4c }]
        }
    ...
    proc REMOTE_AHB_WLE_CNT { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REMOTE_AHB_WIP_CNT { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    namespace export REMOTE_STS_CTRL0
    proc REMOTE_STS_CTRL0 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x58 }]
    }
    namespace eval REMOTE_STS_CTRL0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x58 }]
        }
        namespace eval PREFETCH_STS_ENABLE {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval CACHE_STS_ENABLE {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
    ...
    namespace export REMOTE_STS_CTRL1
    proc REMOTE_STS_CTRL1 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x5c }]
    }
    namespace eval REMOTE_STS_CTRL1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x5c }]
        }
        namespace eval PREFETCH_STS_CLEAR {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval CACHE_STS_CLEAR {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
    ...
    namespace export PREFETCH_STS_CNT0
    proc PREFETCH_STS_CNT0 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x60 }]
    }
    namespace eval PREFETCH_STS_CNT0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x60 }]
        }
        namespace eval PREFETCH_EVENT_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PREFETCH_STS_CNT1
    proc PREFETCH_STS_CNT1 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x64 }]
    }
    namespace eval PREFETCH_STS_CNT1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x64 }]
        }
        namespace eval PREFETCH_HIT_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PREFETCH_STS_CNT2
    proc PREFETCH_STS_CNT2 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x68 }]
    }
    namespace eval PREFETCH_STS_CNT2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x68 }]
        }
        namespace eval PREFETCH_FLUSH_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PREFETCH_STS_CNT3
    proc PREFETCH_STS_CNT3 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x6c }]
    }
    namespace eval PREFETCH_STS_CNT3 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x6c }]
        }
        namespace eval PREFETCH_FLUSH_WRD_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PREFETCH_STS_CNT4
    proc PREFETCH_STS_CNT4 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x70 }]
    }
    namespace eval PREFETCH_STS_CNT4 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x70 }]
        }
        namespace eval PREFETCH_WORD_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PREFETCH_STS_CNT5
    proc PREFETCH_STS_CNT5 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x74 }]
    }
    namespace eval PREFETCH_STS_CNT5 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x74 }]
        }
        namespace eval PREFETCH_F2NF_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export CACHE_STS_CNT0
    proc CACHE_STS_CNT0 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x78 }]
    }
    namespace eval CACHE_STS_CNT0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x78 }]
        }
        namespace eval CACHE_REQ_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export CACHE_STS_CNT1
    proc CACHE_STS_CNT1 { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x7c }]
    }
    namespace eval CACHE_STS_CNT1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x7c }]
        }
        namespace eval CACHE_HIT_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export BURST_PP_CTRL
    proc BURST_PP_CTRL { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x80 }]
    }
    namespace eval BURST_PP_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x80 }]
        }
        namespace eval BYTE_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    proc CORE_ID { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_QSPI_NONSECURE::BASE]} } {
