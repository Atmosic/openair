namespace eval CMSDK_UART1_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40145000
    }
    namespace export DATA
    proc DATA { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval DATA {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval DATA {
    ...
    proc STATE { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CTRL { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc INTSTATUS_CLEAR { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    namespace eval INTSTATUS_CLEAR {
        ...
        namespace eval RX_STOP_BITS_ERR {
            namespace export SHIFT
            proc SHIFT {} {
                return 5
            }
    ...
    proc BAUDDIV { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc RX_LWM { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc TX_LWM { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc RX_FIFO_SPACES { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc TX_FIFO_SPACES { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc HW_FLOW_OVRD { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc BAUD_RATE_DETECT { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc BAUD_DIV_CEIL { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc BRD_STAT { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc INTMASK { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    namespace eval INTMASK {
        ...
        namespace eval RX_PARITY_ERR_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 4
            }
        ...
        namespace eval RX_STOP_BITS_ERR_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 5
            }
    ...
    proc RX_FIFO_ENTRIES { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc INTSTATUS_SET { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    namespace export TX_CTRL
    proc TX_CTRL { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x40 }]
    }
    namespace eval TX_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x40 }]
        }
        namespace eval PARITY_ENABLE {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval PARITY_ODDNEVEN {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
        ...
        namespace eval HAS_2_STOP_BITS {
            namespace export SHIFT
            proc SHIFT {} {
                return 2
            }
    ...
    namespace export RX_CTRL
    proc RX_CTRL { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x44 }]
    }
    namespace eval RX_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x44 }]
        }
    ...
    proc PID4 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID5 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID6 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID7 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID0 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID1 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID2 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc PID3 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CID0 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CID1 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CID2 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CID3 { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_UART1_NONSECURE::BASE]} } {
