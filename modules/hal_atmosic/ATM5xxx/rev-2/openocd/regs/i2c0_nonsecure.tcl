namespace eval CMSDK_I2C0_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40150000
    }
    namespace export CTRL
    proc CTRL { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval S_ID_SEL {
    ...
    proc TRANSACTION_SETUP { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc CLOCK_CONTROL { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    namespace eval CLOCK_CONTROL {
        ...
        namespace eval CLK_STRETCH_DUR {
            namespace export SHIFT
            proc SHIFT {} {
                return 13
            }
    ...
    proc OUTGOING_DATA { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc OUTGOING_DATA1 { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc IO_CTRL { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc INCOMING_DATA { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc INCOMING_DATA1 { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc TRANSACTION_STATUS { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    namespace export ID
    proc ID { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_I2C0_NONSECURE::BASE]} } {
