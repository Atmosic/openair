namespace eval CMSDK_RADIO_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40155000
    }
    namespace export CTRL
    proc CTRL { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval MSTR {
        ...
        namespace eval S_ADR_AUTOINC_DIS {
            namespace export SHIFT
            proc SHIFT {} {
                return 24
            }
    ...
    proc TRANSACTION_SETUP { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    namespace eval TRANSACTION_SETUP {
        ...
        namespace eval CLKDIV {
            ...
            namespace export READ
            proc READ {reg_val} {
                return [expr {($reg_val & 0x0000ffc0) >> 6}]
            }
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 6) & 0x0000ffc0}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x0000ffc0) | (($field_val << 6) & 0x0000ffc0)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x0000ffc0) | (($field_val << 6) & 0x0000ffc0)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 6) & ~0x0000ffc0)}]
    ...
    namespace export TRANSACTION_SETUP_2
    proc TRANSACTION_SETUP_2 { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x8 }]
    }
    namespace eval TRANSACTION_SETUP_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x8 }]
        }
        namespace eval DUMMY_CYCLES_MSB {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export TRANSACTION_SETUP_DMA
    proc TRANSACTION_SETUP_DMA { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0xc }]
    }
    namespace eval TRANSACTION_SETUP_DMA {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0xc }]
        }
    ...
    proc TRANSACTION_STATUS { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    namespace export DATA_BYTES_LOWER
    proc DATA_BYTES_LOWER { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x14 }]
    }
    namespace eval DATA_BYTES_LOWER {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x14 }]
        }
        namespace eval BYTE0 {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export DATA_BYTES_UPPER
    proc DATA_BYTES_UPPER { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x18 }]
    }
    namespace eval DATA_BYTES_UPPER {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x18 }]
        }
        namespace eval BYTE4 {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    namespace eval RESET_INTERRUPT {
        ...
        namespace eval RESET_INTERRUPT3 {
            namespace export SHIFT
            proc SHIFT {} {
                return 3
            }
    ...
    proc CORE_ID { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_RADIO_NONSECURE::BASE]} } {
