namespace eval CMSDK_BIQUAD_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x4016d000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    namespace export X
    proc X { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    namespace export Y
    proc Y { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B0_HI { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B0_LO { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B1_HI { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B1_LO { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B2_HI { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc B2_LO { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc A1_HI { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc A1_LO { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc A2_HI { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc A2_LO { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_BIQUAD_NONSECURE::BASE]} } {
