namespace eval CMSDK_CLKRSTGEN_NONSECURE {
    ...
    proc RADIO_STATUS { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc ATLC_LP_CTRL_0 { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc ATLC_LP_CTRL_1 { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc FSM_CTRL { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc FSM_WAIT4DOUBLER { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc FSM_STATUS { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc XTAL_BITS0 { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    namespace eval XTAL_BITS0 {
        ...
        namespace eval CLK_CP_SRC_CAIRO {
            namespace export SHIFT
            proc SHIFT {} {
                return 21
            }
    ...
    proc XTAL_BITS1 { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc PLL { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc IRQ_MASK { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc IRQ_SET { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc IRQ_CLR { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc IRQ_STATUS { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc ATLC_LP_CTRL_2 { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc ATLC_LP_FRAC_RESIDUE { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc CLKSYNC_STATUS { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    namespace export HARV_CTRL
    proc HARV_CTRL { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x68 }]
    }
    namespace eval HARV_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x68 }]
        }
        namespace eval HARV_IND_SEL {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export QSPI_CLK_CTRL
    proc QSPI_CLK_CTRL { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x6c }]
    }
    namespace eval QSPI_CLK_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x6c }]
        }
    ...
    namespace export QSPI_STAT
    proc QSPI_STAT { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x70 }]
    }
    namespace eval QSPI_STAT {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x70 }]
        }
        namespace eval CLK_ACTV_REQ {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    proc REV_HASH { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_CLKRSTGEN_NONSECURE::BASE]} } {
