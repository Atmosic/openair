namespace eval CMSDK_SHA2_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50103000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_SHA2_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SHA2_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc SIDELOAD_CTRL { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc CMD { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc MESSAGE_LENGTH_LO { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc MESSAGE_LENGTH_HI { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc WIPE_V { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc FIFO_PUSH { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST0 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST1 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST2 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST3 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST4 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST5 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST6 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc DIGEST7 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_0 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_1 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_2 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_3 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_4 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_5 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_6 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc KEY_7 { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc STATUS { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc ERR_CODE { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc TXCOUNT_LO { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc TXCOUNT_HI { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc SHA_TXCOUNT_LO { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    proc SHA_TXCOUNT_HI { {base [::CMSDK_SHA2_SECURE::BASE]} } {
    ...
    namespace export ID
    proc ID { {base [::CMSDK_SHA2_SECURE::BASE]} } {
