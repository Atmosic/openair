namespace eval CMSDK_QSPI_SECURE {
    ...
    proc SCRATCHPAD { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_8 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_9 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_10 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_AHB_SETUP_11 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_PREFETCH_SETUP { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_CACHE_SETUP { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_STATUS { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_PREFETCH_STATUS { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_STS_CTRL0 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_STS_CTRL1 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT0 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT1 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT2 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT3 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT4 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STS_CNT5 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc CACHE_STS_CNT0 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc CACHE_STS_CNT1 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc BURST_PP_CTRL { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_QSPI_SECURE::BASE]} } {
