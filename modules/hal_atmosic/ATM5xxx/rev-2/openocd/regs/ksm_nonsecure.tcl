namespace eval CMSDK_KSM_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x4014a000
    }
    namespace export CTRL0
    proc CTRL0 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CTRL0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval GO {
        ...
        namespace eval KSM_NOT_EMPTY_TO_INTRPT {
            namespace export SHIFT
            proc SHIFT {} {
                return 12
            }
    ...
    namespace export TIME_PARAM0
    proc TIME_PARAM0 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x4 }]
    }
    namespace eval TIME_PARAM0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x4 }]
        }
    ...
    namespace export TIME_PARAM1
    proc TIME_PARAM1 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x8 }]
    }
    namespace eval TIME_PARAM1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x8 }]
        }
    ...
    namespace export MATRIX_SIZE
    proc MATRIX_SIZE { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0xc }]
    }
    namespace eval MATRIX_SIZE {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0xc }]
        }
        namespace eval NUM_COL {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export KEYBOARD_IDLE_CTRL
    proc KEYBOARD_IDLE_CTRL { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x38 }]
    }
    namespace eval KEYBOARD_IDLE_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x38 }]
        }
        namespace eval IDLE_INTR_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export KEYBOARD_CYCLE
    proc KEYBOARD_CYCLE { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x3c }]
    }
    namespace eval KEYBOARD_CYCLE {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x3c }]
        }
        namespace eval CURR_ROW {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export KEYBOARD_PACKET
    proc KEYBOARD_PACKET { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x40 }]
    }
    namespace eval KEYBOARD_PACKET {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x40 }]
        }
        ...
        namespace eval PRESSED_RELEASED_N {
            namespace export SHIFT
            proc SHIFT {} {
                return 10
            }
    ...
    namespace export LOW_POWER
    proc LOW_POWER { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x44 }]
    }
    namespace eval LOW_POWER {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x44 }]
        }
    ...
    namespace export LPBACK_KSI
    proc LPBACK_KSI { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x58 }]
    }
    namespace eval LPBACK_KSI {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x58 }]
        }
    ...
    proc STATUS { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    proc INTERRUPTS { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_CLEAR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    namespace export KEY_BUF0
    proc KEY_BUF0 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x100 }]
    }
    namespace eval KEY_BUF0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x100 }]
        }
    ...
    namespace export KEY_BUF1
    proc KEY_BUF1 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x104 }]
    }
    namespace eval KEY_BUF1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x104 }]
        }
    ...
    namespace export KEY_BUF2
    proc KEY_BUF2 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x108 }]
    }
    namespace eval KEY_BUF2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x108 }]
        }
    ...
    namespace export KEY_BUF3
    proc KEY_BUF3 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x10c }]
    }
    namespace eval KEY_BUF3 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x10c }]
        }
    ...
    namespace export KEY_BUF4
    proc KEY_BUF4 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x110 }]
    }
    namespace eval KEY_BUF4 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x110 }]
        }
    ...
    namespace export KEY_BUF5
    proc KEY_BUF5 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x114 }]
    }
    namespace eval KEY_BUF5 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x114 }]
        }
    ...
    namespace export KEY_BUF6
    proc KEY_BUF6 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x118 }]
    }
    namespace eval KEY_BUF6 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x118 }]
        }
    ...
    namespace export KEY_BUF7
    proc KEY_BUF7 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x11c }]
    }
    namespace eval KEY_BUF7 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x11c }]
        }
    ...
    namespace export KEY_BUF8
    proc KEY_BUF8 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x120 }]
    }
    namespace eval KEY_BUF8 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x120 }]
        }
    ...
    namespace export KEY_BUF9
    proc KEY_BUF9 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x124 }]
    }
    namespace eval KEY_BUF9 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x124 }]
        }
    ...
    namespace export KEY_BUF10
    proc KEY_BUF10 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x128 }]
    }
    namespace eval KEY_BUF10 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x128 }]
        }
    ...
    namespace export KEY_BUF11
    proc KEY_BUF11 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x12c }]
    }
    namespace eval KEY_BUF11 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x12c }]
        }
    ...
    proc DEBUG { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    namespace export DEBUG2
    proc DEBUG2 { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0xff0 }]
    }
    namespace eval DEBUG2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0xff0 }]
        }
    ...
    proc CORE_ID { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_KSM_NONSECURE::BASE]} } {
