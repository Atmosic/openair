namespace eval CMSDK_AES_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50167000
    }
    namespace export ALERT_TEST
    proc ALERT_TEST { {base [::CMSDK_AES_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval ALERT_TEST {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_AES_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc KEY_SHARE0_0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_4 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_5 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_6 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE0_7 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_4 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_5 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_6 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc KEY_SHARE1_7 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IV_0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IV_1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IV_2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IV_3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_IN_0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_IN_1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_IN_2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_IN_3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_OUT_0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_OUT_1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_OUT_2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc DATA_OUT_3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CTRL_SHADOWED { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc TRIGGER { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc STATUS { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc A_BLK_START { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc A_BLK_END { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B_BLK_START { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B_BLK_END { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_ENC_MIC_W0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_ENC_MIC_W1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_ENC_MIC_W2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_ENC_MIC_W3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_MIC_W0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_MIC_W1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_MIC_W2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_MIC_W3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_DATAOUT { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_DATAIN { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc CCM_CTRL { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B0_FORMAT_W0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B0_FORMAT_W1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B0_FORMAT_W2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B0_FORMAT_W3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B1_FORMAT_W0 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B1_FORMAT_W1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B1_FORMAT_W2 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc B1_FORMAT_W3 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc PYLD_SIZE { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IRQ_STATUS { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IRQ_MASK { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc IRQ_CLR { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc STATUS1 { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc SIDELOAD_CTRL { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    namespace export ID
    proc ID { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_AES_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_AES_SECURE::BASE]} } {
