namespace eval CMSDK_WRPR2_NONSECURE {
    ...
    proc OTP_INIT_LOWER { {base [::CMSDK_WRPR2_NONSECURE::BASE]} } {
    ...
    proc OTP_INIT_UPPER { {base [::CMSDK_WRPR2_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_WRPR2_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_WRPR2_NONSECURE::BASE]} } {
