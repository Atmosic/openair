namespace eval CMSDK_I2S_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40165000
    }
    namespace export I2S_CTRL0
    proc I2S_CTRL0 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval I2S_CTRL0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc I2S_CTRL1_TX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL1_RX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL2_TX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL2_RX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL3 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL4 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL5_TX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_CTRL5_RX { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_INTRP_CTRL { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_PP1_RDATA { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_PP0_WDATA { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_PP1_CTRL { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_PP0_CTRL { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQ0 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQM0 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQS0 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQC0 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQ1 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQM1 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQS1 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_IRQC1 { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc BUFFER_DEPTH { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc PP_ST { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    namespace export PP0_ST
    proc PP0_ST { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x60 }]
    }
    namespace eval PP0_ST {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x60 }]
        }
        namespace eval RD_ADDR {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PP1_ST
    proc PP1_ST { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x64 }]
    }
    namespace eval PP1_ST {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x64 }]
        }
    ...
    proc I2S_SPARE { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc I2S_DBG { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    namespace export ID
    proc ID { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_I2S_NONSECURE::BASE]} } {
