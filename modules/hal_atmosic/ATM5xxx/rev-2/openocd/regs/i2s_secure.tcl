namespace eval CMSDK_I2S_SECURE {
    ...
    proc PP0_ST { {base [::CMSDK_I2S_SECURE::BASE]} } {
    ...
    proc PP1_ST { {base [::CMSDK_I2S_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_I2S_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_I2S_SECURE::BASE]} } {
