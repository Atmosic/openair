namespace eval CMSDK_RIF_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50154000
    }
    namespace export BIAS
    proc BIAS { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval BIAS {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc RXBBF { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXBBF_1M { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXBBF_2M { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX_MODGAIN { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX_VCOCAP { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc LNA { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RGT { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RGTHW { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN4 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN5 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN6 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN7 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN8 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN9 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN10 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN11 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN12 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN13 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN14 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXGAIN15 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace export TRNG_CONF
    proc TRNG_CONF { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x74 }]
    }
    namespace eval TRNG_CONF {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x74 }]
        }
        namespace eval FORCE_BBGAIN {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval BB2GAIN_CALRX {
            ...
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x000000f8) | (($field_val << 3) & 0x000000f8)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 3) & ~0x000000f8)}]
        ...
        namespace eval SYNTHON_DURING_TRNG {
            namespace export SHIFT
            proc SHIFT {} {
                return 26
            }
        ...
        namespace eval FORCE_DUAL_MODE {
            namespace export SHIFT
            proc SHIFT {} {
                return 27
            }
    ...
    proc SYNTX_CAL { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace export SYNTX_154
    proc SYNTX_154 { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x7c }]
    }
    namespace eval SYNTX_154 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x7c }]
        }
        namespace eval USE154DPD {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval SCALETXMODHF154DPD {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
        ...
        namespace eval TXMODGAIN154DPD {
            namespace export SHIFT
            proc SHIFT {} {
                return 9
            }
        ...
        namespace eval MODVARSIZE154DPD {
            namespace export SHIFT
            proc SHIFT {} {
                return 14
            }
        ...
        namespace eval MODVARBIAS154DPD {
            namespace export SHIFT
            proc SHIFT {} {
                return 18
            }
        ...
        namespace eval TXMODGAIN154DPD_OVR {
            namespace export SHIFT
            proc SHIFT {} {
                return 22
            }
    ...
    proc SYNTX0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTX4 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace eval SYNTX4 {
        ...
        namespace eval MOD_IDX {
            ...
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 13) & 0x001fe000}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x001fe000) | (($field_val << 13) & 0x001fe000)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x001fe000) | (($field_val << 13) & 0x001fe000)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 13) & ~0x001fe000)}]
        ...
        namespace eval MODVARBIAS_1M {
            ...
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 23) & 0x07800000}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x07800000) | (($field_val << 23) & 0x07800000)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x07800000) | (($field_val << 23) & 0x07800000)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 23) & ~0x07800000)}]
    ...
    proc SYNTX5 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace export SYNTX6
    proc SYNTX6 { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x98 }]
    }
    namespace eval SYNTX6 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x98 }]
        }
        namespace eval LOOPREFERENCEFREQUENCY_CS {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval VCOAGCENGAIN_CS {
            namespace export SHIFT
            proc SHIFT {} {
                return 3
            }
    ...
    proc DUTY_CYCLE { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN0_PMU { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN1_PMU { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TXGAIN2_PMU { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RX0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TIMER0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TIMER1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TIMER2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc TIMER3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace export TIMER154
    proc TIMER154 { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0xc0 }]
    }
    namespace eval TIMER154 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0xc0 }]
        }
    ...
    proc HADM_TIMER0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc HADM_TIMER1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc HADM_TIMER2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc HADM_TIMER3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc RXDC7 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN0 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN1 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN3 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN4 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc SYNTH_CHAN5 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc ADC_CNTL { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc MODE_CNTL { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc MODE_CNTL2 { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace eval MODE_CNTL2 {
        ...
        namespace eval HADM_SYNTH_FORCE_BW2 {
            namespace export SHIFT
            proc SHIFT {} {
                return 3
            }
        ...
        namespace eval IEEE154_SYNTH_OVR {
            namespace export SHIFT
            proc SHIFT {} {
                return 17
            }
        ...
        namespace eval SEQUENCED_SYNTHON_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 18
            }
        ...
        namespace eval SEQUENCED_SYNTHON_DELAY {
            namespace export SHIFT
            proc SHIFT {} {
                return 19
            }
        ...
        namespace eval FORCE_INT_RXGAIN {
            namespace export SHIFT
            proc SHIFT {} {
                return 23
            }
        ...
        namespace eval FORCE_INT_RX_EN {
            namespace export SHIFT
            proc SHIFT {} {
                return 24
            }
    ...
    proc XLNA_XPA_CNTL { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc CAL_CNTL { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc CAL_DONE { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace eval INTERRUPT_STATUS {
        ...
        namespace eval CALTX_DONE_IRQ_STATUS {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc INTERRUPT_RESET { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc DFT { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    namespace export RIF_I_TEST
    proc RIF_I_TEST { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x118 }]
    }
    namespace eval RIF_I_TEST {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x118 }]
        }
    ...
    namespace export RIF_Q_TEST
    proc RIF_Q_TEST { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x11c }]
    }
    namespace eval RIF_Q_TEST {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x11c }]
        }
    ...
    namespace export SYNTX_COMLIF
    proc SYNTX_COMLIF { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x120 }]
    }
    namespace eval SYNTX_COMLIF {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x120 }]
        }
        namespace eval USE_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval SCALETXMODHF_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
        ...
        namespace eval TXMODGAIN_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 9
            }
        ...
        namespace eval MODVARSIZE1M_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 14
            }
        ...
        namespace eval MODVARSIZE2M_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 18
            }
        ...
        namespace eval MODVARBIAS_COMLIF {
            namespace export SHIFT
            proc SHIFT {} {
                return 22
            }
        ...
        namespace eval TXMODGAIN_COMLIF_OVR {
            namespace export SHIFT
            proc SHIFT {} {
                return 26
            }
    ...
    namespace export SYNTX_SINGLERX
    proc SYNTX_SINGLERX { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x124 }]
    }
    namespace eval SYNTX_SINGLERX {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x124 }]
        }
        namespace eval LOOPREFERENCEFREQUENCY_SCRX {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
        ...
        namespace eval VCOAGCENGAIN_SCRX {
            namespace export SHIFT
            proc SHIFT {} {
                return 3
            }
    ...
    namespace export TIMERCSTONE
    proc TIMERCSTONE { {base [::CMSDK_RIF_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x128 }]
    }
    namespace eval TIMERCSTONE {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RIF_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x128 }]
        }
    ...
    namespace export ID
    proc ID { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_RIF_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_RIF_SECURE::BASE]} } {
