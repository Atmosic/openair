namespace eval CMSDK_PDM0_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50160000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_PDM0_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_PDM0_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc FILTER_CONFIG { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc FILTER_CONFIG1 { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc GAIN_CONTROL_CONFIG { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc PCM_SAMPLE { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc FIFO_DEBUG { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc INTERRUPTS { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc INTERRUPT_CLEAR { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc BUFFER_ACCESS_MODE { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc AUTO_COUNTER { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc BUFFER_DEPTH { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_PDM0_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_PDM0_SECURE::BASE]} } {
