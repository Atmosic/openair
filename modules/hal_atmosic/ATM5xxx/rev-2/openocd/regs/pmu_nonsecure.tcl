namespace eval CMSDK_PMU_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40157000
    }
    namespace export CTRL
    proc CTRL { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval MSTR {
    ...
    proc TRANSACTION_SETUP { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc TRANSACTION_SETUP_2 { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc TRANSACTION_SETUP_DMA { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc TRANSACTION_STATUS { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc DATA_BYTES_LOWER { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc DATA_BYTES_UPPER { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_PMU_NONSECURE::BASE]} } {
