namespace eval CMSDK_RIF_NONSECURE {
    ...
    proc TRNG_CONF { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc SYNTX_154 { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc SYNTX6 { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc TIMER154 { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_RESET { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc DFT { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc RIF_I_TEST { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc RIF_Q_TEST { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc SYNTX_COMLIF { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc SYNTX_SINGLERX { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc TIMERCSTONE { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_RIF_NONSECURE::BASE]} } {
