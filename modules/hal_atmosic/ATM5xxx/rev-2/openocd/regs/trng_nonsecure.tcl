namespace eval CMSDK_TRNG_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x4015b000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval GO {
        ...
        namespace eval RADIO_WARMUP_CNT {
            ...
            namespace export READ
            proc READ {reg_val} {
                return [expr {($reg_val & 0x0003ffc0) >> 6}]
            }
            namespace export WRITE
            proc WRITE {field_val} {
                return [expr {($field_val << 6) & 0x0003ffc0}]
            }
            namespace export MODIFY
            proc MODIFY {var_name field_val} {
                upvar $var_name var
                set var [expr {($var & ~0x0003ffc0) | (($field_val << 6) & 0x0003ffc0)}]
            }
            namespace export MODIFY_TGT
            proc MODIFY_TGT {addr field_val} {
                mww $addr [expr {([mrw $addr] & ~0x0003ffc0) | (($field_val << 6) & 0x0003ffc0)}]
            }
            namespace export VERIFY
            proc VERIFY {field_val} {
                return [expr {!(($field_val << 6) & ~0x0003ffc0)}]
    ...
    proc STATUS { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc TRNG { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_TRNG_NONSECURE::BASE]} } {
