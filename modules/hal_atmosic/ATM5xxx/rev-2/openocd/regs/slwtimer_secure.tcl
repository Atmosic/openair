namespace eval CMSDK_SLWTIMER_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x5014e000
    }
    namespace export CONTROL
    proc CONTROL { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CONTROL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc INIT_LOW { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc INIT_HIGH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc CNT_LOW { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc CNT_HIGH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES0_LOW { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES0_HIGH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES1_LOW { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES1_HIGH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES2_LOW { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc THRES2_HIGH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc STATUS { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_SLWTIMER_SECURE::BASE]} } {
