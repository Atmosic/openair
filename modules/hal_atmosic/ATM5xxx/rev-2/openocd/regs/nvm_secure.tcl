namespace eval CMSDK_NVM_SECURE {
    ...
    proc OPMODE1 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc STATUS1 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc OTP_CFG_LOW { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc OTP_CFG_HIGH { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_RD_TIME0 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_RD_TIME1 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_RD_TIME2 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_RD_TIME3 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_RD_TIME4 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME0 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME1 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME2 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME3 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME4 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc T_PR_TIME5 { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_NVM_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_NVM_SECURE::BASE]} } {
