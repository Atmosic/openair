namespace eval CMSDK_I2C1_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50151000
    }
    namespace export CTRL
    proc CTRL { {base [::CMSDK_I2C1_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_I2C1_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc TRANSACTION_SETUP { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc CLOCK_CONTROL { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc OUTGOING_DATA { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc OUTGOING_DATA1 { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc IO_CTRL { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc INCOMING_DATA { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc INCOMING_DATA1 { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc TRANSACTION_STATUS { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    namespace export ID
    proc ID { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_I2C1_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_I2C1_SECURE::BASE]} } {
