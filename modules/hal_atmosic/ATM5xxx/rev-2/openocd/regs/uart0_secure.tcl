namespace eval CMSDK_UART0_SECURE {
    ...
    proc TX_CTRL { {base [::CMSDK_UART0_SECURE::BASE]} } {
    ...
    proc RX_CTRL { {base [::CMSDK_UART0_SECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_UART0_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_UART0_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_UART0_SECURE::BASE]} } {
