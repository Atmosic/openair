namespace eval CMSDK_WRPR1_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40153000
    }
    namespace export APB0_CTRL
    proc APB0_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval APB0_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc APB1_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB2_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB3_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB4_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB5_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB6_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB7_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB8_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB9_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB10_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB11_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB12_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB13_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB14_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc APB15_CTRL { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    namespace export OTP_INIT_LOWER
    proc OTP_INIT_LOWER { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x40 }]
    }
    namespace eval OTP_INIT_LOWER {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x40 }]
        }
    ...
    namespace export OTP_INIT_UPPER
    proc OTP_INIT_UPPER { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x44 }]
    }
    namespace eval OTP_INIT_UPPER {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x44 }]
        }
    ...
    proc CORE_ID { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_WRPR1_NONSECURE::BASE]} } {
