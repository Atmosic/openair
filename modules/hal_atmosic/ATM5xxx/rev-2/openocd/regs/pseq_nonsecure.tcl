namespace eval CMSDK_PSEQ_NONSECURE {
    ...
    proc PERSISTENT_EXPANSION_CTRL { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc PERSISTENT_EXPANSION_RDATA { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc BP_CLK_OFF_DUR { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc FLASH2_CONTROL { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc FLASH2_CONTROL2 { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
