namespace eval CMSDK_ARM_TRNG_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x5015e000
    }
    namespace export RNG_IMR
    proc RNG_IMR { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x100 }]
    }
    namespace eval RNG_IMR {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x100 }]
        }
    ...
    proc RNG_ISR { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RNG_ICR { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc TRNG_CONFIG { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc TRNG_VALID { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA0 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA1 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA2 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA3 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA4 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc EHR_DATA5 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RND_SOURCE_ENABLE { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc SAMPLE_CNT1 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc AUTOCORR_STATISTIC { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc TRNG_DEBUG_CONTROL { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc TRNG_SW_RESET { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc TRNG_BUSY { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RST_BITS_COUNTER { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RNG_BIST_CNTR0 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RNG_BIST_CNTR1 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc RNG_BIST_CNTR2 { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_ARM_TRNG_SECURE::BASE]} } {
