namespace eval CMSDK_WRPR1_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50153000
    }
    namespace export APB0_CTRL
    proc APB0_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval APB0_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc APB1_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB2_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB3_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB4_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB5_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB6_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB7_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB8_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB9_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB10_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB11_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB12_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB13_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB14_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc APB15_CTRL { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc OTP_INIT_LOWER { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc OTP_INIT_UPPER { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_WRPR1_SECURE::BASE]} } {
