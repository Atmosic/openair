...
#define CHIP_INFO__PACKAGE__BGA 7
...
struct pmu_cal_s {
    ...
    uint32_t pmu_top_pmu5;
    uint32_t pmu_top_pmu6;
    uint32_t pmu_top_pmu7;
    uint32_t pmu_top_pmu10;
};
...
struct cs_cal_s {
    uint8_t lna_delays[8];
    uint16_t tia_pga_delays[48];
};
