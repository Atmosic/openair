 ...
 * @details analog test bus select. 0: Disconnect. 1: control voltage. 2: VCO current source gate voltage, set by AGC. 3: VCO inductor center tap. 4: VCO core top (PMOS sources). 5: vdd_vco. 6: gbias voltage in modDAC. 7: vmodLow voltage in modDAC 8: vmod voltage. 9-15: gnd
 * @{
 */
...
#define RADIO_SYNTH_SYNTH_CTRL_2__VCOTUNEMARGIN_X16M__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 27) & ~0x38000000U)))
#define RADIO_SYNTH_SYNTH_CTRL_2__VCOTUNEMARGIN_X16M__RESET_VALUE   0x00000003U
/** @} */
 ...
 * @details if set, state machine will not round-up when making final calculation of Bx and Cx values during VCO fast cap search
 * @{
 */
...
#define RADIO_SYNTH_SYNTH_CTRL_2__RESET_VALUE                       0x9c900040U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__SHIFT                     4
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__WIDTH                     5
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__MASK            0x000001f0U
...
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x000001f0U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__RESET_VALUE     0x00000003U
/** @} */
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__SHIFT                        9
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__WIDTH                        1
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__MASK               0x00000200U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__SHIFT                  10
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__WIDTH                   3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__MASK          0x00001c00U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__SHIFT                    13
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__WIDTH                     5
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__MASK            0x0003e000U
...
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 13) & ~0x0003e000U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__RESET_VALUE     0x00000003U
/** @} */
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__SHIFT                       18
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__WIDTH                        1
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__MASK               0x00040000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__SHIFT                  19
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__WIDTH                   3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__MASK          0x00380000U
...
/* macros for field Bxsearch_useMidCx */
/**
 * @defgroup radio_synth_regs_core_Bxsearch_useMidCx_field Bxsearch_useMidCx_field
 * @brief macros for field Bxsearch_useMidCx
 * @details if set, state machine sets Cx bits to mid-code during B0/B1 search during VCO capacitor cal
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__SHIFT                   22
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__WIDTH                    1
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__MASK           0x00400000U
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00400000U) >> 22)
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__WRITE(src) \
                    (((uint32_t)(src)\
                    << 22) & 0x00400000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | (((uint32_t)(src) <<\
                    22) & 0x00400000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 22) & ~0x00400000U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | ((uint32_t)(1) << 22)
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | ((uint32_t)(0) << 22)
#define RADIO_SYNTH_SYNTH_CTRL_3__BXSEARCH_USEMIDCX__RESET_VALUE    0x00000000U
/** @} */

/* macros for field enSynthAnalog_when_cs */
/**
 * @defgroup radio_synth_regs_core_enSynthAnalog_when_cs_field enSynthAnalog_when_cs_field
 * @brief macros for field enSynthAnalog_when_cs
 * @details if set, enSynthAnalog is forced high when hadm_en=1; allows for faster channel change without needing to wait for analog blocks' bias points to settle
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__SHIFT               23
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__WIDTH                1
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__MASK       0x00800000U
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00800000U) >> 23)
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 23) & 0x00800000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | (((uint32_t)(src) <<\
                    23) & 0x00800000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 23) & ~0x00800000U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(1) << 23)
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(0) << 23)
#define RADIO_SYNTH_SYNTH_CTRL_3__ENSYNTHANALOG_WHEN_CS__RESET_VALUE \
                    0x00000001U
/** @} */

/* macros for field spareExt2 */
/**
 * @defgroup radio_synth_regs_core_spareExt2_field spareExt2_field
 * @brief macros for field spareExt2
 * @details synth local register internal spare bits taken out as pins to synthDigital
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__SHIFT                           24
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__WIDTH                            8
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__MASK                   0xff000000U
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__READ(src) \
                    (((uint32_t)(src)\
                    & 0xff000000U) >> 24)
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__WRITE(src) \
                    (((uint32_t)(src)\
                    << 24) & 0xff000000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xff000000U) | (((uint32_t)(src) <<\
                    24) & 0xff000000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0xff000000U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__SPAREEXT2__RESET_VALUE            0x00000000U
/** @} */
...
#define RADIO_SYNTH_SYNTH_CTRL_3__RESET_VALUE                       0x0080603fU
