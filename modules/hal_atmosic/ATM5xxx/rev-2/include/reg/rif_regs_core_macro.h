...
/* macros for field force_int_rxgain */
/**
 * @defgroup rif_regs_core_force_int_rxgain_field force_int_rxgain_field
 * @brief macros for field force_int_rxgain
 * @details When set and mode_cntl_select_ext is also set, use the internal version of rxgain, not the one sent through the dtop_bypass interface
 * @{
 */
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__SHIFT                              23
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__WIDTH                               1
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__MASK                      0x00800000U
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00800000U) >> 23)
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 23) & 0x00800000U)
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | (((uint32_t)(src) <<\
                    23) & 0x00800000U)
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 23) & ~0x00800000U)))
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(1) << 23)
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(0) << 23)
#define RIF_MODE_CNTL2__FORCE_INT_RXGAIN__RESET_VALUE               0x00000000U
/** @} */

/* macros for field force_int_rx_en */
/**
 * @defgroup rif_regs_core_force_int_rx_en_field force_int_rx_en_field
 * @brief macros for field force_int_rx_en
 * @details When set and mode_cntl_select_ext is also set, use the internal version of rx_en, not the one sent through the dtop_bypass interface
 * @{
 */
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__SHIFT                               24
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__WIDTH                                1
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__MASK                       0x01000000U
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x01000000U) >> 24)
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 24) & 0x01000000U)
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | (((uint32_t)(src) <<\
                    24) & 0x01000000U)
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0x01000000U)))
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(1) << 24)
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(0) << 24)
#define RIF_MODE_CNTL2__FORCE_INT_RX_EN__RESET_VALUE                0x00000000U
/** @} */
#define RIF_MODE_CNTL2__TYPE                                           uint32_t
#define RIF_MODE_CNTL2__READ                                        0x01ffffffU
#define RIF_MODE_CNTL2__WRITE                                       0x01ffffffU
