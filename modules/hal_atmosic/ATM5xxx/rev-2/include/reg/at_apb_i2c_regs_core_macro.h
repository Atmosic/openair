...
/* macros for BlueprintGlobalNameSpace::I2C_ctrl */
/**
 * @defgroup at_apb_i2c_regs_core_ctrl ctrl
 * @brief Contains register fields associated with ctrl. definitions.
 * @{
 */
#ifndef __I2C_CTRL_MACRO__
#define __I2C_CTRL_MACRO__

/* macros for field s_id_sel */
/**
 * @defgroup at_apb_i2c_regs_core_s_id_sel_field s_id_sel_field
 * @brief macros for field s_id_sel
 * @details selects the use of programmable slave id or a hardcoded id  1=use the programmable slave id from s_id field  0=use the hardcoded slave id
 * @{
 */
#define I2C_CTRL__S_ID_SEL__SHIFT                                             0
#define I2C_CTRL__S_ID_SEL__WIDTH                                             1
#define I2C_CTRL__S_ID_SEL__MASK                                    0x00000001U
#define I2C_CTRL__S_ID_SEL__READ(src)           ((uint32_t)(src) & 0x00000001U)
#define I2C_CTRL__S_ID_SEL__WRITE(src)          ((uint32_t)(src) & 0x00000001U)
#define I2C_CTRL__S_ID_SEL__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define I2C_CTRL__S_ID_SEL__VERIFY(src)   (!(((uint32_t)(src) & ~0x00000001U)))
#define I2C_CTRL__S_ID_SEL__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define I2C_CTRL__S_ID_SEL__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define I2C_CTRL__S_ID_SEL__RESET_VALUE                             0x00000000U
/** @} */

/* macros for field s_id */
/**
 * @defgroup at_apb_i2c_regs_core_s_id_field s_id_field
 * @brief macros for field s_id
 * @details programmable slave device-id
 * @{
 */
#define I2C_CTRL__S_ID__SHIFT                                                 1
#define I2C_CTRL__S_ID__WIDTH                                                 7
#define I2C_CTRL__S_ID__MASK                                        0x000000feU
#define I2C_CTRL__S_ID__READ(src)        (((uint32_t)(src) & 0x000000feU) >> 1)
#define I2C_CTRL__S_ID__WRITE(src)       (((uint32_t)(src) << 1) & 0x000000feU)
#define I2C_CTRL__S_ID__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x000000feU) | (((uint32_t)(src) <<\
                    1) & 0x000000feU)
#define I2C_CTRL__S_ID__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 1) & ~0x000000feU)))
#define I2C_CTRL__S_ID__RESET_VALUE                                 0x00000000U
/** @} */
#define I2C_CTRL__TYPE                                                 uint32_t
#define I2C_CTRL__READ                                              0x000000ffU
#define I2C_CTRL__WRITE                                             0x000000ffU
#define I2C_CTRL__PRESERVED                                         0x00000000U
#define I2C_CTRL__RESET_VALUE                                       0x00000000U

#endif /* __I2C_CTRL_MACRO__ */
 ...
 * @details master/slave scl clock-stretching enable
 * @{
 */
 ...
 * @details master scl clock-stretching wait duration. Insert wait states based on selection  0=wait for slave to release scl line  1=wait for 1-byte; time-out after  2=wait for 2-byte; time-out after  3=wait for 4-byte; time-out after
 * @{
 */
 ...
 * @details 1=enables synchronizers on scl input line during master clock-stretching
 * @{
 */
