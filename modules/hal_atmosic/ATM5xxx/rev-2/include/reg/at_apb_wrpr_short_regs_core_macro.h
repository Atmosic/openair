...
/* macros for BlueprintGlobalNameSpace::WRPRSHORT_otp_init_lower */
/**
 * @defgroup at_apb_wrpr_short_regs_core_otp_init_lower otp_init_lower
 * @brief Contains register fields associated with otp_init_lower. definitions.
 * @{
 */
#ifndef __WRPRSHORT_OTP_INIT_LOWER_MACRO__
#define __WRPRSHORT_OTP_INIT_LOWER_MACRO__

/* macros for field val */
/**
 * @defgroup at_apb_wrpr_short_regs_core_val_field val_field
 * @brief macros for field val
 * @details lower word of the init otp output
 * @{
 */
#define WRPRSHORT_OTP_INIT_LOWER__VAL__SHIFT                                  0
#define WRPRSHORT_OTP_INIT_LOWER__VAL__WIDTH                                 32
#define WRPRSHORT_OTP_INIT_LOWER__VAL__MASK                         0xffffffffU
#define WRPRSHORT_OTP_INIT_LOWER__VAL__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRSHORT_OTP_INIT_LOWER__VAL__RESET_VALUE                  0x00000000U
/** @} */
#define WRPRSHORT_OTP_INIT_LOWER__TYPE                                 uint32_t
#define WRPRSHORT_OTP_INIT_LOWER__READ                              0xffffffffU
#define WRPRSHORT_OTP_INIT_LOWER__PRESERVED                         0x00000000U
#define WRPRSHORT_OTP_INIT_LOWER__RESET_VALUE                       0x00000000U

#endif /* __WRPRSHORT_OTP_INIT_LOWER_MACRO__ */

/** @} end of otp_init_lower */

/* macros for BlueprintGlobalNameSpace::WRPRSHORT_otp_init_upper */
/**
 * @defgroup at_apb_wrpr_short_regs_core_otp_init_upper otp_init_upper
 * @brief Contains register fields associated with otp_init_upper. definitions.
 * @{
 */
#ifndef __WRPRSHORT_OTP_INIT_UPPER_MACRO__
#define __WRPRSHORT_OTP_INIT_UPPER_MACRO__

/* macros for field val */
/**
 * @defgroup at_apb_wrpr_short_regs_core_val_field val_field
 * @brief macros for field val
 * @details upper word of the init otp output
 * @{
 */
#define WRPRSHORT_OTP_INIT_UPPER__VAL__SHIFT                                  0
#define WRPRSHORT_OTP_INIT_UPPER__VAL__WIDTH                                 32
#define WRPRSHORT_OTP_INIT_UPPER__VAL__MASK                         0xffffffffU
#define WRPRSHORT_OTP_INIT_UPPER__VAL__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRSHORT_OTP_INIT_UPPER__VAL__RESET_VALUE                  0x00000000U
/** @} */
#define WRPRSHORT_OTP_INIT_UPPER__TYPE                                 uint32_t
#define WRPRSHORT_OTP_INIT_UPPER__READ                              0xffffffffU
#define WRPRSHORT_OTP_INIT_UPPER__PRESERVED                         0x00000000U
#define WRPRSHORT_OTP_INIT_UPPER__RESET_VALUE                       0x00000000U

#endif /* __WRPRSHORT_OTP_INIT_UPPER_MACRO__ */

/** @} end of otp_init_upper */
...
#define WRPRSHORT_REV_HASH__ID__RESET_VALUE                         0xbc6d49a7U
/** @} */
...
#define WRPRSHORT_REV_HASH__RESET_VALUE                             0xbc6d49a7U
