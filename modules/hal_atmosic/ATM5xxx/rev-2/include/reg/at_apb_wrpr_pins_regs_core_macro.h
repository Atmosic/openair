...
/* macros for field etmfifofullen */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_etmfifofullen_field etmfifofullen_field
 * @brief macros for field etmfifofullen
 * @{
 */
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__SHIFT                              23
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__WIDTH                               1
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__MASK                      0x00800000U
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00800000U) >> 23)
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 23) & 0x00800000U)
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | (((uint32_t)(src) <<\
                    23) & 0x00800000U)
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 23) & ~0x00800000U)))
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(1) << 23)
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(0) << 23)
#define WRPRPINS_DBG_CTRL__ETMFIFOFULLEN__RESET_VALUE               0x00000000U
/** @} */

/* macros for field dbg_sel_msb */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_dbg_sel_msb_field dbg_sel_msb_field
 * @brief macros for field dbg_sel_msb
 * @details Msb of dbg_sel
 * @{
 */
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__SHIFT                                24
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__WIDTH                                 1
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__MASK                        0x01000000U
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__READ(src) \
                    (((uint32_t)(src)\
                    & 0x01000000U) >> 24)
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__WRITE(src) \
                    (((uint32_t)(src)\
                    << 24) & 0x01000000U)
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | (((uint32_t)(src) <<\
                    24) & 0x01000000U)
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0x01000000U)))
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(1) << 24)
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(0) << 24)
#define WRPRPINS_DBG_CTRL__DBG_SEL_MSB__RESET_VALUE                 0x00000000U
/** @} */

/* macros for field force_ahb_mpc_clk_enable */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_force_ahb_mpc_clk_enable_field force_ahb_mpc_clk_enable_field
 * @brief macros for field force_ahb_mpc_clk_enable
 * @details write 1 to force ahb to apb bridge input clock gate always enable
 * @{
 */
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__SHIFT                   25
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__WIDTH                    1
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__MASK           0x02000000U
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x02000000U) >> 25)
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 25) & 0x02000000U)
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | (((uint32_t)(src) <<\
                    25) & 0x02000000U)
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 25) & ~0x02000000U)))
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | ((uint32_t)(1) << 25)
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | ((uint32_t)(0) << 25)
#define WRPRPINS_DBG_CTRL__FORCE_AHB_MPC_CLK_ENABLE__RESET_VALUE    0x00000000U
/** @} */

/* macros for field gpio_clk_enable */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_gpio_clk_enable_field gpio_clk_enable_field
 * @brief macros for field gpio_clk_enable
 * @details Enable the gpio glock
 * @{
 */
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__SHIFT                            26
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__WIDTH                             1
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__MASK                    0x04000000U
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x04000000U) >> 26)
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 26) & 0x04000000U)
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | (((uint32_t)(src) <<\
                    26) & 0x04000000U)
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 26) & ~0x04000000U)))
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | ((uint32_t)(1) << 26)
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | ((uint32_t)(0) << 26)
#define WRPRPINS_DBG_CTRL__GPIO_CLK_ENABLE__RESET_VALUE             0x00000001U
/** @} */
#define WRPRPINS_DBG_CTRL__TYPE                                        uint32_t
#define WRPRPINS_DBG_CTRL__READ                                     0x07ffffffU
#define WRPRPINS_DBG_CTRL__WRITE                                    0x07ffffffU
#define WRPRPINS_DBG_CTRL__PRESERVED                                0x00000000U
#define WRPRPINS_DBG_CTRL__RESET_VALUE                              0x0406c000U
...
#define WRPRPINS_PSEL_L__P42_SEL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 16) & ~0x00ff0000U)))
#define WRPRPINS_PSEL_L__P42_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_L__P43_SEL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0xff000000U)))
#define WRPRPINS_PSEL_L__P43_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_L__RESET_VALUE                                0xffff0000U
...
#define WRPRPINS_PSEL_M__P44_SEL__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x000000ffU)))
#define WRPRPINS_PSEL_M__P44_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_M__P45_SEL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x0000ff00U)))
#define WRPRPINS_PSEL_M__P45_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_M__P46_SEL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 16) & ~0x00ff0000U)))
#define WRPRPINS_PSEL_M__P46_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_M__P47_SEL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0xff000000U)))
#define WRPRPINS_PSEL_M__P47_SEL__RESET_VALUE                       0x000000ffU
/** @} */
...
#define WRPRPINS_PSEL_M__RESET_VALUE                                0xffffffffU
...
#define WRPRPINS_PUPD_OVRD2__PIN__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x003fffffU)))
#define WRPRPINS_PUPD_OVRD2__PIN__RESET_VALUE                       0x00000000U
/** @} */
...
#define WRPRPINS_PUPD_OVRD2__RESET_VALUE                            0x00000000U
...
#define WRPRPINS_PUPD_OVRD_VAL2__PIN__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x003fffffU)))
#define WRPRPINS_PUPD_OVRD_VAL2__PIN__RESET_VALUE                   0x00000000U
/** @} */
...
#define WRPRPINS_PUPD_OVRD_VAL2__RESET_VALUE                        0x00000000U
 ...
 * @details if a bit is set, invalidates any writes to the corresponding 8kB block, can only revert with cpu reset
 * @{
 */
#define WRPRPINS_PROT_BITS_SET0__ROM_READ_LOCKS_SET__SHIFT                    0
#define WRPRPINS_PROT_BITS_SET0__ROM_READ_LOCKS_SET__WIDTH                    8
#define WRPRPINS_PROT_BITS_SET0__ROM_READ_LOCKS_SET__MASK           0x000000ffU
...
#define WRPRPINS_PROT_BITS_SET0__READ                               0x000000ffU
#define WRPRPINS_PROT_BITS_SET0__WRITE                              0x000000ffU
 ...
 * @brief Contains register fields associated with prot_bits_set1. definitions.
 * @{
 */
...
/* macros for field spi2_lock_set */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_spi2_lock_set_field spi2_lock_set_field
 * @brief macros for field spi2_lock_set
 * @details sets sticky bit disabling spi2
 * @{
 */
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__SHIFT                         8
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__WIDTH                         1
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__MASK                0x00000100U
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000100U) >> 8)
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__WRITE(src) \
                    (((uint32_t)(src)\
                    << 8) & 0x00000100U)
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | (((uint32_t)(src) <<\
                    8) & 0x00000100U)
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000100U)))
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(1) << 8)
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(0) << 8)
#define WRPRPINS_PROT_BITS_SET1__SPI2_LOCK_SET__RESET_VALUE         0x00000000U
/** @} */
#define WRPRPINS_PROT_BITS_SET1__TYPE                                  uint32_t
#define WRPRPINS_PROT_BITS_SET1__READ                               0x000001ffU
#define WRPRPINS_PROT_BITS_SET1__WRITE                              0x000001ffU
...
#define WRPRPINS_PROT_BITS_STAT0__ROM_READ_LOCKS_STAT__WIDTH                  8
#define WRPRPINS_PROT_BITS_STAT0__ROM_READ_LOCKS_STAT__MASK         0x000000ffU
...
#define WRPRPINS_PROT_BITS_STAT0__READ                              0x000000ffU
...
/* macros for field spi2_lock_stat */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_spi2_lock_stat_field spi2_lock_stat_field
 * @brief macros for field spi2_lock_stat
 * @details sticky bit disabling spi2
 * @{
 */
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__SHIFT                       8
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__WIDTH                       1
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__MASK              0x00000100U
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000100U) >> 8)
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(1) << 8)
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(0) << 8)
#define WRPRPINS_PROT_BITS_STAT1__SPI2_LOCK_STAT__RESET_VALUE       0x00000000U
/** @} */
#define WRPRPINS_PROT_BITS_STAT1__TYPE                                 uint32_t
#define WRPRPINS_PROT_BITS_STAT1__READ                              0x000001ffU
 ...
 * @defgroup at_apb_wrpr_pins_regs_core_set_field set_field
 * @brief macros for field set
 * @details if a bit is set, invalidates any writes/erases to the corresponding 8kB block, can only revert with cpu reset
 * @{
 */
...
/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_write_protection2 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_write_protection2 qspi_sticky_write_protection2
 * @brief Contains register fields associated with qspi_sticky_write_protection2. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2_MACRO__
#define __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__SHIFT                    0
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__WIDTH                   32
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__MASK           0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__SET__RESET_VALUE    0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__TYPE                   uint32_t
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__READ                0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__WRITE               0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__PRESERVED           0x00000000U
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2__RESET_VALUE         0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION2_MACRO__ */

/** @} end of qspi_sticky_write_protection2 */

/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_write_protection3 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_write_protection3 qspi_sticky_write_protection3
 * @brief Contains register fields associated with qspi_sticky_write_protection3. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3_MACRO__
#define __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__SHIFT                    0
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__WIDTH                   32
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__MASK           0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__SET__RESET_VALUE    0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__TYPE                   uint32_t
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__READ                0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__WRITE               0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__PRESERVED           0x00000000U
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3__RESET_VALUE         0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION3_MACRO__ */

/** @} end of qspi_sticky_write_protection3 */
...
/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_write_protection_status2 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_write_protection_status2 qspi_sticky_write_protection_status2
 * @brief Contains register fields associated with qspi_sticky_write_protection_status2. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2_MACRO__
#define __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__VAL__SHIFT             0
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__VAL__WIDTH            32
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__VAL__MASK    0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__VAL__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__VAL__RESET_VALUE \
                    0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__TYPE            uint32_t
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__READ         0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__PRESERVED    0x00000000U
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2__RESET_VALUE  0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS2_MACRO__ */

/** @} end of qspi_sticky_write_protection_status2 */

/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_write_protection_status3 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_write_protection_status3 qspi_sticky_write_protection_status3
 * @brief Contains register fields associated with qspi_sticky_write_protection_status3. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3_MACRO__
#define __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__VAL__SHIFT             0
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__VAL__WIDTH            32
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__VAL__MASK    0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__VAL__READ(src) \
                    ((uint32_t)(src)\
                    & 0xffffffffU)
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__VAL__RESET_VALUE \
                    0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__TYPE            uint32_t
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__READ         0xffffffffU
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__PRESERVED    0x00000000U
#define WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3__RESET_VALUE  0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_WRITE_PROTECTION_STATUS3_MACRO__ */

/** @} end of qspi_sticky_write_protection_status3 */

/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_read_protection0 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_read_protection0 qspi_sticky_read_protection0
 * @brief Contains register fields associated with qspi_sticky_read_protection0. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_READ_PROTECTION0_MACRO__
#define __WRPRPINS_QSPI_STICKY_READ_PROTECTION0_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__SHIFT                     0
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__WIDTH                    12
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__MASK            0x00000fffU
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000fffU)
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000fffU)
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000fffU) | ((uint32_t)(src) &\
                    0x00000fffU)
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000fffU)))
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__SET__RESET_VALUE     0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__TYPE                    uint32_t
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__READ                 0x00000fffU
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__WRITE                0x00000fffU
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__PRESERVED            0x00000000U
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION0__RESET_VALUE          0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_READ_PROTECTION0_MACRO__ */

/** @} end of qspi_sticky_read_protection0 */

/* macros for BlueprintGlobalNameSpace::WRPRPINS_qspi_sticky_read_protection_status0 */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_qspi_sticky_read_protection_status0 qspi_sticky_read_protection_status0
 * @brief Contains register fields associated with qspi_sticky_read_protection_status0. definitions.
 * @{
 */
#ifndef __WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0_MACRO__
#define __WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0_MACRO__
 ...
 * @{
 */
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__VAL__SHIFT              0
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__VAL__WIDTH             12
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__VAL__MASK     0x00000fffU
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__VAL__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000fffU)
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__VAL__RESET_VALUE \
                    0x00000000U
/** @} */
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__TYPE             uint32_t
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__READ          0x00000fffU
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__PRESERVED     0x00000000U
#define WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0__RESET_VALUE   0x00000000U

#endif /* __WRPRPINS_QSPI_STICKY_READ_PROTECTION_STATUS0_MACRO__ */

/** @} end of qspi_sticky_read_protection_status0 */
 ...
 * @details state of secure debug FSM.  0 = ENABLED_DBG  1 = DISABLED_DBG  2 = SEC_DBG  3 = RESERVED_DBG
 * @{
 */
 ...
 * @defgroup at_apb_wrpr_pins_regs_core_P_ie_alt_field P_ie_alt_field
 * @brief macros for field P_ie_alt
 * @details for P47 to P31
 * @{
 */
#define WRPRPINS_GLITCHLESS_IO6__P_IE_ALT__SHIFT                              0
#define WRPRPINS_GLITCHLESS_IO6__P_IE_ALT__WIDTH                             17
#define WRPRPINS_GLITCHLESS_IO6__P_IE_ALT__MASK                     0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO6__READ                               0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO6__WRITE                              0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO7__P_PULL_UP_ALT__WIDTH                        17
#define WRPRPINS_GLITCHLESS_IO7__P_PULL_UP_ALT__MASK                0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO7__READ                               0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO7__WRITE                              0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO8__P_PULL_DN_ALT__WIDTH                        17
#define WRPRPINS_GLITCHLESS_IO8__P_PULL_DN_ALT__MASK                0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO8__READ                               0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO8__WRITE                              0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO9__P_OEN_ALT__WIDTH                            17
#define WRPRPINS_GLITCHLESS_IO9__P_OEN_ALT__MASK                    0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO9__READ                               0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO9__WRITE                              0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO10__P_DOUT_ALT__WIDTH                          17
#define WRPRPINS_GLITCHLESS_IO10__P_DOUT_ALT__MASK                  0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO10__READ                              0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO10__WRITE                             0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO11__P_DIN_ALT__WIDTH                           17
#define WRPRPINS_GLITCHLESS_IO11__P_DIN_ALT__MASK                   0x0001ffffU
...
#define WRPRPINS_GLITCHLESS_IO11__READ                              0x0001ffffU
#define WRPRPINS_GLITCHLESS_IO11__WRITE                             0x0001ffffU
...
/* macros for field at_lc_bufferable */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_at_lc_bufferable_field at_lc_bufferable_field
 * @brief macros for field at_lc_bufferable
 * @details The write access to ATLC is bufferable
 * @{
 */
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__SHIFT                       3
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__WIDTH                       1
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__MASK              0x00000008U
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000008U) >> 3)
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 3) & 0x00000008U)
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | (((uint32_t)(src) <<\
                    3) & 0x00000008U)
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 3) & ~0x00000008U)))
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(1) << 3)
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(0) << 3)
#define WRPRPINS_SOC_MISC_CTRL__AT_LC_BUFFERABLE__RESET_VALUE       0x00000000U
/** @} */

/* macros for field fixed_freq_speedup */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_fixed_freq_speedup_field fixed_freq_speedup_field
 * @brief macros for field fixed_freq_speedup
 * @details Speed-up the register access of fixed-freq APB peripherals
 * @{
 */
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__SHIFT                     4
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__WIDTH                     1
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__MASK            0x00000010U
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define WRPRPINS_SOC_MISC_CTRL__FIXED_FREQ_SPEEDUP__RESET_VALUE     0x00000000U
/** @} */

/* macros for field mdm_apb_speedup */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_mdm_apb_speedup_field mdm_apb_speedup_field
 * @brief macros for field mdm_apb_speedup
 * @details Speed-up the APB access from backplane to mdm
 * @{
 */
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__SHIFT                        5
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__WIDTH                        1
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__MASK               0x00000020U
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000020U) >> 5)
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x00000020U)
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | (((uint32_t)(src) <<\
                    5) & 0x00000020U)
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x00000020U)))
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(1) << 5)
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(0) << 5)
#define WRPRPINS_SOC_MISC_CTRL__MDM_APB_SPEEDUP__RESET_VALUE        0x00000000U
/** @} */

/* macros for field rif_apb_speedup */
/**
 * @defgroup at_apb_wrpr_pins_regs_core_rif_apb_speedup_field rif_apb_speedup_field
 * @brief macros for field rif_apb_speedup
 * @details Speed-up the APB access from backplane to rif
 * @{
 */
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__SHIFT                        6
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__WIDTH                        1
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__MASK               0x00000040U
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000040U) >> 6)
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__WRITE(src) \
                    (((uint32_t)(src)\
                    << 6) & 0x00000040U)
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | (((uint32_t)(src) <<\
                    6) & 0x00000040U)
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 6) & ~0x00000040U)))
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | ((uint32_t)(1) << 6)
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | ((uint32_t)(0) << 6)
#define WRPRPINS_SOC_MISC_CTRL__RIF_APB_SPEEDUP__RESET_VALUE        0x00000000U
/** @} */
#define WRPRPINS_SOC_MISC_CTRL__TYPE                                   uint32_t
#define WRPRPINS_SOC_MISC_CTRL__READ                                0x0000007fU
#define WRPRPINS_SOC_MISC_CTRL__WRITE                               0x0000007fU
...
#define WRPRPINS_CHIPID1__CHAR3__RESET_VALUE                        0x00000072U
/** @} */
...
#define WRPRPINS_CHIPID1__CHAR2__READ(src) \
                    (((uint32_t)(src)\
                    & 0x0000ff00U) >> 8)
#define WRPRPINS_CHIPID1__CHAR2__RESET_VALUE                        0x00000069U
/** @} */
...
#define WRPRPINS_CHIPID1__CHAR0__READ(src) \
                    (((uint32_t)(src)\
                    & 0xff000000U) >> 24)
#define WRPRPINS_CHIPID1__CHAR0__RESET_VALUE                        0x00000043U
/** @} */
...
#define WRPRPINS_CHIPID1__RESET_VALUE                               0x43616972U
...
#define WRPRPINS_CHIPID2__CHAR4__READ(src) \
                    (((uint32_t)(src)\
                    & 0xff000000U) >> 24)
#define WRPRPINS_CHIPID2__CHAR4__RESET_VALUE                        0x0000006fU
/** @} */
...
#define WRPRPINS_CHIPID2__RESET_VALUE                               0x6f000000U
...
#define WRPRPINS_REV_HASH__ID__RESET_VALUE                          0xf0e94322U
/** @} */
...
#define WRPRPINS_REV_HASH__RESET_VALUE                              0xf0e94322U
