 ...
 * @details introduce a delay between master spi_csn falling-edge and first bit on mosi
 * @{
 */
#define SPI_CTRL__CSN_BUBBLE__SHIFT                                          21
#define SPI_CTRL__CSN_BUBBLE__WIDTH                                           1
#define SPI_CTRL__CSN_BUBBLE__MASK                                  0x00200000U
#define SPI_CTRL__CSN_BUBBLE__READ(src) (((uint32_t)(src) & 0x00200000U) >> 21)
#define SPI_CTRL__CSN_BUBBLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 21) & 0x00200000U)
#define SPI_CTRL__CSN_BUBBLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | (((uint32_t)(src) <<\
                    21) & 0x00200000U)
#define SPI_CTRL__CSN_BUBBLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 21) & ~0x00200000U)))
#define SPI_CTRL__CSN_BUBBLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | ((uint32_t)(1) << 21)
#define SPI_CTRL__CSN_BUBBLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | ((uint32_t)(0) << 21)
#define SPI_CTRL__CSN_BUBBLE__RESET_VALUE                           0x00000000U
/** @} */
 ...
 * @{
 */
#define SPI_CTRL__LOOPBACK__SHIFT                                            22
#define SPI_CTRL__LOOPBACK__WIDTH                                             1
#define SPI_CTRL__LOOPBACK__MASK                                    0x00400000U
#define SPI_CTRL__LOOPBACK__READ(src)   (((uint32_t)(src) & 0x00400000U) >> 22)
#define SPI_CTRL__LOOPBACK__WRITE(src)  (((uint32_t)(src) << 22) & 0x00400000U)
#define SPI_CTRL__LOOPBACK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | (((uint32_t)(src) <<\
                    22) & 0x00400000U)
#define SPI_CTRL__LOOPBACK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 22) & ~0x00400000U)))
#define SPI_CTRL__LOOPBACK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | ((uint32_t)(1) << 22)
#define SPI_CTRL__LOOPBACK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00400000U) | ((uint32_t)(0) << 22)
#define SPI_CTRL__LOOPBACK__RESET_VALUE                             0x00000000U
/** @} */
 ...
 * @{
 */
#define SPI_CTRL__INVERT_MOSI__SHIFT                                         23
#define SPI_CTRL__INVERT_MOSI__WIDTH                                          1
#define SPI_CTRL__INVERT_MOSI__MASK                                 0x00800000U
#define SPI_CTRL__INVERT_MOSI__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00800000U) >> 23)
#define SPI_CTRL__INVERT_MOSI__WRITE(src) \
                    (((uint32_t)(src)\
                    << 23) & 0x00800000U)
#define SPI_CTRL__INVERT_MOSI__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | (((uint32_t)(src) <<\
                    23) & 0x00800000U)
#define SPI_CTRL__INVERT_MOSI__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 23) & ~0x00800000U)))
#define SPI_CTRL__INVERT_MOSI__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(1) << 23)
#define SPI_CTRL__INVERT_MOSI__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(0) << 23)
#define SPI_CTRL__INVERT_MOSI__RESET_VALUE                          0x00000000U
/** @} */

/* macros for field s_adr_autoinc_dis */
/**
 * @defgroup at_apb_spi_regs_core_s_adr_autoinc_dis_field s_adr_autoinc_dis_field
 * @brief macros for field s_adr_autoinc_dis
 * @details 1=disable slave address auto-increment.
 * @{
 */
#define SPI_CTRL__S_ADR_AUTOINC_DIS__SHIFT                                   24
#define SPI_CTRL__S_ADR_AUTOINC_DIS__WIDTH                                    1
#define SPI_CTRL__S_ADR_AUTOINC_DIS__MASK                           0x01000000U
#define SPI_CTRL__S_ADR_AUTOINC_DIS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x01000000U) >> 24)
#define SPI_CTRL__S_ADR_AUTOINC_DIS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 24) & 0x01000000U)
#define SPI_CTRL__S_ADR_AUTOINC_DIS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | (((uint32_t)(src) <<\
                    24) & 0x01000000U)
#define SPI_CTRL__S_ADR_AUTOINC_DIS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0x01000000U)))
#define SPI_CTRL__S_ADR_AUTOINC_DIS__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(1) << 24)
#define SPI_CTRL__S_ADR_AUTOINC_DIS__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(0) << 24)
#define SPI_CTRL__S_ADR_AUTOINC_DIS__RESET_VALUE                    0x00000000U
/** @} */

/* macros for field s_opcode_byp */
/**
 * @defgroup at_apb_spi_regs_core_s_opcode_byp_field s_opcode_byp_field
 * @brief macros for field s_opcode_byp
 * @details 1=bypass slave input opcode.
 * @{
 */
#define SPI_CTRL__S_OPCODE_BYP__SHIFT                                        25
#define SPI_CTRL__S_OPCODE_BYP__WIDTH                                         1
#define SPI_CTRL__S_OPCODE_BYP__MASK                                0x02000000U
#define SPI_CTRL__S_OPCODE_BYP__READ(src) \
                    (((uint32_t)(src)\
                    & 0x02000000U) >> 25)
#define SPI_CTRL__S_OPCODE_BYP__WRITE(src) \
                    (((uint32_t)(src)\
                    << 25) & 0x02000000U)
#define SPI_CTRL__S_OPCODE_BYP__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | (((uint32_t)(src) <<\
                    25) & 0x02000000U)
#define SPI_CTRL__S_OPCODE_BYP__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 25) & ~0x02000000U)))
#define SPI_CTRL__S_OPCODE_BYP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | ((uint32_t)(1) << 25)
#define SPI_CTRL__S_OPCODE_BYP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x02000000U) | ((uint32_t)(0) << 25)
#define SPI_CTRL__S_OPCODE_BYP__RESET_VALUE                         0x00000000U
/** @} */

/* macros for field s_rwb */
/**
 * @defgroup at_apb_spi_regs_core_s_rwb_field s_rwb_field
 * @brief macros for field s_rwb
 * @details 1=read 0=write; note use to specify direction when slave opcode is bypassed
 * @{
 */
#define SPI_CTRL__S_RWB__SHIFT                                               26
#define SPI_CTRL__S_RWB__WIDTH                                                1
#define SPI_CTRL__S_RWB__MASK                                       0x04000000U
#define SPI_CTRL__S_RWB__READ(src)      (((uint32_t)(src) & 0x04000000U) >> 26)
#define SPI_CTRL__S_RWB__WRITE(src)     (((uint32_t)(src) << 26) & 0x04000000U)
#define SPI_CTRL__S_RWB__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | (((uint32_t)(src) <<\
                    26) & 0x04000000U)
#define SPI_CTRL__S_RWB__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 26) & ~0x04000000U)))
#define SPI_CTRL__S_RWB__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | ((uint32_t)(1) << 26)
#define SPI_CTRL__S_RWB__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x04000000U) | ((uint32_t)(0) << 26)
#define SPI_CTRL__S_RWB__RESET_VALUE                                0x00000000U
/** @} */
...
#define SPI_CTRL__READ                                              0x9fffffffU
#define SPI_CTRL__WRITE                                             0x9fffffffU
...
/* macros for field opcode_dis */
/**
 * @defgroup at_apb_spi_regs_core_opcode_dis_field opcode_dis_field
 * @brief macros for field opcode_dis
 * @details master opcode control  1=opcode byte is not sent out before data-bytes  0=opcode byte is sent out before data-bytes;  It also allows for the opcode field to be used as a data field.  For slaves that doesn't require an opcode, opcode field can be used to send data in case of writes or store data in case of reads
 * @{
 */
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__SHIFT                             16
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__WIDTH                              1
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__MASK                     0x00010000U
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00010000U) >> 16)
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 16) & 0x00010000U)
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00010000U) | (((uint32_t)(src) <<\
                    16) & 0x00010000U)
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 16) & ~0x00010000U)))
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00010000U) | ((uint32_t)(1) << 16)
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00010000U) | ((uint32_t)(0) << 16)
#define SPI_TRANSACTION_SETUP__OPCODE_DIS__RESET_VALUE              0x00000000U
/** @} */
 ...
 * @details master opcode out; requires opcode_dis set to 0.
 * @{
 */
#define SPI_TRANSACTION_SETUP__OPCODE__SHIFT                                 17
#define SPI_TRANSACTION_SETUP__OPCODE__WIDTH                                  8
#define SPI_TRANSACTION_SETUP__OPCODE__MASK                         0x01fe0000U
...
#define SPI_TRANSACTION_SETUP__DUMMY_CYCLES__WIDTH                            6
#define SPI_TRANSACTION_SETUP__DUMMY_CYCLES__MASK                   0xfc000000U
...
/* macros for BlueprintGlobalNameSpace::SPI_transaction_setup_2 */
/**
 * @defgroup at_apb_spi_regs_core_transaction_setup_2 transaction_setup_2
 * @brief master transaction setup 2 definitions.
 * @{
 */
#ifndef __SPI_TRANSACTION_SETUP_2_MACRO__
#define __SPI_TRANSACTION_SETUP_2_MACRO__

/* macros for field dummy_cycles_msb */
/**
 * @defgroup at_apb_spi_regs_core_dummy_cycles_msb_field dummy_cycles_msb_field
 * @brief macros for field dummy_cycles_msb
 * @details msb of the dummy cycles
 * @{
 */
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__SHIFT                      0
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__WIDTH                      2
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__MASK             0x00000003U
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000003U)
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000003U)
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000003U) | ((uint32_t)(src) &\
                    0x00000003U)
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000003U)))
#define SPI_TRANSACTION_SETUP_2__DUMMY_CYCLES_MSB__RESET_VALUE      0x00000000U
/** @} */
#define SPI_TRANSACTION_SETUP_2__TYPE                                  uint32_t
#define SPI_TRANSACTION_SETUP_2__READ                               0x00000003U
#define SPI_TRANSACTION_SETUP_2__WRITE                              0x00000003U
#define SPI_TRANSACTION_SETUP_2__PRESERVED                          0x00000000U
#define SPI_TRANSACTION_SETUP_2__RESET_VALUE                        0x00000000U

#endif /* __SPI_TRANSACTION_SETUP_2_MACRO__ */

/** @} end of transaction_setup_2 */
