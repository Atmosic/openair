...
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATGOODTOTX__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000007U)))
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATGOODTOTX__RESET_VALUE        0x00000001U
/** @} */
...
#define PMUADC_CMPOUT_PARAM_3__CTR_VSTOGOODTOTX__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 3) & ~0x00000038U)))
#define PMUADC_CMPOUT_PARAM_3__CTR_VSTOGOODTOTX__RESET_VALUE        0x00000001U
/** @} */
...
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATGOODFORCPU__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 6) & ~0x000001c0U)))
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATGOODFORCPU__RESET_VALUE      0x00000001U
/** @} */
...
#define PMUADC_CMPOUT_PARAM_3__CTR_VSTOGOODFORCPU__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 9) & ~0x00000e00U)))
#define PMUADC_CMPOUT_PARAM_3__CTR_VSTOGOODFORCPU__RESET_VALUE      0x00000001U
/** @} */
...
/* macros for field ctr_vbatchrg_vstorelargervbat */
/**
 * @defgroup pmu_pmuadc_regs_core_ctr_vbatchrg_vstorelargervbat_field ctr_vbatchrg_vstorelargervbat_field
 * @brief macros for field ctr_vbatchrg_vstorelargervbat
 * @details added to select between two values
 * @{
 */
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__SHIFT          19
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__WIDTH           1
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__MASK  0x00080000U
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00080000U) >> 19)
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__WRITE(src) \
                    (((uint32_t)(src)\
                    << 19) & 0x00080000U)
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00080000U) | (((uint32_t)(src) <<\
                    19) & 0x00080000U)
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 19) & ~0x00080000U)))
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00080000U) | ((uint32_t)(1) << 19)
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00080000U) | ((uint32_t)(0) << 19)
#define PMUADC_CMPOUT_PARAM_3__CTR_VBATCHRG_VSTORELARGERVBAT__RESET_VALUE \
                    0x00000001U
/** @} */
#define PMUADC_CMPOUT_PARAM_3__TYPE                                    uint32_t
#define PMUADC_CMPOUT_PARAM_3__READ                                 0x000fffffU
#define PMUADC_CMPOUT_PARAM_3__WRITE                                0x000fffffU
#define PMUADC_CMPOUT_PARAM_3__PRESERVED                            0x00000000U
#define PMUADC_CMPOUT_PARAM_3__RESET_VALUE                          0x000d4249U
