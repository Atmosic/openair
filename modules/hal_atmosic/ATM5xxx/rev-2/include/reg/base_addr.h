...
typedef struct {
  ...
  __I  uint32_t  TFF1_ADDR;
  __I  uint32_t  RFF1_ADDR;
  __I  uint32_t  TFF2_ADDR;
  __I  uint32_t  RFF2_ADDR;
  __I  uint32_t  TFF3_ADDR;
  __I  uint32_t  RFF3_ADDR;
  __I  uint32_t  TFF4_ADDR;
  __I  uint32_t  RFF4_ADDR;
  __I  uint32_t  TFF5_ADDR;
  __I  uint32_t  RFF5_ADDR;
  __I  uint32_t  TFF6_ADDR;
  __I  uint32_t  RFF6_ADDR;
  __I  uint32_t  TFF7_ADDR;
  __I  uint32_t  RFF7_ADDR;
  __I  uint32_t  TFF0_RPTR;
  __IO uint32_t  TFF0_WPTR;
  __IO uint32_t  RFF0_RPTR;
  __I  uint32_t  RFF0_WPTR;
  __I  uint32_t  TFF1_RPTR;
  __I  uint32_t  TFF1_WPTR;
  __I  uint32_t  RFF1_RPTR;
  __I  uint32_t  RFF1_WPTR;
  __I  uint32_t  TFF2_RPTR;
  __I  uint32_t  TFF2_WPTR;
  __I  uint32_t  RFF2_RPTR;
  __I  uint32_t  RFF2_WPTR;
  __I  uint32_t  TFF3_RPTR;
  __I  uint32_t  TFF3_WPTR;
  __I  uint32_t  RFF3_RPTR;
  __I  uint32_t  RFF3_WPTR;
  __I  uint32_t  TFF4_RPTR;
  __I  uint32_t  TFF4_WPTR;
  __I  uint32_t  RFF4_RPTR;
  __I  uint32_t  RFF4_WPTR;
  __I  uint32_t  TFF5_RPTR;
  __I  uint32_t  TFF5_WPTR;
  __I  uint32_t  RFF5_RPTR;
  __I  uint32_t  RFF5_WPTR;
  __I  uint32_t  TFF6_RPTR;
  __I  uint32_t  TFF6_WPTR;
  __I  uint32_t  RFF6_RPTR;
  __I  uint32_t  RFF6_WPTR;
  __I  uint32_t  TFF7_RPTR;
  __I  uint32_t  TFF7_WPTR;
  __I  uint32_t  RFF7_RPTR;
...
typedef struct {
  ...
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION0;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION1;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION2;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION3;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION4;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION5;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION6;
  __I  uint32_t  RRAM_STICKY_WRITE_PROTECTION7;
  ...
  __I  uint32_t  RRAM_STICKY_READ_PROTECTION0;
  ...
  __IO uint32_t  QSPI_STICKY_WRITE_PROTECTION2;
  __IO uint32_t  QSPI_STICKY_WRITE_PROTECTION3;
  __I  uint32_t  QSPI_STICKY_WRITE_PROTECTION_STATUS0;
  __I  uint32_t  QSPI_STICKY_WRITE_PROTECTION_STATUS1;
  __I  uint32_t  QSPI_STICKY_WRITE_PROTECTION_STATUS2;
  __I  uint32_t  QSPI_STICKY_WRITE_PROTECTION_STATUS3;
  __IO uint32_t  QSPI_STICKY_READ_PROTECTION0;
  __I  uint32_t  QSPI_STICKY_READ_PROTECTION_STATUS0;
...
typedef struct {
  ...
  __IO uint32_t  RX_CTRL;
       uint32_t  RESERVED0[991];
  __I  uint32_t  PID4;
  __I  uint32_t  PID5;
  __I  uint32_t  PID6;
  __I  uint32_t  PID7;
...
typedef struct {
  ...
  __IO uint32_t  TRANSACTION_SETUP_2;
...
typedef struct {
  ...
  __I  uint32_t  KEY_BUF0;
  __I  uint32_t  KEY_BUF1;
  __I  uint32_t  KEY_BUF2;
  __I  uint32_t  KEY_BUF3;
  __I  uint32_t  KEY_BUF4;
  __I  uint32_t  KEY_BUF5;
  __I  uint32_t  KEY_BUF6;
  __I  uint32_t  KEY_BUF7;
  __I  uint32_t  KEY_BUF8;
  __I  uint32_t  KEY_BUF9;
  __I  uint32_t  KEY_BUF10;
  __I  uint32_t  KEY_BUF11;
       uint32_t  RESERVED5[943];
  __I  uint32_t  DEBUG;
  __I  uint32_t  DEBUG2;
  __I  uint32_t  CORE_ID;
  __I  uint32_t  REV_HASH;
...
typedef struct {
  ...
  __IO uint32_t  REMOTE_AHB_SETUP_10;
  __IO uint32_t  REMOTE_AHB_SETUP_11;
  __IO uint32_t  REMOTE_PREFETCH_SETUP;
  __IO uint32_t  REMOTE_CACHE_SETUP;
  __I  uint32_t  REMOTE_STATUS;
  __I  uint32_t  REMOTE_PREFETCH_STATUS;
  __I  uint32_t  REMOTE_AHB_WLE_CNT;
  __I  uint32_t  REMOTE_AHB_WIP_CNT;
  __IO uint32_t  REMOTE_STS_CTRL0;
  __IO uint32_t  REMOTE_STS_CTRL1;
  __I  uint32_t  PREFETCH_STS_CNT0;
  __I  uint32_t  PREFETCH_STS_CNT1;
  __I  uint32_t  PREFETCH_STS_CNT2;
  __I  uint32_t  PREFETCH_STS_CNT3;
  __I  uint32_t  PREFETCH_STS_CNT4;
  __I  uint32_t  PREFETCH_STS_CNT5;
  __I  uint32_t  CACHE_STS_CNT0;
  __I  uint32_t  CACHE_STS_CNT1;
  __IO uint32_t  BURST_PP_CTRL;
       uint32_t  RESERVED0[988];
  __I  uint32_t  CORE_ID;
  __I  uint32_t  REV_HASH;
  __I  uint32_t  REV_KEY;
...
typedef struct {
  ...
  __IO uint32_t  OPMODE1;
  __I  uint32_t  STATUS;
  __I  uint32_t  STATUS1;
  __I  uint32_t  OTP_CFG_LOW;
  __I  uint32_t  OTP_CFG_HIGH;
  __IO uint32_t  T_RD_TIME0;
  __IO uint32_t  T_RD_TIME1;
  __IO uint32_t  T_RD_TIME2;
  __IO uint32_t  T_RD_TIME3;
  __IO uint32_t  T_RD_TIME4;
  __IO uint32_t  T_PR_TIME0;
  __IO uint32_t  T_PR_TIME1;
  __IO uint32_t  T_PR_TIME2;
  __IO uint32_t  T_PR_TIME3;
  __IO uint32_t  T_PR_TIME4;
  __IO uint32_t  T_PR_TIME5;
  __I  uint32_t  INTERRUPT_STATUS;
  __IO uint32_t  INTERRUPT_MASK;
...
typedef struct {
  ...
  __IO uint32_t  APB14_CTRL;
  __IO uint32_t  APB15_CTRL;
  __I  uint32_t  OTP_INIT_LOWER;
  __I  uint32_t  OTP_INIT_UPPER;
...
typedef struct {
  ...
  __IO uint32_t  CSTX2_PHASE_CORR0;
  __IO uint32_t  CSTX2_PHASE_CORR1;
  __IO uint32_t  CSTX2_PHASE_CORR2;
  __IO uint32_t  CSTX2_PHASE_CORR3;
  __IO uint32_t  CSTX2_PHASE_CORR4;
  __IO uint32_t  CSTX2_PHASE_CORR5;
  __IO uint32_t  CSTX2_PHASE_CORR6;
  __IO uint32_t  CSTX3_PHASE_CORR0;
  __IO uint32_t  CSTX3_PHASE_CORR1;
  __IO uint32_t  CSTX3_PHASE_CORR2;
  __IO uint32_t  CSTX3_PHASE_CORR3;
  __IO uint32_t  CSTX3_PHASE_CORR4;
  __IO uint32_t  CSTX3_PHASE_CORR5;
  __IO uint32_t  CSTX3_PHASE_CORR6;
  __IO uint32_t  CSTX4_PHASE_CORR0;
  __IO uint32_t  CSTX4_PHASE_CORR1;
  __IO uint32_t  CSTX4_PHASE_CORR2;
  __IO uint32_t  CSTX4_PHASE_CORR3;
  __IO uint32_t  CSTX4_PHASE_CORR4;
  __IO uint32_t  CSTX4_PHASE_CORR5;
  __IO uint32_t  CSTX4_PHASE_CORR6;
...
typedef struct {
  ...
  __IO uint32_t  PERSISTENT_EXPANSION_CTRL;
  __I  uint32_t  PERSISTENT_EXPANSION_RDATA;
  ...
  __I  uint32_t  BP_CLK_OFF_DUR;
  __IO uint32_t  FLASH2_CONTROL;
  __IO uint32_t  FLASH2_CONTROL2;
       uint32_t  RESERVED0[944];
  __I  uint32_t  CORE_ID;
  __I  uint32_t  REV_HASH;
  __I  uint32_t  REV_KEY;
} CMSDK_AT_APB_PSEQ_CAIRO_TypeDef;
...
typedef struct {
  ...
  __IO uint32_t  RNG_IMR;
  __I  uint32_t  RNG_ISR;
  __O  uint32_t  RNG_ICR;
  __IO uint32_t  TRNG_CONFIG;
  __I  uint32_t  TRNG_VALID;
  __I  uint32_t  EHR_DATA0;
  __I  uint32_t  EHR_DATA1;
  __I  uint32_t  EHR_DATA2;
  __I  uint32_t  EHR_DATA3;
  __I  uint32_t  EHR_DATA4;
  __I  uint32_t  EHR_DATA5;
  __IO uint32_t  RND_SOURCE_ENABLE;
  __IO uint32_t  SAMPLE_CNT1;
  __IO uint32_t  AUTOCORR_STATISTIC;
  __I  uint32_t  TRNG_DEBUG_CONTROL;
       uint32_t  RESERVED1[1];
  __O  uint32_t  TRNG_SW_RESET;
       uint32_t  RESERVED2[29];
  __I  uint32_t  TRNG_BUSY;
  __O  uint32_t  RST_BITS_COUNTER;
       uint32_t  RESERVED3[8];
  __I  uint32_t  RNG_BIST_CNTR0;
  __I  uint32_t  RNG_BIST_CNTR1;
  __I  uint32_t  RNG_BIST_CNTR2;
       uint32_t  RESERVED4[898];
  __I  uint32_t  CORE_ID;
  __I  uint32_t  REV_HASH;
  __I  uint32_t  REV_KEY;
} CMSDK_AT_APB_ARM_TRNG_TypeDef;
...
typedef struct {
  ...
  __IO uint32_t  HARV_CTRL;
  __IO uint32_t  QSPI_CLK_CTRL;
  __I  uint32_t  QSPI_STAT;
...
#define CMSDK_ARM_TRNG_NONSECURE_BASE                     0x4015e000
...
#define CMSDK_BIQUAD_NONSECURE_BASE                       0x4016d000
...
#define CMSDK_ARM_TRNG_SECURE_BASE                        0x5015e000
...
#define CMSDK_BIQUAD_SECURE_BASE                          0x5016d000
...
#define CMSDK_NVM_NONSECURE                               ((CMSDK_AT_APB_UMC_NVM_TypeDef *) CMSDK_NVM_NONSECURE_BASE)
...
#define CMSDK_PSEQ_NONSECURE                              ((CMSDK_AT_APB_PSEQ_CAIRO_TypeDef *) CMSDK_PSEQ_NONSECURE_BASE)
...
#define CMSDK_ARM_TRNG_NONSECURE                          ((CMSDK_AT_APB_ARM_TRNG_TypeDef *) CMSDK_ARM_TRNG_NONSECURE_BASE)
...
#define CMSDK_BIQUAD_NONSECURE                            ((CMSDK_AT_APB_BIQUAD_TypeDef *) CMSDK_BIQUAD_NONSECURE_BASE)
...
#define CMSDK_NVM_SECURE                                  ((CMSDK_AT_APB_UMC_NVM_TypeDef *) CMSDK_NVM_SECURE_BASE)
...
#define CMSDK_PSEQ_SECURE                                 ((CMSDK_AT_APB_PSEQ_CAIRO_TypeDef *) CMSDK_PSEQ_SECURE_BASE)
...
#define CMSDK_ARM_TRNG_SECURE                             ((CMSDK_AT_APB_ARM_TRNG_TypeDef *) CMSDK_ARM_TRNG_SECURE_BASE)
...
#define CMSDK_BIQUAD_SECURE                               ((CMSDK_AT_APB_BIQUAD_TypeDef *) CMSDK_BIQUAD_SECURE_BASE)
