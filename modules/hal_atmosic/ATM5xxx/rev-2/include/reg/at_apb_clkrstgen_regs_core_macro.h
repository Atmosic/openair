...
#define CLKRSTGEN_CLK_BP_CTRL__READ                                 0x00000fffU
#define CLKRSTGEN_CLK_BP_CTRL__WRITE                                0x00000fffU
 ...
 * @details how much to divide the pll to get 16 MHz?  div_val = freq(pll)/16MHz. 0 is undefined.  only gets updated by SW when pll_enable is 0.
 * @{
 */
...
/* macros for field div_bp_val */
/**
 * @defgroup at_apb_clkrstgen_regs_core_div_bp_val_field div_bp_val_field
 * @brief macros for field div_bp_val
 * @details how much to divide the pll to generate clk_bp (backplane clock) at the target frequency  div_bp_val = freq(pll)/freq(clk_bp). 0 is undefined.
 * @{
 */
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__SHIFT                                  8
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__WIDTH                                  4
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__MASK                         0x00000f00U
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000f00U) >> 8)
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__WRITE(src) \
                    (((uint32_t)(src)\
                    << 8) & 0x00000f00U)
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000f00U) | (((uint32_t)(src) <<\
                    8) & 0x00000f00U)
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000f00U)))
#define CLKRSTGEN_CLKSYNC__DIV_BP_VAL__RESET_VALUE                  0x00000001U
/** @} */

/* macros for field div_qspi_val */
/**
 * @defgroup at_apb_clkrstgen_regs_core_div_qspi_val_field div_qspi_val_field
 * @brief macros for field div_qspi_val
 * @details how much to divide the pll to generate clk_qspi at the target frequency.  div_qspi_val = freq(pll)/freq(clk_qspi). 0 is undefined.
 * @{
 */
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__SHIFT                               16
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__WIDTH                                4
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__MASK                       0x000f0000U
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__READ(src) \
                    (((uint32_t)(src)\
                    & 0x000f0000U) >> 16)
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__WRITE(src) \
                    (((uint32_t)(src)\
                    << 16) & 0x000f0000U)
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x000f0000U) | (((uint32_t)(src) <<\
                    16) & 0x000f0000U)
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 16) & ~0x000f0000U)))
#define CLKRSTGEN_CLKSYNC__DIV_QSPI_VAL__RESET_VALUE                0x00000001U
/** @} */
#define CLKRSTGEN_CLKSYNC__TYPE                                        uint32_t
#define CLKRSTGEN_CLKSYNC__READ                                     0x000f0f3fU
#define CLKRSTGEN_CLKSYNC__WRITE                                    0x000f0f3fU
#define CLKRSTGEN_CLKSYNC__PRESERVED                                0x00000000U
#define CLKRSTGEN_CLKSYNC__RESET_VALUE                              0x00010100U
 ...
 * @details ramp-up target frequency  0 = 16M is requested.  1 = doubler cluster is requested  2 = pll cluster is requested (Note: clkrstgen must be running off of PLL prior to WFI to use this choice)
 * @{
 */
#define CLKRSTGEN_FSM_CTRL__TARGET_FREQ__SHIFT                                0
#define CLKRSTGEN_FSM_CTRL__TARGET_FREQ__WIDTH                                2
#define CLKRSTGEN_FSM_CTRL__TARGET_FREQ__MASK                       0x00000003U
 ...
 * @{
 */
#define CLKRSTGEN_FSM_CTRL__CLR_FSM__SHIFT                                    2
#define CLKRSTGEN_FSM_CTRL__CLR_FSM__WIDTH                                    1
#define CLKRSTGEN_FSM_CTRL__CLR_FSM__MASK                           0x00000004U
 ...
 * @{
 */
#define CLKRSTGEN_FSM_CTRL__WAIT4XTAL__SHIFT                                  3
#define CLKRSTGEN_FSM_CTRL__WAIT4XTAL__WIDTH                                  1
#define CLKRSTGEN_FSM_CTRL__WAIT4XTAL__MASK                         0x00000008U
 ...
 * @{
 */
#define CLKRSTGEN_FSM_CTRL__ABORT_FSM__SHIFT                                  4
#define CLKRSTGEN_FSM_CTRL__ABORT_FSM__WIDTH                                  1
#define CLKRSTGEN_FSM_CTRL__ABORT_FSM__MASK                         0x00000010U
...
#define CLKRSTGEN_FSM_CTRL__READ                                    0x007f001fU
#define CLKRSTGEN_FSM_CTRL__WRITE                                   0x007f001fU
#define CLKRSTGEN_FSM_CTRL__PRESERVED                               0x00000000U
#define CLKRSTGEN_FSM_CTRL__RESET_VALUE                             0x00400008U
...
#define CLKRSTGEN_FSM_STATUS__STATE__WIDTH                                   17
#define CLKRSTGEN_FSM_STATUS__STATE__MASK                           0x0001ffffU
#define CLKRSTGEN_FSM_STATUS__STATE__READ(src)  ((uint32_t)(src) & 0x0001ffffU)
...
#define CLKRSTGEN_FSM_STATUS__READ                                  0xc001ffffU
...
/* macros for field clk_cp_src_cairo */
/**
 * @defgroup at_apb_clkrstgen_regs_core_clk_cp_src_cairo_field clk_cp_src_cairo_field
 * @brief macros for field clk_cp_src_cairo
 * @details 0=clk_cp 1=clk_cp_cairo
 * @{
 */
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__SHIFT                        21
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__WIDTH                         1
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__MASK                0x00200000U
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00200000U) >> 21)
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__WRITE(src) \
                    (((uint32_t)(src)\
                    << 21) & 0x00200000U)
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | (((uint32_t)(src) <<\
                    21) & 0x00200000U)
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 21) & ~0x00200000U)))
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | ((uint32_t)(1) << 21)
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00200000U) | ((uint32_t)(0) << 21)
#define CLKRSTGEN_XTAL_BITS0__CLK_CP_SRC_CAIRO__RESET_VALUE         0x00000000U
/** @} */
#define CLKRSTGEN_XTAL_BITS0__TYPE                                     uint32_t
#define CLKRSTGEN_XTAL_BITS0__READ                                  0x003fffffU
#define CLKRSTGEN_XTAL_BITS0__WRITE                                 0x003fffffU
...
/* macros for BlueprintGlobalNameSpace::CLKRSTGEN_harv_ctrl */
/**
 * @defgroup at_apb_clkrstgen_regs_core_harv_ctrl harv_ctrl
 * @brief PMU canharv/mustharv indictaor for clk_cp gate definitions.
 * @{
 */
#ifndef __CLKRSTGEN_HARV_CTRL_MACRO__
#define __CLKRSTGEN_HARV_CTRL_MACRO__

/* macros for field harv_ind_sel */
/**
 * @defgroup at_apb_clkrstgen_regs_core_harv_ind_sel_field harv_ind_sel_field
 * @brief macros for field harv_ind_sel
 * @details selects PMU dig_test_out for clk_bp gate
 * @{
 */
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__SHIFT                              0
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__WIDTH                              1
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__MASK                     0x00000001U
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000001U)))
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define CLKRSTGEN_HARV_CTRL__HARV_IND_SEL__RESET_VALUE              0x00000000U
/** @} */
#define CLKRSTGEN_HARV_CTRL__TYPE                                      uint32_t
#define CLKRSTGEN_HARV_CTRL__READ                                   0x00000001U
#define CLKRSTGEN_HARV_CTRL__WRITE                                  0x00000001U
#define CLKRSTGEN_HARV_CTRL__PRESERVED                              0x00000000U
#define CLKRSTGEN_HARV_CTRL__RESET_VALUE                            0x00000000U

#endif /* __CLKRSTGEN_HARV_CTRL_MACRO__ */

/** @} end of harv_ctrl */

/* macros for BlueprintGlobalNameSpace::CLKRSTGEN_qspi_clk_ctrl */
/**
 * @defgroup at_apb_clkrstgen_regs_core_qspi_clk_ctrl qspi_clk_ctrl
 * @brief Contains register fields associated with qspi_clk_ctrl. definitions.
 * @{
 */
#ifndef __CLKRSTGEN_QSPI_CLK_CTRL_MACRO__
#define __CLKRSTGEN_QSPI_CLK_CTRL_MACRO__

/* macros for field source_sel */
/**
 * @defgroup at_apb_clkrstgen_regs_core_source_sel_field source_sel_field
 * @brief macros for field source_sel
 * @{
 */
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__SHIFT                            0
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__WIDTH                            1
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__MASK                   0x00000001U
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000001U)))
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define CLKRSTGEN_QSPI_CLK_CTRL__SOURCE_SEL__RESET_VALUE            0x00000000U
/** @} */

/* macros for field clk_change_on */
/**
 * @defgroup at_apb_clkrstgen_regs_core_clk_change_on_field clk_change_on_field
 * @brief macros for field clk_change_on
 * @{
 */
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__SHIFT                         1
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__WIDTH                         1
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__MASK                0x00000002U
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000002U) >> 1)
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__WRITE(src) \
                    (((uint32_t)(src)\
                    << 1) & 0x00000002U)
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | (((uint32_t)(src) <<\
                    1) & 0x00000002U)
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 1) & ~0x00000002U)))
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(1) << 1)
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(0) << 1)
#define CLKRSTGEN_QSPI_CLK_CTRL__CLK_CHANGE_ON__RESET_VALUE         0x00000000U
/** @} */
#define CLKRSTGEN_QSPI_CLK_CTRL__TYPE                                  uint32_t
#define CLKRSTGEN_QSPI_CLK_CTRL__READ                               0x00000003U
#define CLKRSTGEN_QSPI_CLK_CTRL__WRITE                              0x00000003U
#define CLKRSTGEN_QSPI_CLK_CTRL__PRESERVED                          0x00000000U
#define CLKRSTGEN_QSPI_CLK_CTRL__RESET_VALUE                        0x00000000U

#endif /* __CLKRSTGEN_QSPI_CLK_CTRL_MACRO__ */

/** @} end of qspi_clk_ctrl */

/* macros for BlueprintGlobalNameSpace::CLKRSTGEN_qspi_stat */
/**
 * @defgroup at_apb_clkrstgen_regs_core_qspi_stat qspi_stat
 * @brief Contains register fields associated with qspi_stat. definitions.
 * @{
 */
#ifndef __CLKRSTGEN_QSPI_STAT_MACRO__
#define __CLKRSTGEN_QSPI_STAT_MACRO__

/* macros for field clk_actv_req */
/**
 * @defgroup at_apb_clkrstgen_regs_core_clk_actv_req_field clk_actv_req_field
 * @brief macros for field clk_actv_req
 * @details 1=ahb_qspi is running
 * @{
 */
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__SHIFT                              0
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__WIDTH                              1
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__MASK                     0x00000001U
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define CLKRSTGEN_QSPI_STAT__CLK_ACTV_REQ__RESET_VALUE              0x00000000U
/** @} */
#define CLKRSTGEN_QSPI_STAT__TYPE                                      uint32_t
#define CLKRSTGEN_QSPI_STAT__READ                                   0x00000001U
#define CLKRSTGEN_QSPI_STAT__PRESERVED                              0x00000000U
#define CLKRSTGEN_QSPI_STAT__RESET_VALUE                            0x00000000U

#endif /* __CLKRSTGEN_QSPI_STAT_MACRO__ */
...
#define CLKRSTGEN_REV_HASH__ID__RESET_VALUE                         0xaabd9222U
/** @} */
...
#define CLKRSTGEN_REV_HASH__RESET_VALUE                             0xaabd9222U
