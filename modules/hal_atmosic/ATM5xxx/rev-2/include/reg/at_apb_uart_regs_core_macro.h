...
#define CMSDK_AT_UART_DATA_DATA_Pos             CMSDK_AT_UART_DATA__DATA__SHIFT
#define CMSDK_AT_UART_DATA_DATA_Msk              CMSDK_AT_UART_DATA__DATA__MASK
#define CMSDK_UART_DATA_DATA_Pos                CMSDK_AT_UART_DATA__DATA__SHIFT
#define CMSDK_UART_DATA_DATA_Msk                 CMSDK_AT_UART_DATA__DATA__MASK
...
/* macros for field parity_err */
/**
 * @defgroup at_apb_uart_regs_core_parity_err_field parity_err_field
 * @brief macros for field parity_err
 * @details 1 = parity check error.
 * @{
 */
#define CMSDK_AT_UART_DATA__PARITY_ERR__SHIFT                                 8
#define CMSDK_AT_UART_DATA__PARITY_ERR__WIDTH                                 1
#define CMSDK_AT_UART_DATA__PARITY_ERR__MASK                        0x00000100U
#define CMSDK_AT_UART_DATA_PARITY_ERR_Pos CMSDK_AT_UART_DATA__PARITY_ERR__SHIFT
#define CMSDK_AT_UART_DATA_PARITY_ERR_Msk  CMSDK_AT_UART_DATA__PARITY_ERR__MASK
#define CMSDK_UART_DATA_PARITY_ERR_Pos    CMSDK_AT_UART_DATA__PARITY_ERR__SHIFT
#define CMSDK_UART_DATA_PARITY_ERR_Msk     CMSDK_AT_UART_DATA__PARITY_ERR__MASK
#define CMSDK_AT_UART_DATA__PARITY_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000100U) >> 8)
#define CMSDK_AT_UART_DATA__PARITY_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 8) & 0x00000100U)
#define CMSDK_AT_UART_DATA__PARITY_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | (((uint32_t)(src) <<\
                    8) & 0x00000100U)
#define CMSDK_AT_UART_DATA__PARITY_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000100U)))
#define CMSDK_AT_UART_DATA__PARITY_ERR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(1) << 8)
#define CMSDK_AT_UART_DATA__PARITY_ERR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000100U) | ((uint32_t)(0) << 8)
#define CMSDK_AT_UART_DATA__PARITY_ERR__RESET_VALUE                 0x00000000U
/** @} */
 ...
 * @details 2'b00 = no stop bit errors 2'b01 = 1st stop bit error 2'b10 = 2nd stop bit error 2'b11 = both stop bits error.
 * @{
 */
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__SHIFT                               9
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__WIDTH                               2
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__MASK                      0x00000600U
#define CMSDK_AT_UART_DATA_STOP_BIT_ERR_Pos \
                    CMSDK_AT_UART_DATA__STOP_BIT_ERR__SHIFT
#define CMSDK_AT_UART_DATA_STOP_BIT_ERR_Msk \
                    CMSDK_AT_UART_DATA__STOP_BIT_ERR__MASK
#define CMSDK_UART_DATA_STOP_BIT_ERR_Pos \
                    CMSDK_AT_UART_DATA__STOP_BIT_ERR__SHIFT
#define CMSDK_UART_DATA_STOP_BIT_ERR_Msk CMSDK_AT_UART_DATA__STOP_BIT_ERR__MASK
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000600U) >> 9)
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 9) & 0x00000600U)
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000600U) | (((uint32_t)(src) <<\
                    9) & 0x00000600U)
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 9) & ~0x00000600U)))
#define CMSDK_AT_UART_DATA__STOP_BIT_ERR__RESET_VALUE               0x00000000U
/** @} */
#define CMSDK_AT_UART_DATA__TYPE                                       uint32_t
#define CMSDK_AT_UART_DATA__READ                                    0x000007ffU
#define CMSDK_AT_UART_DATA__WRITE                                   0x000007ffU
...
/**
 * @defgroup at_apb_uart_regs_core_rsvd_field rsvd_field
 * @brief macros for field rsvd
 * @details reserved
 * @{
 */
#define CMSDK_AT_UART_STATE__RSVD__SHIFT                                      6
#define CMSDK_AT_UART_STATE__RSVD__WIDTH                                      1
#define CMSDK_AT_UART_STATE__RSVD__MASK                             0x00000040U
#define CMSDK_AT_UART_STATE_RSVD_Pos           CMSDK_AT_UART_STATE__RSVD__SHIFT
#define CMSDK_AT_UART_STATE_RSVD_Msk            CMSDK_AT_UART_STATE__RSVD__MASK
#define CMSDK_UART_STATE_RSVD_Pos              CMSDK_AT_UART_STATE__RSVD__SHIFT
#define CMSDK_UART_STATE_RSVD_Msk               CMSDK_AT_UART_STATE__RSVD__MASK
#define CMSDK_AT_UART_STATE__RSVD__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000040U) >> 6)
#define CMSDK_AT_UART_STATE__RSVD__WRITE(src) \
                    (((uint32_t)(src)\
                    << 6) & 0x00000040U)
#define CMSDK_AT_UART_STATE__RSVD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | (((uint32_t)(src) <<\
                    6) & 0x00000040U)
#define CMSDK_AT_UART_STATE__RSVD__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 6) & ~0x00000040U)))
#define CMSDK_AT_UART_STATE__RSVD__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | ((uint32_t)(1) << 6)
#define CMSDK_AT_UART_STATE__RSVD__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000040U) | ((uint32_t)(0) << 6)
#define CMSDK_AT_UART_STATE__RSVD__RESET_VALUE                      0x00000000U
/** @} */
...
/* macros for field rx_idle */
/**
 * @defgroup at_apb_uart_regs_core_rx_idle_field rx_idle_field
 * @brief macros for field rx_idle
 * @details 1=rx state is idle (Read only) // (Atmosic)
 * @{
 */
#define CMSDK_AT_UART_STATE__RX_IDLE__SHIFT                                   9
#define CMSDK_AT_UART_STATE__RX_IDLE__WIDTH                                   1
#define CMSDK_AT_UART_STATE__RX_IDLE__MASK                          0x00000200U
#define CMSDK_AT_UART_STATE_RX_IDLE_Pos     CMSDK_AT_UART_STATE__RX_IDLE__SHIFT
#define CMSDK_AT_UART_STATE_RX_IDLE_Msk      CMSDK_AT_UART_STATE__RX_IDLE__MASK
#define CMSDK_UART_STATE_RX_IDLE_Pos        CMSDK_AT_UART_STATE__RX_IDLE__SHIFT
#define CMSDK_UART_STATE_RX_IDLE_Msk         CMSDK_AT_UART_STATE__RX_IDLE__MASK
#define CMSDK_AT_UART_STATE__RX_IDLE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000200U) >> 9)
#define CMSDK_AT_UART_STATE__RX_IDLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 9) & 0x00000200U)
#define CMSDK_AT_UART_STATE__RX_IDLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000200U) | (((uint32_t)(src) <<\
                    9) & 0x00000200U)
#define CMSDK_AT_UART_STATE__RX_IDLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 9) & ~0x00000200U)))
#define CMSDK_AT_UART_STATE__RX_IDLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000200U) | ((uint32_t)(1) << 9)
#define CMSDK_AT_UART_STATE__RX_IDLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000200U) | ((uint32_t)(0) << 9)
#define CMSDK_AT_UART_STATE__RX_IDLE__RESET_VALUE                   0x00000000U
/** @} */
#define CMSDK_AT_UART_STATE__TYPE                                      uint32_t
#define CMSDK_AT_UART_STATE__READ                                   0x000003ffU
#define CMSDK_AT_UART_STATE__WRITE                                  0x000003ffU
 ...
 * @defgroup at_apb_uart_regs_core_rsvd_field rsvd_field
 * @brief macros for field rsvd
 * @details reserved; previously used in legacy parity implementation {odd_parity, parity_mode}
 * @{
 */
#define CMSDK_AT_UART_CTRL__RSVD__SHIFT                                       9
#define CMSDK_AT_UART_CTRL__RSVD__WIDTH                                       2
#define CMSDK_AT_UART_CTRL__RSVD__MASK                              0x00000600U
#define CMSDK_AT_UART_CTRL_RSVD_Pos             CMSDK_AT_UART_CTRL__RSVD__SHIFT
#define CMSDK_AT_UART_CTRL_RSVD_Msk              CMSDK_AT_UART_CTRL__RSVD__MASK
#define CMSDK_UART_CTRL_RSVD_Pos                CMSDK_AT_UART_CTRL__RSVD__SHIFT
#define CMSDK_UART_CTRL_RSVD_Msk                 CMSDK_AT_UART_CTRL__RSVD__MASK
#define CMSDK_AT_UART_CTRL__RSVD__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000600U) >> 9)
#define CMSDK_AT_UART_CTRL__RSVD__WRITE(src) \
                    (((uint32_t)(src)\
                    << 9) & 0x00000600U)
#define CMSDK_AT_UART_CTRL__RSVD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000600U) | (((uint32_t)(src) <<\
                    9) & 0x00000600U)
#define CMSDK_AT_UART_CTRL__RSVD__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 9) & ~0x00000600U)))
#define CMSDK_AT_UART_CTRL__RSVD__RESET_VALUE                       0x00000000U
/** @} */

/* macros for field enable_loopback */
/**
 * @defgroup at_apb_uart_regs_core_enable_loopback_field enable_loopback_field
 * @brief macros for field enable_loopback
 * @{
 */
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__SHIFT                           11
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__WIDTH                            1
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__MASK                   0x00000800U
#define CMSDK_AT_UART_CTRL_ENABLE_LOOPBACK_Pos \
                    CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__SHIFT
#define CMSDK_AT_UART_CTRL_ENABLE_LOOPBACK_Msk \
                    CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__MASK
#define CMSDK_UART_CTRL_ENABLE_LOOPBACK_Pos \
                    CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__SHIFT
#define CMSDK_UART_CTRL_ENABLE_LOOPBACK_Msk \
                    CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__MASK
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000800U) >> 11)
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__WRITE(src) \
                    (((uint32_t)(src)\
                    << 11) & 0x00000800U)
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000800U) | (((uint32_t)(src) <<\
                    11) & 0x00000800U)
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 11) & ~0x00000800U)))
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000800U) | ((uint32_t)(1) << 11)
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000800U) | ((uint32_t)(0) << 11)
#define CMSDK_AT_UART_CTRL__ENABLE_LOOPBACK__RESET_VALUE            0x00000000U
/** @} */
#define CMSDK_AT_UART_CTRL__TYPE                                       uint32_t
#define CMSDK_AT_UART_CTRL__READ                                    0x00000fffU
#define CMSDK_AT_UART_CTRL__WRITE                                   0x00000fffU
...
/* macros for field rx_parity_err */
/**
 * @defgroup at_apb_uart_regs_core_rx_parity_err_field rx_parity_err_field
 * @brief macros for field rx_parity_err
 * @details parity check error overloaded on rx_overflow_intr. Write 1 to clear
 * @{
 */
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__SHIFT                         4
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__WIDTH                         1
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__MASK                0x00000010U
#define CMSDK_AT_UART_INTSTATUS_RX_PARITY_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__SHIFT
#define CMSDK_AT_UART_INTSTATUS_RX_PARITY_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__MASK
#define CMSDK_UART_INTSTATUS_RX_PARITY_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__SHIFT
#define CMSDK_UART_INTSTATUS_RX_PARITY_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__MASK
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define CMSDK_AT_UART_INTSTATUS__RX_PARITY_ERR__RESET_VALUE         0x00000000U
/** @} */

/* macros for field rx_stop_bits_err */
/**
 * @defgroup at_apb_uart_regs_core_rx_stop_bits_err_field rx_stop_bits_err_field
 * @brief macros for field rx_stop_bits_err
 * @details stop bits error overloaded on rx_overflow_intr. write > 0 to clear both bits.
 * @{
 */
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__SHIFT                      5
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__WIDTH                      2
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__MASK             0x00000060U
#define CMSDK_AT_UART_INTSTATUS_RX_STOP_BITS_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__SHIFT
#define CMSDK_AT_UART_INTSTATUS_RX_STOP_BITS_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__MASK
#define CMSDK_UART_INTSTATUS_RX_STOP_BITS_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__SHIFT
#define CMSDK_UART_INTSTATUS_RX_STOP_BITS_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__MASK
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000060U) >> 5)
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x00000060U)
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000060U) | (((uint32_t)(src) <<\
                    5) & 0x00000060U)
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x00000060U)))
#define CMSDK_AT_UART_INTSTATUS__RX_STOP_BITS_ERR__RESET_VALUE      0x00000000U
/** @} */
#define CMSDK_AT_UART_INTSTATUS__TYPE                                  uint32_t
#define CMSDK_AT_UART_INTSTATUS__READ                               0x0000007fU
#define CMSDK_AT_UART_INTSTATUS__WRITE                              0x0000007fU
...
/* macros for field rx_parity_err_en */
/**
 * @defgroup at_apb_uart_regs_core_rx_parity_err_en_field rx_parity_err_en_field
 * @brief macros for field rx_parity_err_en
 * @details mask enable for rx_parity error, which is overloaded on RX overflow interrupt,
 * @{
 */
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__SHIFT                        4
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__WIDTH                        1
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__MASK               0x00000010U
#define CMSDK_AT_UART_INTMASK_RX_PARITY_ERR_EN_Pos \
                    CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__SHIFT
#define CMSDK_AT_UART_INTMASK_RX_PARITY_ERR_EN_Msk \
                    CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__MASK
#define CMSDK_UART_INTMASK_RX_PARITY_ERR_EN_Pos \
                    CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__SHIFT
#define CMSDK_UART_INTMASK_RX_PARITY_ERR_EN_Msk \
                    CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__MASK
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define CMSDK_AT_UART_INTMASK__RX_PARITY_ERR_EN__RESET_VALUE        0x00000000U
/** @} */

/* macros for field rx_stop_bits_err_en */
/**
 * @defgroup at_apb_uart_regs_core_rx_stop_bits_err_en_field rx_stop_bits_err_en_field
 * @brief macros for field rx_stop_bits_err_en
 * @details mask enable for rx_stop_bits error, which is overloaded on RX overflow interrupt,
 * @{
 */
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__SHIFT                     5
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__WIDTH                     1
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__MASK            0x00000020U
#define CMSDK_AT_UART_INTMASK_RX_STOP_BITS_ERR_EN_Pos \
                    CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__SHIFT
#define CMSDK_AT_UART_INTMASK_RX_STOP_BITS_ERR_EN_Msk \
                    CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__MASK
#define CMSDK_UART_INTMASK_RX_STOP_BITS_ERR_EN_Pos \
                    CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__SHIFT
#define CMSDK_UART_INTMASK_RX_STOP_BITS_ERR_EN_Msk \
                    CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__MASK
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000020U) >> 5)
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x00000020U)
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | (((uint32_t)(src) <<\
                    5) & 0x00000020U)
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x00000020U)))
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(1) << 5)
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(0) << 5)
#define CMSDK_AT_UART_INTMASK__RX_STOP_BITS_ERR_EN__RESET_VALUE     0x00000000U
/** @} */
#define CMSDK_AT_UART_INTMASK__TYPE                                    uint32_t
#define CMSDK_AT_UART_INTMASK__READ                                 0x0000003fU
#define CMSDK_AT_UART_INTMASK__WRITE                                0x0000003fU
 ...
 * @defgroup at_apb_uart_regs_core_rx_parity_err_field rx_parity_err_field
 * @brief macros for field rx_parity_err
 * @details parity check error overloaded on rx_overflow_intr. (READ_ONLY)
 * @{
 */
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__SHIFT                     4
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__WIDTH                     1
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__MASK            0x00000010U
#define CMSDK_AT_UART_INTSTATUS_SET_RX_PARITY_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__SHIFT
#define CMSDK_AT_UART_INTSTATUS_SET_RX_PARITY_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__MASK
#define CMSDK_UART_INTSTATUS_SET_RX_PARITY_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__SHIFT
#define CMSDK_UART_INTSTATUS_SET_RX_PARITY_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__MASK
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_PARITY_ERR__RESET_VALUE     0x00000000U
/** @} */
 ...
 * @defgroup at_apb_uart_regs_core_rx_stop_bits_err_field rx_stop_bits_err_field
 * @brief macros for field rx_stop_bits_err
 * @details stop bits error overloaded on rx_overflow_intr. (READ_ONLY)
 * @{
 */
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__SHIFT                  5
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__WIDTH                  2
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__MASK         0x00000060U
#define CMSDK_AT_UART_INTSTATUS_SET_RX_STOP_BITS_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__SHIFT
#define CMSDK_AT_UART_INTSTATUS_SET_RX_STOP_BITS_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__MASK
#define CMSDK_UART_INTSTATUS_SET_RX_STOP_BITS_ERR_Pos \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__SHIFT
#define CMSDK_UART_INTSTATUS_SET_RX_STOP_BITS_ERR_Msk \
                    CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__MASK
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000060U) >> 5)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x00000060U)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000060U) | (((uint32_t)(src) <<\
                    5) & 0x00000060U)
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x00000060U)))
#define CMSDK_AT_UART_INTSTATUS_SET__RX_STOP_BITS_ERR__RESET_VALUE  0x00000000U
/** @} */
#define CMSDK_AT_UART_INTSTATUS_SET__TYPE                              uint32_t
#define CMSDK_AT_UART_INTSTATUS_SET__READ                           0x0000007fU
#define CMSDK_AT_UART_INTSTATUS_SET__WRITE                          0x0000007fU
...
/* macros for BlueprintGlobalNameSpace::CMSDK_AT_UART_TX_CTRL */
/**
 * @defgroup at_apb_uart_regs_core_TX_CTRL TX_CTRL
 * @brief Contains register fields associated with TX_CTRL. definitions.
 * @{
 */
#ifndef __CMSDK_AT_UART_TX_CTRL_MACRO__
#define __CMSDK_AT_UART_TX_CTRL_MACRO__

/* macros for field parity_enable */
/**
 * @defgroup at_apb_uart_regs_core_parity_enable_field parity_enable_field
 * @brief macros for field parity_enable
 * @details 0 = no parity bit, 1 = parity enabled
 * @{
 */
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__SHIFT                           0
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__WIDTH                           1
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__MASK                  0x00000001U
#define CMSDK_AT_UART_TX_CTRL_PARITY_ENABLE_Pos \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__SHIFT
#define CMSDK_AT_UART_TX_CTRL_PARITY_ENABLE_Msk \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__MASK
#define CMSDK_UART_TX_CTRL_PARITY_ENABLE_Pos \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__SHIFT
#define CMSDK_UART_TX_CTRL_PARITY_ENABLE_Msk \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__MASK
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000001U)))
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ENABLE__RESET_VALUE           0x00000000U
/** @} */

/* macros for field parity_oddneven */
/**
 * @defgroup at_apb_uart_regs_core_parity_oddneven_field parity_oddneven_field
 * @brief macros for field parity_oddneven
 * @details 0 = even parity, 1 = odd parity
 * @{
 */
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__SHIFT                         1
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__WIDTH                         1
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__MASK                0x00000002U
#define CMSDK_AT_UART_TX_CTRL_PARITY_ODDNEVEN_Pos \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__SHIFT
#define CMSDK_AT_UART_TX_CTRL_PARITY_ODDNEVEN_Msk \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__MASK
#define CMSDK_UART_TX_CTRL_PARITY_ODDNEVEN_Pos \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__SHIFT
#define CMSDK_UART_TX_CTRL_PARITY_ODDNEVEN_Msk \
                    CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__MASK
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000002U) >> 1)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 1) & 0x00000002U)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | (((uint32_t)(src) <<\
                    1) & 0x00000002U)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 1) & ~0x00000002U)))
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(1) << 1)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(0) << 1)
#define CMSDK_AT_UART_TX_CTRL__PARITY_ODDNEVEN__RESET_VALUE         0x00000000U
/** @} */

/* macros for field has_2_stop_bits */
/**
 * @defgroup at_apb_uart_regs_core_has_2_stop_bits_field has_2_stop_bits_field
 * @brief macros for field has_2_stop_bits
 * @details 0 = TX has one stop bit, 1 = TX has two stop bits
 * @{
 */
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__SHIFT                         2
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__WIDTH                         1
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__MASK                0x00000004U
#define CMSDK_AT_UART_TX_CTRL_HAS_2_STOP_BITS_Pos \
                    CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__SHIFT
#define CMSDK_AT_UART_TX_CTRL_HAS_2_STOP_BITS_Msk \
                    CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__MASK
#define CMSDK_UART_TX_CTRL_HAS_2_STOP_BITS_Pos \
                    CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__SHIFT
#define CMSDK_UART_TX_CTRL_HAS_2_STOP_BITS_Msk \
                    CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__MASK
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000004U) >> 2)
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 2) & 0x00000004U)
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | (((uint32_t)(src) <<\
                    2) & 0x00000004U)
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 2) & ~0x00000004U)))
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(1) << 2)
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(0) << 2)
#define CMSDK_AT_UART_TX_CTRL__HAS_2_STOP_BITS__RESET_VALUE         0x00000000U
/** @} */
#define CMSDK_AT_UART_TX_CTRL__TYPE                                    uint32_t
#define CMSDK_AT_UART_TX_CTRL__READ                                 0x00000007U
#define CMSDK_AT_UART_TX_CTRL__WRITE                                0x00000007U
#define CMSDK_AT_UART_TX_CTRL__PRESERVED                            0x00000000U
#define CMSDK_AT_UART_TX_CTRL__RESET_VALUE                          0x00000000U

#endif /* __CMSDK_AT_UART_TX_CTRL_MACRO__ */

/** @} end of TX_CTRL */

/* macros for BlueprintGlobalNameSpace::CMSDK_AT_UART_RX_CTRL */
/**
 * @defgroup at_apb_uart_regs_core_RX_CTRL RX_CTRL
 * @brief Contains register fields associated with RX_CTRL. definitions.
 * @{
 */
#ifndef __CMSDK_AT_UART_RX_CTRL_MACRO__
#define __CMSDK_AT_UART_RX_CTRL_MACRO__
 ...
 * @{
 */
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__SHIFT                           0
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__WIDTH                           1
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__MASK                  0x00000001U
#define CMSDK_AT_UART_RX_CTRL_PARITY_ENABLE_Pos \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__SHIFT
#define CMSDK_AT_UART_RX_CTRL_PARITY_ENABLE_Msk \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__MASK
#define CMSDK_UART_RX_CTRL_PARITY_ENABLE_Pos \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__SHIFT
#define CMSDK_UART_RX_CTRL_PARITY_ENABLE_Msk \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__MASK
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000001U)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000001U)))
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ENABLE__RESET_VALUE           0x00000000U
/** @} */
 ...
 * @{
 */
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__SHIFT                         1
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__WIDTH                         1
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__MASK                0x00000002U
#define CMSDK_AT_UART_RX_CTRL_PARITY_ODDNEVEN_Pos \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__SHIFT
#define CMSDK_AT_UART_RX_CTRL_PARITY_ODDNEVEN_Msk \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__MASK
#define CMSDK_UART_RX_CTRL_PARITY_ODDNEVEN_Pos \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__SHIFT
#define CMSDK_UART_RX_CTRL_PARITY_ODDNEVEN_Msk \
                    CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__MASK
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000002U) >> 1)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 1) & 0x00000002U)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | (((uint32_t)(src) <<\
                    1) & 0x00000002U)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 1) & ~0x00000002U)))
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(1) << 1)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(0) << 1)
#define CMSDK_AT_UART_RX_CTRL__PARITY_ODDNEVEN__RESET_VALUE         0x00000000U
/** @} */
 ...
 * @{
 */
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__SHIFT                         2
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__WIDTH                         1
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__MASK                0x00000004U
#define CMSDK_AT_UART_RX_CTRL_HAS_2_STOP_BITS_Pos \
                    CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__SHIFT
#define CMSDK_AT_UART_RX_CTRL_HAS_2_STOP_BITS_Msk \
                    CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__MASK
#define CMSDK_UART_RX_CTRL_HAS_2_STOP_BITS_Pos \
                    CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__SHIFT
#define CMSDK_UART_RX_CTRL_HAS_2_STOP_BITS_Msk \
                    CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__MASK
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000004U) >> 2)
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 2) & 0x00000004U)
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | (((uint32_t)(src) <<\
                    2) & 0x00000004U)
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 2) & ~0x00000004U)))
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(1) << 2)
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(0) << 2)
#define CMSDK_AT_UART_RX_CTRL__HAS_2_STOP_BITS__RESET_VALUE         0x00000000U
/** @} */
#define CMSDK_AT_UART_RX_CTRL__TYPE                                    uint32_t
#define CMSDK_AT_UART_RX_CTRL__READ                                 0x00000007U
#define CMSDK_AT_UART_RX_CTRL__WRITE                                0x00000007U
#define CMSDK_AT_UART_RX_CTRL__PRESERVED                            0x00000000U
#define CMSDK_AT_UART_RX_CTRL__RESET_VALUE                          0x00000000U

#endif /* __CMSDK_AT_UART_RX_CTRL_MACRO__ */
...
/* macros for BlueprintGlobalNameSpace::CMSDK_AT_UART_core_id */
/**
 * @defgroup at_apb_uart_regs_core_core_id core_id
 * @brief Contains register fields associated with core_id. definitions.
 * @{
 */
#ifndef __CMSDK_AT_UART_CORE_ID_MACRO__
#define __CMSDK_AT_UART_CORE_ID_MACRO__

/* macros for field id */
/**
 * @defgroup at_apb_uart_regs_core_id_field id_field
 * @brief macros for field id
 * @details UART in ASCII
 * @{
 */
#define CMSDK_AT_UART_CORE_ID__ID__SHIFT                                      0
#define CMSDK_AT_UART_CORE_ID__ID__WIDTH                                     32
#define CMSDK_AT_UART_CORE_ID__ID__MASK                             0xffffffffU
#define CMSDK_AT_UART_CORE_ID_Pos              CMSDK_AT_UART_CORE_ID__ID__SHIFT
#define CMSDK_AT_UART_CORE_ID_Msk               CMSDK_AT_UART_CORE_ID__ID__MASK
#define CMSDK_UART_CORE_ID_Pos                 CMSDK_AT_UART_CORE_ID__ID__SHIFT
#define CMSDK_UART_CORE_ID_Msk                  CMSDK_AT_UART_CORE_ID__ID__MASK
#define CMSDK_AT_UART_CORE_ID__ID__READ(src)    ((uint32_t)(src) & 0xffffffffU)
#define CMSDK_AT_UART_CORE_ID__ID__RESET_VALUE                      0x55415254U
/** @} */
#define CMSDK_AT_UART_CORE_ID__TYPE                                    uint32_t
#define CMSDK_AT_UART_CORE_ID__READ                                 0xffffffffU
#define CMSDK_AT_UART_CORE_ID__PRESERVED                            0x00000000U
#define CMSDK_AT_UART_CORE_ID__RESET_VALUE                          0x55415254U

#endif /* __CMSDK_AT_UART_CORE_ID_MACRO__ */

/** @} end of core_id */

/* macros for BlueprintGlobalNameSpace::CMSDK_AT_UART_rev_hash */
/**
 * @defgroup at_apb_uart_regs_core_rev_hash rev_hash
 * @brief Contains register fields associated with rev_hash. definitions.
 * @{
 */
#ifndef __CMSDK_AT_UART_REV_HASH_MACRO__
#define __CMSDK_AT_UART_REV_HASH_MACRO__
 ...
 * @{
 */
#define CMSDK_AT_UART_REV_HASH__ID__SHIFT                                     0
#define CMSDK_AT_UART_REV_HASH__ID__WIDTH                                    32
#define CMSDK_AT_UART_REV_HASH__ID__MASK                            0xffffffffU
#define CMSDK_AT_UART_REV_HASH_Pos            CMSDK_AT_UART_REV_HASH__ID__SHIFT
#define CMSDK_AT_UART_REV_HASH_Msk             CMSDK_AT_UART_REV_HASH__ID__MASK
#define CMSDK_UART_REV_HASH_Pos               CMSDK_AT_UART_REV_HASH__ID__SHIFT
#define CMSDK_UART_REV_HASH_Msk                CMSDK_AT_UART_REV_HASH__ID__MASK
#define CMSDK_AT_UART_REV_HASH__ID__READ(src)   ((uint32_t)(src) & 0xffffffffU)
#define CMSDK_AT_UART_REV_HASH__ID__RESET_VALUE                     0xd5fa6f85U
/** @} */
#define CMSDK_AT_UART_REV_HASH__TYPE                                   uint32_t
#define CMSDK_AT_UART_REV_HASH__READ                                0xffffffffU
#define CMSDK_AT_UART_REV_HASH__PRESERVED                           0x00000000U
#define CMSDK_AT_UART_REV_HASH__RESET_VALUE                         0xd5fa6f85U

#endif /* __CMSDK_AT_UART_REV_HASH_MACRO__ */

/** @} end of rev_hash */

/* macros for BlueprintGlobalNameSpace::CMSDK_AT_UART_rev_key */
/**
 * @defgroup at_apb_uart_regs_core_rev_key rev_key
 * @brief Contains register fields associated with rev_key. definitions.
 * @{
 */
#ifndef __CMSDK_AT_UART_REV_KEY_MACRO__
#define __CMSDK_AT_UART_REV_KEY_MACRO__
 ...
 * @{
 */
#define CMSDK_AT_UART_REV_KEY__ID__SHIFT                                      0
#define CMSDK_AT_UART_REV_KEY__ID__WIDTH                                     32
#define CMSDK_AT_UART_REV_KEY__ID__MASK                             0xffffffffU
#define CMSDK_AT_UART_REV_KEY_Pos              CMSDK_AT_UART_REV_KEY__ID__SHIFT
#define CMSDK_AT_UART_REV_KEY_Msk               CMSDK_AT_UART_REV_KEY__ID__MASK
#define CMSDK_UART_REV_KEY_Pos                 CMSDK_AT_UART_REV_KEY__ID__SHIFT
#define CMSDK_UART_REV_KEY_Msk                  CMSDK_AT_UART_REV_KEY__ID__MASK
#define CMSDK_AT_UART_REV_KEY__ID__READ(src)    ((uint32_t)(src) & 0xffffffffU)
#define CMSDK_AT_UART_REV_KEY__ID__RESET_VALUE                      0x52455620U
/** @} */
#define CMSDK_AT_UART_REV_KEY__TYPE                                    uint32_t
#define CMSDK_AT_UART_REV_KEY__READ                                 0xffffffffU
#define CMSDK_AT_UART_REV_KEY__PRESERVED                            0x00000000U
#define CMSDK_AT_UART_REV_KEY__RESET_VALUE                          0x52455620U

#endif /* __CMSDK_AT_UART_REV_KEY_MACRO__ */
