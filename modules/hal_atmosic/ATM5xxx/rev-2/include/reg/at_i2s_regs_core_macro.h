...
/* macros for field thrshld_dr */
/**
 * @defgroup at_i2s_regs_core_thrshld_dr_field thrshld_dr_field
 * @brief macros for field thrshld_dr
 * @details 0 = trigger thrshld hit when previous cnt was higher or lower, 1 = trigger thrshld hit when previous cnt was lower, 2 = trigger thrshld hit when previous cnt was higher
 * @{
 */
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__SHIFT                                 8
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__WIDTH                                 2
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__MASK                        0x00000300U
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000300U) >> 8)
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 8) & 0x00000300U)
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000300U) | (((uint32_t)(src) <<\
                    8) & 0x00000300U)
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000300U)))
#define ATI2S_I2S_PP1_CTRL__THRSHLD_DR__RESET_VALUE                 0x00000000U
/** @} */
#define ATI2S_I2S_PP1_CTRL__TYPE                                       uint32_t
#define ATI2S_I2S_PP1_CTRL__READ                                    0x0000037fU
#define ATI2S_I2S_PP1_CTRL__WRITE                                   0x0000037fU
 ...
 * @{
 */
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__SHIFT                                 8
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__WIDTH                                 2
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__MASK                        0x00000300U
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000300U) >> 8)
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 8) & 0x00000300U)
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000300U) | (((uint32_t)(src) <<\
                    8) & 0x00000300U)
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000300U)))
#define ATI2S_I2S_PP0_CTRL__THRSHLD_DR__RESET_VALUE                 0x00000000U
/** @} */
#define ATI2S_I2S_PP0_CTRL__TYPE                                       uint32_t
#define ATI2S_I2S_PP0_CTRL__READ                                    0x0000037fU
#define ATI2S_I2S_PP0_CTRL__WRITE                                   0x0000037fU
...
/* macros for BlueprintGlobalNameSpace::ATI2S_pp0_st */
/**
 * @defgroup at_i2s_regs_core_pp0_st pp0_st
 * @brief Contains register fields associated with pp0_st. definitions.
 * @{
 */
#ifndef __ATI2S_PP0_ST_MACRO__
#define __ATI2S_PP0_ST_MACRO__

/* macros for field rd_addr */
/**
 * @defgroup at_i2s_regs_core_rd_addr_field rd_addr_field
 * @brief macros for field rd_addr
 * @details read address including wrap bit in ping pong set 0. valid when i2s_pp0_wdata or i2s_pp1_rdata is used.
 * @{
 */
#define ATI2S_PP0_ST__RD_ADDR__SHIFT                                          0
#define ATI2S_PP0_ST__RD_ADDR__WIDTH                                          7
#define ATI2S_PP0_ST__RD_ADDR__MASK                                 0x0000007fU
#define ATI2S_PP0_ST__RD_ADDR__READ(src)        ((uint32_t)(src) & 0x0000007fU)
#define ATI2S_PP0_ST__RD_ADDR__RESET_VALUE                          0x00000010U
/** @} */

/* macros for field wr_addr */
/**
 * @defgroup at_i2s_regs_core_wr_addr_field wr_addr_field
 * @brief macros for field wr_addr
 * @details write adress including wrap bit in ping pong set 0. valid when i2s_pp0_wdata or i2s_pp1_rdata is used.
 * @{
 */
#define ATI2S_PP0_ST__WR_ADDR__SHIFT                                          8
#define ATI2S_PP0_ST__WR_ADDR__WIDTH                                          7
#define ATI2S_PP0_ST__WR_ADDR__MASK                                 0x00007f00U
#define ATI2S_PP0_ST__WR_ADDR__READ(src) (((uint32_t)(src) & 0x00007f00U) >> 8)
#define ATI2S_PP0_ST__WR_ADDR__RESET_VALUE                          0x00000010U
/** @} */

/* macros for field ep_cnt */
/**
 * @defgroup at_i2s_regs_core_ep_cnt_field ep_cnt_field
 * @brief macros for field ep_cnt
 * @details empty count in ping pong set 0.
 * @{
 */
#define ATI2S_PP0_ST__EP_CNT__SHIFT                                          16
#define ATI2S_PP0_ST__EP_CNT__WIDTH                                           7
#define ATI2S_PP0_ST__EP_CNT__MASK                                  0x007f0000U
#define ATI2S_PP0_ST__EP_CNT__READ(src) (((uint32_t)(src) & 0x007f0000U) >> 16)
#define ATI2S_PP0_ST__EP_CNT__RESET_VALUE                           0x00000000U
/** @} */

/* macros for field ep */
/**
 * @defgroup at_i2s_regs_core_ep_field ep_field
 * @brief macros for field ep
 * @details ping pong set 0 is empty.
 * @{
 */
#define ATI2S_PP0_ST__EP__SHIFT                                              30
#define ATI2S_PP0_ST__EP__WIDTH                                               1
#define ATI2S_PP0_ST__EP__MASK                                      0x40000000U
#define ATI2S_PP0_ST__EP__READ(src)     (((uint32_t)(src) & 0x40000000U) >> 30)
#define ATI2S_PP0_ST__EP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | ((uint32_t)(1) << 30)
#define ATI2S_PP0_ST__EP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | ((uint32_t)(0) << 30)
#define ATI2S_PP0_ST__EP__RESET_VALUE                               0x00000000U
/** @} */

/* macros for field fl */
/**
 * @defgroup at_i2s_regs_core_fl_field fl_field
 * @brief macros for field fl
 * @details ping pong set 0 is full.
 * @{
 */
#define ATI2S_PP0_ST__FL__SHIFT                                              31
#define ATI2S_PP0_ST__FL__WIDTH                                               1
#define ATI2S_PP0_ST__FL__MASK                                      0x80000000U
#define ATI2S_PP0_ST__FL__READ(src)     (((uint32_t)(src) & 0x80000000U) >> 31)
#define ATI2S_PP0_ST__FL__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x80000000U) | ((uint32_t)(1) << 31)
#define ATI2S_PP0_ST__FL__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x80000000U) | ((uint32_t)(0) << 31)
#define ATI2S_PP0_ST__FL__RESET_VALUE                               0x00000000U
/** @} */
#define ATI2S_PP0_ST__TYPE                                             uint32_t
#define ATI2S_PP0_ST__READ                                          0xc07f7f7fU
#define ATI2S_PP0_ST__PRESERVED                                     0x00000000U
#define ATI2S_PP0_ST__RESET_VALUE                                   0x00001010U

#endif /* __ATI2S_PP0_ST_MACRO__ */

/** @} end of pp0_st */

/* macros for BlueprintGlobalNameSpace::ATI2S_pp1_st */
/**
 * @defgroup at_i2s_regs_core_pp1_st pp1_st
 * @brief Contains register fields associated with pp1_st. definitions.
 * @{
 */
#ifndef __ATI2S_PP1_ST_MACRO__
#define __ATI2S_PP1_ST_MACRO__

/* macros for field rd_addr */
/**
 * @defgroup at_i2s_regs_core_rd_addr_field rd_addr_field
 * @brief macros for field rd_addr
 * @details read address including wrap bit in ping pong set 1. valid when i2s_pp0_wdata or i2s_pp1_rdata is used.
 * @{
 */
#define ATI2S_PP1_ST__RD_ADDR__SHIFT                                          0
#define ATI2S_PP1_ST__RD_ADDR__WIDTH                                          7
#define ATI2S_PP1_ST__RD_ADDR__MASK                                 0x0000007fU
#define ATI2S_PP1_ST__RD_ADDR__READ(src)        ((uint32_t)(src) & 0x0000007fU)
#define ATI2S_PP1_ST__RD_ADDR__RESET_VALUE                          0x00000010U
/** @} */
 ...
 * @defgroup at_i2s_regs_core_wr_addr_field wr_addr_field
 * @brief macros for field wr_addr
 * @details write adress including wrap bit in ping pong set 1. valid when i2s_pp0_wdata or i2s_pp1_rdata is used.
 * @{
 */
#define ATI2S_PP1_ST__WR_ADDR__SHIFT                                          8
#define ATI2S_PP1_ST__WR_ADDR__WIDTH                                          7
#define ATI2S_PP1_ST__WR_ADDR__MASK                                 0x00007f00U
#define ATI2S_PP1_ST__WR_ADDR__READ(src) (((uint32_t)(src) & 0x00007f00U) >> 8)
#define ATI2S_PP1_ST__WR_ADDR__RESET_VALUE                          0x00000010U
/** @} */
 ...
 * @{
 */
#define ATI2S_PP1_ST__EP_CNT__SHIFT                                          16
#define ATI2S_PP1_ST__EP_CNT__WIDTH                                           7
#define ATI2S_PP1_ST__EP_CNT__MASK                                  0x007f0000U
#define ATI2S_PP1_ST__EP_CNT__READ(src) (((uint32_t)(src) & 0x007f0000U) >> 16)
#define ATI2S_PP1_ST__EP_CNT__RESET_VALUE                           0x00000000U
/** @} */
 ...
 * @{
 */
#define ATI2S_PP1_ST__EP__SHIFT                                              30
#define ATI2S_PP1_ST__EP__WIDTH                                               1
#define ATI2S_PP1_ST__EP__MASK                                      0x40000000U
#define ATI2S_PP1_ST__EP__READ(src)     (((uint32_t)(src) & 0x40000000U) >> 30)
#define ATI2S_PP1_ST__EP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | ((uint32_t)(1) << 30)
#define ATI2S_PP1_ST__EP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | ((uint32_t)(0) << 30)
#define ATI2S_PP1_ST__EP__RESET_VALUE                               0x00000000U
/** @} */
 ...
 * @{
 */
#define ATI2S_PP1_ST__FL__SHIFT                                              31
#define ATI2S_PP1_ST__FL__WIDTH                                               1
#define ATI2S_PP1_ST__FL__MASK                                      0x80000000U
#define ATI2S_PP1_ST__FL__READ(src)     (((uint32_t)(src) & 0x80000000U) >> 31)
#define ATI2S_PP1_ST__FL__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x80000000U) | ((uint32_t)(1) << 31)
#define ATI2S_PP1_ST__FL__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x80000000U) | ((uint32_t)(0) << 31)
#define ATI2S_PP1_ST__FL__RESET_VALUE                               0x00000000U
/** @} */
#define ATI2S_PP1_ST__TYPE                                             uint32_t
#define ATI2S_PP1_ST__READ                                          0xc07f7f7fU
#define ATI2S_PP1_ST__PRESERVED                                     0x00000000U
#define ATI2S_PP1_ST__RESET_VALUE                                   0x00001010U

#endif /* __ATI2S_PP1_ST_MACRO__ */
