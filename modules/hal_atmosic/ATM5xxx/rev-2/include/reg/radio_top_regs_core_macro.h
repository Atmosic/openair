...
#define RADIO_TOP_VERSION__REV_ID__RESET_VALUE                      0x00000010U
/** @} */
...
#define RADIO_TOP_VERSION__PROD_ID__READ(src) \
                    (((uint32_t)(src)\
                    & 0x0000ff00U) >> 8)
#define RADIO_TOP_VERSION__PROD_ID__RESET_VALUE                     0x00000004U
/** @} */
...
#define RADIO_TOP_VERSION__RESET_VALUE                              0x00000410U
...
#define RADIO_TOP_PROCMON__READ                                     0x00000fffU
#define RADIO_TOP_PROCMON__WRITE                                    0x00000fffU
#define RADIO_TOP_PROCMON__PRESERVED                                0x00000000U
#define RADIO_TOP_PROCMON__RESET_VALUE                              0x00000206U

#endif /* __RADIO_TOP_PROCMON_MACRO__ */

/** @} end of procmon */

/* macros for BlueprintGlobalNameSpace::radio_top_ldo */
/**
 * @defgroup radio_top_regs_core_ldo ldo
 * @brief LDO settins definitions.
 * @{
 */
#ifndef __RADIO_TOP_LDO_MACRO__
#define __RADIO_TOP_LDO_MACRO__

/* macros for field ldo_highIq */
/**
 * @defgroup radio_top_regs_core_ldo_highIq_field ldo_highIq_field
 * @brief macros for field ldo_highIq
 * @details quescinet current setting for ldo
 * @{
 */
#define RADIO_TOP_LDO__LDO_HIGHIQ__SHIFT                                      0
#define RADIO_TOP_LDO__LDO_HIGHIQ__WIDTH                                      5
#define RADIO_TOP_LDO__LDO_HIGHIQ__MASK                             0x0000001fU
#define RADIO_TOP_LDO__LDO_HIGHIQ__READ(src)    ((uint32_t)(src) & 0x0000001fU)
#define RADIO_TOP_LDO__LDO_HIGHIQ__WRITE(src)   ((uint32_t)(src) & 0x0000001fU)
#define RADIO_TOP_LDO__LDO_HIGHIQ__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0000001fU) | ((uint32_t)(src) &\
                    0x0000001fU)
#define RADIO_TOP_LDO__LDO_HIGHIQ__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x0000001fU)))
#define RADIO_TOP_LDO__LDO_HIGHIQ__RESET_VALUE                      0x00000018U
/** @} */

/* macros for field ldo2mA_folbias */
/**
 * @defgroup radio_top_regs_core_ldo2mA_folbias_field ldo2mA_folbias_field
 * @brief macros for field ldo2mA_folbias
 * @details bias for 2mA radio ldo follower
 * @{
 */
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__SHIFT                                  5
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__WIDTH                                  3
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__MASK                         0x000000e0U
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__READ(src) \
                    (((uint32_t)(src)\
                    & 0x000000e0U) >> 5)
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x000000e0U)
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x000000e0U) | (((uint32_t)(src) <<\
                    5) & 0x000000e0U)
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x000000e0U)))
#define RADIO_TOP_LDO__LDO2MA_FOLBIAS__RESET_VALUE                  0x00000007U
/** @} */

/* macros for field spare */
/**
 * @defgroup radio_top_regs_core_spare_field spare_field
 * @brief macros for field spare
 * @details spares
 * @{
 */
#define RADIO_TOP_LDO__SPARE__SHIFT                                           8
#define RADIO_TOP_LDO__SPARE__WIDTH                                           3
#define RADIO_TOP_LDO__SPARE__MASK                                  0x00000700U
#define RADIO_TOP_LDO__SPARE__READ(src)  (((uint32_t)(src) & 0x00000700U) >> 8)
#define RADIO_TOP_LDO__SPARE__WRITE(src) (((uint32_t)(src) << 8) & 0x00000700U)
#define RADIO_TOP_LDO__SPARE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000700U) | (((uint32_t)(src) <<\
                    8) & 0x00000700U)
#define RADIO_TOP_LDO__SPARE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 8) & ~0x00000700U)))
#define RADIO_TOP_LDO__SPARE__RESET_VALUE                           0x00000000U
/** @} */
#define RADIO_TOP_LDO__TYPE                                            uint32_t
#define RADIO_TOP_LDO__READ                                         0x000007ffU
#define RADIO_TOP_LDO__WRITE                                        0x000007ffU
#define RADIO_TOP_LDO__PRESERVED                                    0x00000000U
#define RADIO_TOP_LDO__RESET_VALUE                                  0x000000f8U

#endif /* __RADIO_TOP_LDO_MACRO__ */
