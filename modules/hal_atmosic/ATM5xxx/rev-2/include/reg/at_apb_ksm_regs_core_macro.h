...
/* macros for field disable_gk */
/**
 * @defgroup at_apb_ksm_regs_core_disable_gk_field disable_gk_field
 * @brief macros for field disable_gk
 * @details write 0 to enable ghost ket detect
 * @{
 */
#define KSM_CTRL0__DISABLE_GK__SHIFT                                         17
#define KSM_CTRL0__DISABLE_GK__WIDTH                                          1
#define KSM_CTRL0__DISABLE_GK__MASK                                 0x00020000U
#define KSM_CTRL0__DISABLE_GK__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00020000U) >> 17)
#define KSM_CTRL0__DISABLE_GK__WRITE(src) \
                    (((uint32_t)(src)\
                    << 17) & 0x00020000U)
#define KSM_CTRL0__DISABLE_GK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | (((uint32_t)(src) <<\
                    17) & 0x00020000U)
#define KSM_CTRL0__DISABLE_GK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 17) & ~0x00020000U)))
#define KSM_CTRL0__DISABLE_GK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | ((uint32_t)(1) << 17)
#define KSM_CTRL0__DISABLE_GK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | ((uint32_t)(0) << 17)
#define KSM_CTRL0__DISABLE_GK__RESET_VALUE                          0x00000001U
/** @} */
 ...
 * @details set 1 to enable ksm clk switch to 128khz .
 * @{
 */
...
/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF0 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF0 KEY_BUF0
 * @brief Contains register fields associated with KEY_BUF0. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF0_MACRO__
#define __KSM_KEY_BUF0_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF0__ROW__SHIFT                                              0
#define KSM_KEY_BUF0__ROW__WIDTH                                              5
#define KSM_KEY_BUF0__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF0__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF0__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @defgroup at_apb_ksm_regs_core_col_field col_field
 * @brief macros for field col
 * @details stored column
 * @{
 */
#define KSM_KEY_BUF0__COL__SHIFT                                              5
#define KSM_KEY_BUF0__COL__WIDTH                                              5
#define KSM_KEY_BUF0__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF0__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF0__COL__RESET_VALUE                              0x00000000U
/** @} */

/* macros for field key_stored */
/**
 * @defgroup at_apb_ksm_regs_core_key_stored_field key_stored_field
 * @brief macros for field key_stored
 * @details key is pressed and col/row number are latched.
 * @{
 */
#define KSM_KEY_BUF0__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF0__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF0__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF0__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF0__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF0__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF0__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF0__TYPE                                             uint32_t
#define KSM_KEY_BUF0__READ                                          0x000007ffU
#define KSM_KEY_BUF0__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF0__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF0_MACRO__ */

/** @} end of KEY_BUF0 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF1 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF1 KEY_BUF1
 * @brief Contains register fields associated with KEY_BUF1. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF1_MACRO__
#define __KSM_KEY_BUF1_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF1__ROW__SHIFT                                              0
#define KSM_KEY_BUF1__ROW__WIDTH                                              5
#define KSM_KEY_BUF1__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF1__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF1__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF1__COL__SHIFT                                              5
#define KSM_KEY_BUF1__COL__WIDTH                                              5
#define KSM_KEY_BUF1__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF1__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF1__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF1__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF1__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF1__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF1__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF1__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF1__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF1__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF1__TYPE                                             uint32_t
#define KSM_KEY_BUF1__READ                                          0x000007ffU
#define KSM_KEY_BUF1__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF1__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF1_MACRO__ */

/** @} end of KEY_BUF1 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF2 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF2 KEY_BUF2
 * @brief Contains register fields associated with KEY_BUF2. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF2_MACRO__
#define __KSM_KEY_BUF2_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF2__ROW__SHIFT                                              0
#define KSM_KEY_BUF2__ROW__WIDTH                                              5
#define KSM_KEY_BUF2__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF2__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF2__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF2__COL__SHIFT                                              5
#define KSM_KEY_BUF2__COL__WIDTH                                              5
#define KSM_KEY_BUF2__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF2__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF2__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF2__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF2__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF2__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF2__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF2__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF2__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF2__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF2__TYPE                                             uint32_t
#define KSM_KEY_BUF2__READ                                          0x000007ffU
#define KSM_KEY_BUF2__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF2__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF2_MACRO__ */

/** @} end of KEY_BUF2 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF3 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF3 KEY_BUF3
 * @brief Contains register fields associated with KEY_BUF3. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF3_MACRO__
#define __KSM_KEY_BUF3_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF3__ROW__SHIFT                                              0
#define KSM_KEY_BUF3__ROW__WIDTH                                              5
#define KSM_KEY_BUF3__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF3__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF3__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF3__COL__SHIFT                                              5
#define KSM_KEY_BUF3__COL__WIDTH                                              5
#define KSM_KEY_BUF3__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF3__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF3__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF3__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF3__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF3__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF3__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF3__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF3__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF3__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF3__TYPE                                             uint32_t
#define KSM_KEY_BUF3__READ                                          0x000007ffU
#define KSM_KEY_BUF3__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF3__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF3_MACRO__ */

/** @} end of KEY_BUF3 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF4 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF4 KEY_BUF4
 * @brief Contains register fields associated with KEY_BUF4. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF4_MACRO__
#define __KSM_KEY_BUF4_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF4__ROW__SHIFT                                              0
#define KSM_KEY_BUF4__ROW__WIDTH                                              5
#define KSM_KEY_BUF4__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF4__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF4__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF4__COL__SHIFT                                              5
#define KSM_KEY_BUF4__COL__WIDTH                                              5
#define KSM_KEY_BUF4__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF4__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF4__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF4__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF4__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF4__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF4__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF4__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF4__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF4__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF4__TYPE                                             uint32_t
#define KSM_KEY_BUF4__READ                                          0x000007ffU
#define KSM_KEY_BUF4__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF4__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF4_MACRO__ */

/** @} end of KEY_BUF4 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF5 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF5 KEY_BUF5
 * @brief Contains register fields associated with KEY_BUF5. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF5_MACRO__
#define __KSM_KEY_BUF5_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF5__ROW__SHIFT                                              0
#define KSM_KEY_BUF5__ROW__WIDTH                                              5
#define KSM_KEY_BUF5__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF5__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF5__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF5__COL__SHIFT                                              5
#define KSM_KEY_BUF5__COL__WIDTH                                              5
#define KSM_KEY_BUF5__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF5__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF5__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF5__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF5__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF5__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF5__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF5__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF5__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF5__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF5__TYPE                                             uint32_t
#define KSM_KEY_BUF5__READ                                          0x000007ffU
#define KSM_KEY_BUF5__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF5__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF5_MACRO__ */

/** @} end of KEY_BUF5 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF6 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF6 KEY_BUF6
 * @brief Contains register fields associated with KEY_BUF6. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF6_MACRO__
#define __KSM_KEY_BUF6_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF6__ROW__SHIFT                                              0
#define KSM_KEY_BUF6__ROW__WIDTH                                              5
#define KSM_KEY_BUF6__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF6__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF6__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF6__COL__SHIFT                                              5
#define KSM_KEY_BUF6__COL__WIDTH                                              5
#define KSM_KEY_BUF6__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF6__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF6__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF6__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF6__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF6__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF6__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF6__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF6__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF6__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF6__TYPE                                             uint32_t
#define KSM_KEY_BUF6__READ                                          0x000007ffU
#define KSM_KEY_BUF6__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF6__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF6_MACRO__ */

/** @} end of KEY_BUF6 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF7 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF7 KEY_BUF7
 * @brief Contains register fields associated with KEY_BUF7. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF7_MACRO__
#define __KSM_KEY_BUF7_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF7__ROW__SHIFT                                              0
#define KSM_KEY_BUF7__ROW__WIDTH                                              5
#define KSM_KEY_BUF7__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF7__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF7__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF7__COL__SHIFT                                              5
#define KSM_KEY_BUF7__COL__WIDTH                                              5
#define KSM_KEY_BUF7__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF7__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF7__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF7__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF7__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF7__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF7__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF7__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF7__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF7__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF7__TYPE                                             uint32_t
#define KSM_KEY_BUF7__READ                                          0x000007ffU
#define KSM_KEY_BUF7__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF7__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF7_MACRO__ */

/** @} end of KEY_BUF7 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF8 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF8 KEY_BUF8
 * @brief Contains register fields associated with KEY_BUF8. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF8_MACRO__
#define __KSM_KEY_BUF8_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF8__ROW__SHIFT                                              0
#define KSM_KEY_BUF8__ROW__WIDTH                                              5
#define KSM_KEY_BUF8__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF8__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF8__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF8__COL__SHIFT                                              5
#define KSM_KEY_BUF8__COL__WIDTH                                              5
#define KSM_KEY_BUF8__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF8__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF8__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF8__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF8__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF8__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF8__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF8__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF8__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF8__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF8__TYPE                                             uint32_t
#define KSM_KEY_BUF8__READ                                          0x000007ffU
#define KSM_KEY_BUF8__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF8__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF8_MACRO__ */

/** @} end of KEY_BUF8 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF9 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF9 KEY_BUF9
 * @brief Contains register fields associated with KEY_BUF9. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF9_MACRO__
#define __KSM_KEY_BUF9_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF9__ROW__SHIFT                                              0
#define KSM_KEY_BUF9__ROW__WIDTH                                              5
#define KSM_KEY_BUF9__ROW__MASK                                     0x0000001fU
#define KSM_KEY_BUF9__ROW__READ(src)            ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF9__ROW__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF9__COL__SHIFT                                              5
#define KSM_KEY_BUF9__COL__WIDTH                                              5
#define KSM_KEY_BUF9__COL__MASK                                     0x000003e0U
#define KSM_KEY_BUF9__COL__READ(src)     (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF9__COL__RESET_VALUE                              0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF9__KEY_STORED__SHIFT                                      10
#define KSM_KEY_BUF9__KEY_STORED__WIDTH                                       1
#define KSM_KEY_BUF9__KEY_STORED__MASK                              0x00000400U
#define KSM_KEY_BUF9__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF9__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF9__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF9__KEY_STORED__RESET_VALUE                       0x00000000U
/** @} */
#define KSM_KEY_BUF9__TYPE                                             uint32_t
#define KSM_KEY_BUF9__READ                                          0x000007ffU
#define KSM_KEY_BUF9__PRESERVED                                     0x00000000U
#define KSM_KEY_BUF9__RESET_VALUE                                   0x00000000U

#endif /* __KSM_KEY_BUF9_MACRO__ */

/** @} end of KEY_BUF9 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF10 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF10 KEY_BUF10
 * @brief Contains register fields associated with KEY_BUF10. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF10_MACRO__
#define __KSM_KEY_BUF10_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF10__ROW__SHIFT                                             0
#define KSM_KEY_BUF10__ROW__WIDTH                                             5
#define KSM_KEY_BUF10__ROW__MASK                                    0x0000001fU
#define KSM_KEY_BUF10__ROW__READ(src)           ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF10__ROW__RESET_VALUE                             0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF10__COL__SHIFT                                             5
#define KSM_KEY_BUF10__COL__WIDTH                                             5
#define KSM_KEY_BUF10__COL__MASK                                    0x000003e0U
#define KSM_KEY_BUF10__COL__READ(src)    (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF10__COL__RESET_VALUE                             0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF10__KEY_STORED__SHIFT                                     10
#define KSM_KEY_BUF10__KEY_STORED__WIDTH                                      1
#define KSM_KEY_BUF10__KEY_STORED__MASK                             0x00000400U
#define KSM_KEY_BUF10__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF10__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF10__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF10__KEY_STORED__RESET_VALUE                      0x00000000U
/** @} */
#define KSM_KEY_BUF10__TYPE                                            uint32_t
#define KSM_KEY_BUF10__READ                                         0x000007ffU
#define KSM_KEY_BUF10__PRESERVED                                    0x00000000U
#define KSM_KEY_BUF10__RESET_VALUE                                  0x00000000U

#endif /* __KSM_KEY_BUF10_MACRO__ */

/** @} end of KEY_BUF10 */

/* macros for BlueprintGlobalNameSpace::KSM_KEY_BUF11 */
/**
 * @defgroup at_apb_ksm_regs_core_KEY_BUF11 KEY_BUF11
 * @brief Contains register fields associated with KEY_BUF11. definitions.
 * @{
 */
#ifndef __KSM_KEY_BUF11_MACRO__
#define __KSM_KEY_BUF11_MACRO__
 ...
 * @{
 */
#define KSM_KEY_BUF11__ROW__SHIFT                                             0
#define KSM_KEY_BUF11__ROW__WIDTH                                             5
#define KSM_KEY_BUF11__ROW__MASK                                    0x0000001fU
#define KSM_KEY_BUF11__ROW__READ(src)           ((uint32_t)(src) & 0x0000001fU)
#define KSM_KEY_BUF11__ROW__RESET_VALUE                             0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF11__COL__SHIFT                                             5
#define KSM_KEY_BUF11__COL__WIDTH                                             5
#define KSM_KEY_BUF11__COL__MASK                                    0x000003e0U
#define KSM_KEY_BUF11__COL__READ(src)    (((uint32_t)(src) & 0x000003e0U) >> 5)
#define KSM_KEY_BUF11__COL__RESET_VALUE                             0x00000000U
/** @} */
 ...
 * @{
 */
#define KSM_KEY_BUF11__KEY_STORED__SHIFT                                     10
#define KSM_KEY_BUF11__KEY_STORED__WIDTH                                      1
#define KSM_KEY_BUF11__KEY_STORED__MASK                             0x00000400U
#define KSM_KEY_BUF11__KEY_STORED__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000400U) >> 10)
#define KSM_KEY_BUF11__KEY_STORED__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(1) << 10)
#define KSM_KEY_BUF11__KEY_STORED__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000400U) | ((uint32_t)(0) << 10)
#define KSM_KEY_BUF11__KEY_STORED__RESET_VALUE                      0x00000000U
/** @} */
#define KSM_KEY_BUF11__TYPE                                            uint32_t
#define KSM_KEY_BUF11__READ                                         0x000007ffU
#define KSM_KEY_BUF11__PRESERVED                                    0x00000000U
#define KSM_KEY_BUF11__RESET_VALUE                                  0x00000000U

#endif /* __KSM_KEY_BUF11_MACRO__ */
