...
/* macros for field amic_dp_enable */
/**
 * @defgroup at_apb_pdm_regs_core_amic_dp_enable_field amic_dp_enable_field
 * @brief macros for field amic_dp_enable
 * @details enables sharing pdm signal-path for amic filtering
 * @{
 */
#define PDM_CONTROL__AMIC_DP_ENABLE__SHIFT                                   17
#define PDM_CONTROL__AMIC_DP_ENABLE__WIDTH                                    1
#define PDM_CONTROL__AMIC_DP_ENABLE__MASK                           0x00020000U
#define PDM_CONTROL__AMIC_DP_ENABLE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00020000U) >> 17)
#define PDM_CONTROL__AMIC_DP_ENABLE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 17) & 0x00020000U)
#define PDM_CONTROL__AMIC_DP_ENABLE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | (((uint32_t)(src) <<\
                    17) & 0x00020000U)
#define PDM_CONTROL__AMIC_DP_ENABLE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 17) & ~0x00020000U)))
#define PDM_CONTROL__AMIC_DP_ENABLE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | ((uint32_t)(1) << 17)
#define PDM_CONTROL__AMIC_DP_ENABLE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00020000U) | ((uint32_t)(0) << 17)
#define PDM_CONTROL__AMIC_DP_ENABLE__RESET_VALUE                    0x00000000U
/** @} */
#define PDM_CONTROL__TYPE                                              uint32_t
#define PDM_CONTROL__READ                                           0x0003ffffU
#define PDM_CONTROL__WRITE                                          0x0003ffffU
 ...
 * @details hpf order  0= 1st order  1= 2nd order  2= 3rd order  3= 4th order
 * @{
 */
 ...
 * @details hpf bandwidth selection when hpf_ord=0, bandwidth will be (Hz):  0= 10, 1= 20, 2= 40, 3= 80, 4= 161, 5= 324, 6= 658, 7= 1359  when hpf_ord=1, bandwidth will be (Hz):  0= 50, 1= 100, 2= 200, 3= 400, 4= 797, 5= 1580, 6= 3092, 7= 5868  when hpf_ord=2, bandwidth will be (Hz):  0= 51, 1= 102, 2= 203, 3= 406, 4= 808, 5= 1601, 6= 3127, 7= 5919  when hpf_ord=3, bandwidth will be (Hz):  0= 59, 1= 117, 2= 234, 3= 465, 4= 918, 5= 1793, 6= 3412, 7= 6240
 * @{
 */
 ...
 * @details hpf2 initialization shift amount, max=16  for values > max, operation is same as max
 * @{
 */
...
#define PDM_FILTER_CONFIG__HPF2_INIT_SHIFT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 14) & ~0x0007c000U)))
#define PDM_FILTER_CONFIG__HPF2_INIT_SHIFT__RESET_VALUE             0x00000010U
/** @} */
...
#define PDM_FILTER_CONFIG__RESET_VALUE                              0x00042a50U
 ...
 * @details clear interrupt 0; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 1; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 2; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 3; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 4; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 5; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 6; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 7; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 8; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @details clear interrupt 9; (__SELF_CLEARING__)
 * @{
 */
 ...
 * @brief ping-pong buffer access mode - AHB or DMA definitions.
 * @{
 */
 ...
 * @brief ping-pong buffer index used during DMA mode definitions.
 * @{
 */
 ...
 * @brief One ping-pong buffer depth. definitions.
 * @{
 */
