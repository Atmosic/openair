...
/*   NAME                           PORT       DESCRIPTION                         SSE200      SECURE  */
  ...
  EXPIRQn_59                    =  59,      /* APB2 irq[3]   <-- RESERVED                              */
...
__IOM  uint32_t CLOCK_CTRL;                  /* Offset: 0x18 (read-write) CLOCK_CTRL Register    */
...
/* SYS_CTRL_REG_SSE200 CLOCK_CTRL Register Definitions */
#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_FCLK_DCS_ENABLE_Pos                16                                                          /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: FCLK_DCS_ENABLE Positions */
#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_FCLK_DCS_ENABLE_Msk                (0x3UL  << SYS_CTRL_REG_SSE200_CLOCK_CTRL_FCLK_DCS_ENABLE_Pos)                 /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: FCLK_DCS_ENABLE Mask */

#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_DCLK_FORCE_Pos                1                                                           /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: DCLK_FORCE Positions */
#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_DCLK_FORCE_Msk                (0x1UL  << SYS_CTRL_REG_SSE200_CLOCK_CTRL_DCLK_FORCE_Pos)                 /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: DCLK_FORCE Mask */

#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_HCLK_FORCE_Pos                0                                                           /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: HCLK_FORCE Positions */
#define SYS_CTRL_REG_SSE200_CLOCK_CTRL_HCLK_FORCE_Msk                (0x1UL  << SYS_CTRL_REG_SSE200_CLOCK_CTRL_HCLK_FORCE_Pos)                 /* SYS_CTRL_REG_SSE200 CLOCK_CTRL: HCLK_FORCE Mask */
...
#define SYS_PHYS_ADDR(addr)     ((addr) & ~0x10000000)
#define SYS_SECURE_ADDR(addr)   ((addr) | 0x10000000)

#define SYS_PPB_BASE            (0xE0000000UL)
#define SYS_VEND_BASE           (0xF0000000UL)
#define EXT_FLASH_BASE          (0x00200000UL)
#define EXT_FLASH_KEY_SIDE_LOAD_SZ (0x00001000UL)
#define CMSDK_SEC_JOURNAL_BASE   SYS_SECURE_ADDR(EXT_FLASH_BASE + EXT_FLASH_KEY_SIDE_LOAD_SZ)
extern uint32_t __secure_flash_size;
#define FLASH_SECURE_SIZE        ((uint32_t)&__secure_flash_size)
#define ROM_RRAM_SIZE            (ROM_SIZE)
...
// override MPC RAM block size
#define MPC_RAM_CFG_BLK_SIZE 1024

// override MPC FLS configuration
// aligned to flash sector size
#define MPC_FLS_CFG_BLK_SIZE 4096
// first 256KB is configurable
#define MPC_EXT_FLASH_CFG_MPC_SIZE 0x40000
// Max available LUT registers, note BLK_MAX reports 255 but not all LUTs are
// implemented in flops. LUT[16..17] can configure flash as secure/nonsecure (2
// regs x 32 bits x 4096 bytes = 256KB).
#define MPC_FLS_CFG_MAX_AVAIL_LUTS 18
