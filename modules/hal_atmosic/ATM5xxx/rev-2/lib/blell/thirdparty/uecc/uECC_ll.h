...
#define uECC_BYTES uECC_CONCAT(uECC_CURVE, _size)

#define uECC_secp160r1_enum 1
#define uECC_secp192r1_enum 2
#define uECC_secp256r1_enum 3
#define uECC_secp256k1_enum 4
#define uECC_secp224r1_enum 5

#define uECC_ENUM uECC_CONCAT(uECC_CURVE, _enum)
