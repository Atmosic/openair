...
/* macros for BlueprintGlobalNameSpace::NVM_rev_hash */
/**
 * @defgroup at_apb_tsmc_nvm_regs_core_rev_hash rev_hash
 * @brief Contains register fields associated with rev_hash. definitions.
 * @{
 */
#ifndef __NVM_REV_HASH_MACRO__
#define __NVM_REV_HASH_MACRO__
 ...
 * @{
 */
#define NVM_REV_HASH__ID__SHIFT                                               0
#define NVM_REV_HASH__ID__WIDTH                                              32
#define NVM_REV_HASH__ID__MASK                                      0xffffffffU
#define NVM_REV_HASH__ID__READ(src)             ((uint32_t)(src) & 0xffffffffU)
#define NVM_REV_HASH__ID__RESET_VALUE                               0xf80311a8U
/** @} */
#define NVM_REV_HASH__TYPE                                             uint32_t
#define NVM_REV_HASH__READ                                          0xffffffffU
#define NVM_REV_HASH__PRESERVED                                     0x00000000U
#define NVM_REV_HASH__RESET_VALUE                                   0xf80311a8U

#endif /* __NVM_REV_HASH_MACRO__ */

/** @} end of rev_hash */

/* macros for BlueprintGlobalNameSpace::NVM_rev_key */
/**
 * @defgroup at_apb_tsmc_nvm_regs_core_rev_key rev_key
 * @brief Contains register fields associated with rev_key. definitions.
 * @{
 */
#ifndef __NVM_REV_KEY_MACRO__
#define __NVM_REV_KEY_MACRO__
 ...
 * @{
 */
#define NVM_REV_KEY__ID__SHIFT                                                0
#define NVM_REV_KEY__ID__WIDTH                                               32
#define NVM_REV_KEY__ID__MASK                                       0xffffffffU
#define NVM_REV_KEY__ID__READ(src)              ((uint32_t)(src) & 0xffffffffU)
#define NVM_REV_KEY__ID__RESET_VALUE                                0x52455620U
/** @} */
#define NVM_REV_KEY__TYPE                                              uint32_t
#define NVM_REV_KEY__READ                                           0xffffffffU
#define NVM_REV_KEY__PRESERVED                                      0x00000000U
#define NVM_REV_KEY__RESET_VALUE                                    0x52455620U

#endif /* __NVM_REV_KEY_MACRO__ */
