 ...
 * @details 1=enables loopback mode for axis 0
 * @{
 */
 ...
 * @details qdec0_b value when loopback is enabled
 * @{
 */
 ...
 * @details qdec0_a value when loopback is enabled
 * @{
 */
 ...
 * @details 1=reverses direction of axis 0 accumulation
 * @{
 */
 ...
 * @details 1=clears axis 0 accumulator after reading accumulator value
 * @{
 */
 ...
 * @details 1=clears axis 0 error count after reading error count value
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_enable_loopback_field enable_loopback_field
 * @brief macros for field enable_loopback
 * @details 1=enables loopback mode for axis 1
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_qsig_b_loopback_val_field qsig_b_loopback_val_field
 * @brief macros for field qsig_b_loopback_val
 * @details qdec1_b value when loopback is enabled
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_qsig_a_loopback_val_field qsig_a_loopback_val_field
 * @brief macros for field qsig_a_loopback_val
 * @details qdec1_a value when loopback is enabled
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_reverse_polarity_field reverse_polarity_field
 * @brief macros for field reverse_polarity
 * @details 1=reverses direction of axis 1 accumulation
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_purge_accum_post_read_field purge_accum_post_read_field
 * @brief macros for field purge_accum_post_read
 * @details 1=clears axis 1 accumulator after reading accumulator value
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_purge_err_post_read_field purge_err_post_read_field
 * @brief macros for field purge_err_post_read
 * @details 1=clears axis 1 error count after reading error count value
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_enable_loopback_field enable_loopback_field
 * @brief macros for field enable_loopback
 * @details 1=enables loopback mode for axis 2
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_qsig_b_loopback_val_field qsig_b_loopback_val_field
 * @brief macros for field qsig_b_loopback_val
 * @details qdec2_b value when loopback is enabled
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_qsig_a_loopback_val_field qsig_a_loopback_val_field
 * @brief macros for field qsig_a_loopback_val
 * @details qdec2_a value when loopback is enabled
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_reverse_polarity_field reverse_polarity_field
 * @brief macros for field reverse_polarity
 * @details 1=reverses direction of axis 2 accumulation
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_purge_accum_post_read_field purge_accum_post_read_field
 * @brief macros for field purge_accum_post_read
 * @details 1=clears axis 2 accumulator after reading accumulator value
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_purge_err_post_read_field purge_err_post_read_field
 * @brief macros for field purge_err_post_read
 * @details 1=clears axis 2 error count after reading error count value
 * @{
 */
...
/* macros for BlueprintGlobalNameSpace::QDEC_rev_hash */
/**
 * @defgroup at_apb_qdec_regs_core_rev_hash rev_hash
 * @brief Contains register fields associated with rev_hash. definitions.
 * @{
 */
#ifndef __QDEC_REV_HASH_MACRO__
#define __QDEC_REV_HASH_MACRO__
 ...
 * @{
 */
#define QDEC_REV_HASH__ID__SHIFT                                              0
#define QDEC_REV_HASH__ID__WIDTH                                             32
#define QDEC_REV_HASH__ID__MASK                                     0xffffffffU
#define QDEC_REV_HASH__ID__READ(src)            ((uint32_t)(src) & 0xffffffffU)
#define QDEC_REV_HASH__ID__RESET_VALUE                              0x9bf3e57dU
/** @} */
#define QDEC_REV_HASH__TYPE                                            uint32_t
#define QDEC_REV_HASH__READ                                         0xffffffffU
#define QDEC_REV_HASH__PRESERVED                                    0x00000000U
#define QDEC_REV_HASH__RESET_VALUE                                  0x9bf3e57dU

#endif /* __QDEC_REV_HASH_MACRO__ */

/** @} end of rev_hash */

/* macros for BlueprintGlobalNameSpace::QDEC_rev_key */
/**
 * @defgroup at_apb_qdec_regs_core_rev_key rev_key
 * @brief Contains register fields associated with rev_key. definitions.
 * @{
 */
#ifndef __QDEC_REV_KEY_MACRO__
#define __QDEC_REV_KEY_MACRO__
 ...
 * @{
 */
#define QDEC_REV_KEY__ID__SHIFT                                               0
#define QDEC_REV_KEY__ID__WIDTH                                              32
#define QDEC_REV_KEY__ID__MASK                                      0xffffffffU
#define QDEC_REV_KEY__ID__READ(src)             ((uint32_t)(src) & 0xffffffffU)
#define QDEC_REV_KEY__ID__RESET_VALUE                               0x52455620U
/** @} */
#define QDEC_REV_KEY__TYPE                                             uint32_t
#define QDEC_REV_KEY__READ                                          0xffffffffU
#define QDEC_REV_KEY__PRESERVED                                     0x00000000U
#define QDEC_REV_KEY__RESET_VALUE                                   0x52455620U

#endif /* __QDEC_REV_KEY_MACRO__ */
