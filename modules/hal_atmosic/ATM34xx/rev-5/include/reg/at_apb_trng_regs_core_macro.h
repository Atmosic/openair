 ...
 * @details start the process of generating a true random number ; (__SELF_CLEARING__)
 * @{
 */
...
#define TRNG_CONTROL__LAUNCH_ON_RADIO_UP__RESET_VALUE               0x00000000U
/** @} */
...
#define TRNG_CONTROL__RADIO_WARMUP_CNT__WIDTH                                12
#define TRNG_CONTROL__RADIO_WARMUP_CNT__MASK                        0x0003ffc0U
...
#define TRNG_CONTROL__RADIO_WARMUP_CNT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0003ffc0U) | (((uint32_t)(src) <<\
                    6) & 0x0003ffc0U)
#define TRNG_CONTROL__RADIO_WARMUP_CNT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 6) & ~0x0003ffc0U)))
#define TRNG_CONTROL__RADIO_WARMUP_CNT__RESET_VALUE                 0x00000c00U
/** @} */
#define TRNG_CONTROL__TYPE                                             uint32_t
#define TRNG_CONTROL__READ                                          0x0003ffffU
#define TRNG_CONTROL__WRITE                                         0x0003ffffU
#define TRNG_CONTROL__PRESERVED                                     0x00000000U
#define TRNG_CONTROL__RESET_VALUE                                   0x00030000U
 ...
 * @details not self clearing (__SELF_CLEARING__)
 * @{
 */
...
/* macros for BlueprintGlobalNameSpace::TRNG_rev_hash */
/**
 * @defgroup at_apb_trng_regs_core_rev_hash rev_hash
 * @brief Contains register fields associated with rev_hash. definitions.
 * @{
 */
#ifndef __TRNG_REV_HASH_MACRO__
#define __TRNG_REV_HASH_MACRO__
 ...
 * @{
 */
#define TRNG_REV_HASH__ID__SHIFT                                              0
#define TRNG_REV_HASH__ID__WIDTH                                             32
#define TRNG_REV_HASH__ID__MASK                                     0xffffffffU
#define TRNG_REV_HASH__ID__READ(src)            ((uint32_t)(src) & 0xffffffffU)
#define TRNG_REV_HASH__ID__RESET_VALUE                              0x1b3ffba6U
/** @} */
#define TRNG_REV_HASH__TYPE                                            uint32_t
#define TRNG_REV_HASH__READ                                         0xffffffffU
#define TRNG_REV_HASH__PRESERVED                                    0x00000000U
#define TRNG_REV_HASH__RESET_VALUE                                  0x1b3ffba6U

#endif /* __TRNG_REV_HASH_MACRO__ */

/** @} end of rev_hash */

/* macros for BlueprintGlobalNameSpace::TRNG_rev_key */
/**
 * @defgroup at_apb_trng_regs_core_rev_key rev_key
 * @brief Contains register fields associated with rev_key. definitions.
 * @{
 */
#ifndef __TRNG_REV_KEY_MACRO__
#define __TRNG_REV_KEY_MACRO__
 ...
 * @{
 */
#define TRNG_REV_KEY__ID__SHIFT                                               0
#define TRNG_REV_KEY__ID__WIDTH                                              32
#define TRNG_REV_KEY__ID__MASK                                      0xffffffffU
#define TRNG_REV_KEY__ID__READ(src)             ((uint32_t)(src) & 0xffffffffU)
#define TRNG_REV_KEY__ID__RESET_VALUE                               0x52455620U
/** @} */
#define TRNG_REV_KEY__TYPE                                             uint32_t
#define TRNG_REV_KEY__READ                                          0xffffffffU
#define TRNG_REV_KEY__PRESERVED                                     0x00000000U
#define TRNG_REV_KEY__RESET_VALUE                                   0x52455620U

#endif /* __TRNG_REV_KEY_MACRO__ */
