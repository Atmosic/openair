...
/* macros for field byte_reverse */
/**
 * @defgroup at_apb_aes_regs_core_byte_reverse_field byte_reverse_field
 * @brief macros for field byte_reverse
 * @details 1=reverse bytes in KEY_SHARES0/1[], DATA_IN[], and DATA_OUT[]
 * @{
 */
#define AES_CTRL_SHADOWED__BYTE_REVERSE__SHIFT                               13
#define AES_CTRL_SHADOWED__BYTE_REVERSE__WIDTH                                1
#define AES_CTRL_SHADOWED__BYTE_REVERSE__MASK                       0x00002000U
#define AES_CTRL_SHADOWED__BYTE_REVERSE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00002000U) >> 13)
#define AES_CTRL_SHADOWED__BYTE_REVERSE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 13) & 0x00002000U)
#define AES_CTRL_SHADOWED__BYTE_REVERSE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00002000U) | (((uint32_t)(src) <<\
                    13) & 0x00002000U)
#define AES_CTRL_SHADOWED__BYTE_REVERSE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 13) & ~0x00002000U)))
#define AES_CTRL_SHADOWED__BYTE_REVERSE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00002000U) | ((uint32_t)(1) << 13)
#define AES_CTRL_SHADOWED__BYTE_REVERSE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00002000U) | ((uint32_t)(0) << 13)
#define AES_CTRL_SHADOWED__BYTE_REVERSE__RESET_VALUE                0x00000000U
/** @} */

/* macros for field iv_byte_reverse */
/**
 * @defgroup at_apb_aes_regs_core_iv_byte_reverse_field iv_byte_reverse_field
 * @brief macros for field iv_byte_reverse
 * @details 1=reverse bytes in IV[]
 * @{
 */
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__SHIFT                            14
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__WIDTH                             1
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__MASK                    0x00004000U
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00004000U) >> 14)
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 14) & 0x00004000U)
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00004000U) | (((uint32_t)(src) <<\
                    14) & 0x00004000U)
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 14) & ~0x00004000U)))
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00004000U) | ((uint32_t)(1) << 14)
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00004000U) | ((uint32_t)(0) << 14)
#define AES_CTRL_SHADOWED__IV_BYTE_REVERSE__RESET_VALUE             0x00000000U
/** @} */

/* macros for field sidekey_byte_reverse */
/**
 * @defgroup at_apb_aes_regs_core_sidekey_byte_reverse_field sidekey_byte_reverse_field
 * @brief macros for field sidekey_byte_reverse
 * @details 1=reverse bytes in side-load key.
 * @{
 */
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__SHIFT                       15
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__WIDTH                        1
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__MASK               0x00008000U
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00008000U) >> 15)
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 15) & 0x00008000U)
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00008000U) | (((uint32_t)(src) <<\
                    15) & 0x00008000U)
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 15) & ~0x00008000U)))
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00008000U) | ((uint32_t)(1) << 15)
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00008000U) | ((uint32_t)(0) << 15)
#define AES_CTRL_SHADOWED__SIDEKEY_BYTE_REVERSE__RESET_VALUE        0x00000000U
/** @} */
#define AES_CTRL_SHADOWED__TYPE                                        uint32_t
#define AES_CTRL_SHADOWED__READ                                     0x0000ffffU
#define AES_CTRL_SHADOWED__WRITE                                    0x0000ffffU
...
/* macros for field RESTORE */
/**
 * @defgroup at_apb_aes_regs_core_RESTORE_field RESTORE_field
 * @brief macros for field RESTORE
 * @details restore IV with saved IV registers.
 * @{
 */
#define AES_TRIGGER__RESTORE__SHIFT                                           4
#define AES_TRIGGER__RESTORE__WIDTH                                           1
#define AES_TRIGGER__RESTORE__MASK                                  0x00000010U
#define AES_TRIGGER__RESTORE__READ(src)  (((uint32_t)(src) & 0x00000010U) >> 4)
#define AES_TRIGGER__RESTORE__WRITE(src) (((uint32_t)(src) << 4) & 0x00000010U)
#define AES_TRIGGER__RESTORE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define AES_TRIGGER__RESTORE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define AES_TRIGGER__RESTORE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define AES_TRIGGER__RESTORE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define AES_TRIGGER__RESTORE__RESET_VALUE                           0x00000000U
/** @} */
#define AES_TRIGGER__TYPE                                              uint32_t
#define AES_TRIGGER__READ                                           0x0000001fU
#define AES_TRIGGER__WRITE                                          0x0000001fU
...
/* macros for BlueprintGlobalNameSpace::AES_A_BLK_START */
/**
 * @defgroup at_apb_aes_regs_core_A_BLK_START A_BLK_START
 * @brief Contains register fields associated with A_BLK_START. definitions.
 * @{
 */
#ifndef __AES_A_BLK_START_MACRO__
#define __AES_A_BLK_START_MACRO__

/* macros for field pntr */
/**
 * @defgroup at_apb_aes_regs_core_pntr_field pntr_field
 * @brief macros for field pntr
 * @details point to the index of the blk_cntr where A_BLK aes starts
 * @{
 */
#define AES_A_BLK_START__PNTR__SHIFT                                          0
#define AES_A_BLK_START__PNTR__WIDTH                                          7
#define AES_A_BLK_START__PNTR__MASK                                 0x0000007fU
#define AES_A_BLK_START__PNTR__READ(src)        ((uint32_t)(src) & 0x0000007fU)
#define AES_A_BLK_START__PNTR__WRITE(src)       ((uint32_t)(src) & 0x0000007fU)
#define AES_A_BLK_START__PNTR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0000007fU) | ((uint32_t)(src) &\
                    0x0000007fU)
#define AES_A_BLK_START__PNTR__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x0000007fU)))
#define AES_A_BLK_START__PNTR__RESET_VALUE                          0x00000001U
/** @} */
#define AES_A_BLK_START__TYPE                                          uint32_t
#define AES_A_BLK_START__READ                                       0x0000007fU
#define AES_A_BLK_START__WRITE                                      0x0000007fU
#define AES_A_BLK_START__PRESERVED                                  0x00000000U
#define AES_A_BLK_START__RESET_VALUE                                0x00000001U

#endif /* __AES_A_BLK_START_MACRO__ */

/** @} end of A_BLK_START */

/* macros for BlueprintGlobalNameSpace::AES_A_BLK_END */
/**
 * @defgroup at_apb_aes_regs_core_A_BLK_END A_BLK_END
 * @brief Contains register fields associated with A_BLK_END. definitions.
 * @{
 */
#ifndef __AES_A_BLK_END_MACRO__
#define __AES_A_BLK_END_MACRO__

/* macros for field pntr */
/**
 * @defgroup at_apb_aes_regs_core_pntr_field pntr_field
 * @brief macros for field pntr
 * @details point to the index of the blk_cntr where A_BLK aes ends. If 0, A_BLK ends at the last blk_cntr
 * @{
 */
#define AES_A_BLK_END__PNTR__SHIFT                                            0
#define AES_A_BLK_END__PNTR__WIDTH                                            7
#define AES_A_BLK_END__PNTR__MASK                                   0x0000007fU
#define AES_A_BLK_END__PNTR__READ(src)          ((uint32_t)(src) & 0x0000007fU)
#define AES_A_BLK_END__PNTR__WRITE(src)         ((uint32_t)(src) & 0x0000007fU)
#define AES_A_BLK_END__PNTR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0000007fU) | ((uint32_t)(src) &\
                    0x0000007fU)
#define AES_A_BLK_END__PNTR__VERIFY(src)  (!(((uint32_t)(src) & ~0x0000007fU)))
#define AES_A_BLK_END__PNTR__RESET_VALUE                            0x00000000U
/** @} */
#define AES_A_BLK_END__TYPE                                            uint32_t
#define AES_A_BLK_END__READ                                         0x0000007fU
#define AES_A_BLK_END__WRITE                                        0x0000007fU
#define AES_A_BLK_END__PRESERVED                                    0x00000000U
#define AES_A_BLK_END__RESET_VALUE                                  0x00000000U

#endif /* __AES_A_BLK_END_MACRO__ */

/** @} end of A_BLK_END */

/* macros for BlueprintGlobalNameSpace::AES_B_BLK_START */
/**
 * @defgroup at_apb_aes_regs_core_B_BLK_START B_BLK_START
 * @brief Contains register fields associated with B_BLK_START. definitions.
 * @{
 */
#ifndef __AES_B_BLK_START_MACRO__
#define __AES_B_BLK_START_MACRO__

/* macros for field pntr */
/**
 * @defgroup at_apb_aes_regs_core_pntr_field pntr_field
 * @brief macros for field pntr
 * @details point to the index of the blk_cntr where B_BLK aes starts
 * @{
 */
#define AES_B_BLK_START__PNTR__SHIFT                                          0
#define AES_B_BLK_START__PNTR__WIDTH                                          7
#define AES_B_BLK_START__PNTR__MASK                                 0x0000007fU
#define AES_B_BLK_START__PNTR__READ(src)        ((uint32_t)(src) & 0x0000007fU)
#define AES_B_BLK_START__PNTR__WRITE(src)       ((uint32_t)(src) & 0x0000007fU)
#define AES_B_BLK_START__PNTR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0000007fU) | ((uint32_t)(src) &\
                    0x0000007fU)
#define AES_B_BLK_START__PNTR__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x0000007fU)))
#define AES_B_BLK_START__PNTR__RESET_VALUE                          0x00000001U
/** @} */
#define AES_B_BLK_START__TYPE                                          uint32_t
#define AES_B_BLK_START__READ                                       0x0000007fU
#define AES_B_BLK_START__WRITE                                      0x0000007fU
#define AES_B_BLK_START__PRESERVED                                  0x00000000U
#define AES_B_BLK_START__RESET_VALUE                                0x00000001U

#endif /* __AES_B_BLK_START_MACRO__ */

/** @} end of B_BLK_START */

/* macros for BlueprintGlobalNameSpace::AES_B_BLK_END */
/**
 * @defgroup at_apb_aes_regs_core_B_BLK_END B_BLK_END
 * @brief Contains register fields associated with B_BLK_END. definitions.
 * @{
 */
#ifndef __AES_B_BLK_END_MACRO__
#define __AES_B_BLK_END_MACRO__

/* macros for field pntr */
/**
 * @defgroup at_apb_aes_regs_core_pntr_field pntr_field
 * @brief macros for field pntr
 * @details point to the index of the blk_cntr where B_BLK aes ends. If 0, B_BLK ends at the last blk_cntr
 * @{
 */
#define AES_B_BLK_END__PNTR__SHIFT                                            0
#define AES_B_BLK_END__PNTR__WIDTH                                            7
#define AES_B_BLK_END__PNTR__MASK                                   0x0000007fU
#define AES_B_BLK_END__PNTR__READ(src)          ((uint32_t)(src) & 0x0000007fU)
#define AES_B_BLK_END__PNTR__WRITE(src)         ((uint32_t)(src) & 0x0000007fU)
#define AES_B_BLK_END__PNTR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0000007fU) | ((uint32_t)(src) &\
                    0x0000007fU)
#define AES_B_BLK_END__PNTR__VERIFY(src)  (!(((uint32_t)(src) & ~0x0000007fU)))
#define AES_B_BLK_END__PNTR__RESET_VALUE                            0x00000000U
/** @} */
#define AES_B_BLK_END__TYPE                                            uint32_t
#define AES_B_BLK_END__READ                                         0x0000007fU
#define AES_B_BLK_END__WRITE                                        0x0000007fU
#define AES_B_BLK_END__PRESERVED                                    0x00000000U
#define AES_B_BLK_END__RESET_VALUE                                  0x00000000U

#endif /* __AES_B_BLK_END_MACRO__ */

/** @} end of B_BLK_END */

/* macros for BlueprintGlobalNameSpace::AES_CCM_ENC_MIC_W0 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_ENC_MIC_W0 CCM_ENC_MIC_W0
 * @brief Contains register fields associated with CCM_ENC_MIC_W0. definitions.
 * @{
 */
#ifndef __AES_CCM_ENC_MIC_W0_MACRO__
#define __AES_CCM_ENC_MIC_W0_MACRO__

/* macros for field data */
/**
 * @defgroup at_apb_aes_regs_core_data_field data_field
 * @brief macros for field data
 * @{
 */
#define AES_CCM_ENC_MIC_W0__DATA__SHIFT                                       0
#define AES_CCM_ENC_MIC_W0__DATA__WIDTH                                      32
#define AES_CCM_ENC_MIC_W0__DATA__MASK                              0xffffffffU
#define AES_CCM_ENC_MIC_W0__DATA__READ(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_ENC_MIC_W0__DATA__RESET_VALUE                       0x00000000U
/** @} */
#define AES_CCM_ENC_MIC_W0__TYPE                                       uint32_t
#define AES_CCM_ENC_MIC_W0__READ                                    0xffffffffU
#define AES_CCM_ENC_MIC_W0__PRESERVED                               0x00000000U
#define AES_CCM_ENC_MIC_W0__RESET_VALUE                             0x00000000U

#endif /* __AES_CCM_ENC_MIC_W0_MACRO__ */

/** @} end of CCM_ENC_MIC_W0 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_ENC_MIC_W1 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_ENC_MIC_W1 CCM_ENC_MIC_W1
 * @brief Contains register fields associated with CCM_ENC_MIC_W1. definitions.
 * @{
 */
#ifndef __AES_CCM_ENC_MIC_W1_MACRO__
#define __AES_CCM_ENC_MIC_W1_MACRO__
 ...
 * @{
 */
#define AES_CCM_ENC_MIC_W1__DATA__SHIFT                                       0
#define AES_CCM_ENC_MIC_W1__DATA__WIDTH                                      32
#define AES_CCM_ENC_MIC_W1__DATA__MASK                              0xffffffffU
#define AES_CCM_ENC_MIC_W1__DATA__READ(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_ENC_MIC_W1__DATA__RESET_VALUE                       0x00000000U
/** @} */
#define AES_CCM_ENC_MIC_W1__TYPE                                       uint32_t
#define AES_CCM_ENC_MIC_W1__READ                                    0xffffffffU
#define AES_CCM_ENC_MIC_W1__PRESERVED                               0x00000000U
#define AES_CCM_ENC_MIC_W1__RESET_VALUE                             0x00000000U

#endif /* __AES_CCM_ENC_MIC_W1_MACRO__ */

/** @} end of CCM_ENC_MIC_W1 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_ENC_MIC_W2 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_ENC_MIC_W2 CCM_ENC_MIC_W2
 * @brief Contains register fields associated with CCM_ENC_MIC_W2. definitions.
 * @{
 */
#ifndef __AES_CCM_ENC_MIC_W2_MACRO__
#define __AES_CCM_ENC_MIC_W2_MACRO__
 ...
 * @{
 */
#define AES_CCM_ENC_MIC_W2__DATA__SHIFT                                       0
#define AES_CCM_ENC_MIC_W2__DATA__WIDTH                                      32
#define AES_CCM_ENC_MIC_W2__DATA__MASK                              0xffffffffU
#define AES_CCM_ENC_MIC_W2__DATA__READ(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_ENC_MIC_W2__DATA__RESET_VALUE                       0x00000000U
/** @} */
#define AES_CCM_ENC_MIC_W2__TYPE                                       uint32_t
#define AES_CCM_ENC_MIC_W2__READ                                    0xffffffffU
#define AES_CCM_ENC_MIC_W2__PRESERVED                               0x00000000U
#define AES_CCM_ENC_MIC_W2__RESET_VALUE                             0x00000000U

#endif /* __AES_CCM_ENC_MIC_W2_MACRO__ */

/** @} end of CCM_ENC_MIC_W2 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_ENC_MIC_W3 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_ENC_MIC_W3 CCM_ENC_MIC_W3
 * @brief Contains register fields associated with CCM_ENC_MIC_W3. definitions.
 * @{
 */
#ifndef __AES_CCM_ENC_MIC_W3_MACRO__
#define __AES_CCM_ENC_MIC_W3_MACRO__
 ...
 * @{
 */
#define AES_CCM_ENC_MIC_W3__DATA__SHIFT                                       0
#define AES_CCM_ENC_MIC_W3__DATA__WIDTH                                      32
#define AES_CCM_ENC_MIC_W3__DATA__MASK                              0xffffffffU
#define AES_CCM_ENC_MIC_W3__DATA__READ(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_ENC_MIC_W3__DATA__RESET_VALUE                       0x00000000U
/** @} */
#define AES_CCM_ENC_MIC_W3__TYPE                                       uint32_t
#define AES_CCM_ENC_MIC_W3__READ                                    0xffffffffU
#define AES_CCM_ENC_MIC_W3__PRESERVED                               0x00000000U
#define AES_CCM_ENC_MIC_W3__RESET_VALUE                             0x00000000U

#endif /* __AES_CCM_ENC_MIC_W3_MACRO__ */

/** @} end of CCM_ENC_MIC_W3 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_MIC_W0 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_MIC_W0 CCM_MIC_W0
 * @brief Contains register fields associated with CCM_MIC_W0. definitions.
 * @{
 */
#ifndef __AES_CCM_MIC_W0_MACRO__
#define __AES_CCM_MIC_W0_MACRO__
 ...
 * @{
 */
#define AES_CCM_MIC_W0__DATA__SHIFT                                           0
#define AES_CCM_MIC_W0__DATA__WIDTH                                          32
#define AES_CCM_MIC_W0__DATA__MASK                                  0xffffffffU
#define AES_CCM_MIC_W0__DATA__READ(src)         ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_MIC_W0__DATA__RESET_VALUE                           0x00000000U
/** @} */
#define AES_CCM_MIC_W0__TYPE                                           uint32_t
#define AES_CCM_MIC_W0__READ                                        0xffffffffU
#define AES_CCM_MIC_W0__PRESERVED                                   0x00000000U
#define AES_CCM_MIC_W0__RESET_VALUE                                 0x00000000U

#endif /* __AES_CCM_MIC_W0_MACRO__ */

/** @} end of CCM_MIC_W0 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_MIC_W1 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_MIC_W1 CCM_MIC_W1
 * @brief Contains register fields associated with CCM_MIC_W1. definitions.
 * @{
 */
#ifndef __AES_CCM_MIC_W1_MACRO__
#define __AES_CCM_MIC_W1_MACRO__
 ...
 * @{
 */
#define AES_CCM_MIC_W1__DATA__SHIFT                                           0
#define AES_CCM_MIC_W1__DATA__WIDTH                                          32
#define AES_CCM_MIC_W1__DATA__MASK                                  0xffffffffU
#define AES_CCM_MIC_W1__DATA__READ(src)         ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_MIC_W1__DATA__RESET_VALUE                           0x00000000U
/** @} */
#define AES_CCM_MIC_W1__TYPE                                           uint32_t
#define AES_CCM_MIC_W1__READ                                        0xffffffffU
#define AES_CCM_MIC_W1__PRESERVED                                   0x00000000U
#define AES_CCM_MIC_W1__RESET_VALUE                                 0x00000000U

#endif /* __AES_CCM_MIC_W1_MACRO__ */

/** @} end of CCM_MIC_W1 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_MIC_W2 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_MIC_W2 CCM_MIC_W2
 * @brief Contains register fields associated with CCM_MIC_W2. definitions.
 * @{
 */
#ifndef __AES_CCM_MIC_W2_MACRO__
#define __AES_CCM_MIC_W2_MACRO__
 ...
 * @{
 */
#define AES_CCM_MIC_W2__DATA__SHIFT                                           0
#define AES_CCM_MIC_W2__DATA__WIDTH                                          32
#define AES_CCM_MIC_W2__DATA__MASK                                  0xffffffffU
#define AES_CCM_MIC_W2__DATA__READ(src)         ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_MIC_W2__DATA__RESET_VALUE                           0x00000000U
/** @} */
#define AES_CCM_MIC_W2__TYPE                                           uint32_t
#define AES_CCM_MIC_W2__READ                                        0xffffffffU
#define AES_CCM_MIC_W2__PRESERVED                                   0x00000000U
#define AES_CCM_MIC_W2__RESET_VALUE                                 0x00000000U

#endif /* __AES_CCM_MIC_W2_MACRO__ */

/** @} end of CCM_MIC_W2 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_MIC_W3 */
/**
 * @defgroup at_apb_aes_regs_core_CCM_MIC_W3 CCM_MIC_W3
 * @brief Contains register fields associated with CCM_MIC_W3. definitions.
 * @{
 */
#ifndef __AES_CCM_MIC_W3_MACRO__
#define __AES_CCM_MIC_W3_MACRO__
 ...
 * @{
 */
#define AES_CCM_MIC_W3__DATA__SHIFT                                           0
#define AES_CCM_MIC_W3__DATA__WIDTH                                          32
#define AES_CCM_MIC_W3__DATA__MASK                                  0xffffffffU
#define AES_CCM_MIC_W3__DATA__READ(src)         ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_MIC_W3__DATA__RESET_VALUE                           0x00000000U
/** @} */
#define AES_CCM_MIC_W3__TYPE                                           uint32_t
#define AES_CCM_MIC_W3__READ                                        0xffffffffU
#define AES_CCM_MIC_W3__PRESERVED                                   0x00000000U
#define AES_CCM_MIC_W3__RESET_VALUE                                 0x00000000U

#endif /* __AES_CCM_MIC_W3_MACRO__ */

/** @} end of CCM_MIC_W3 */

/* macros for BlueprintGlobalNameSpace::AES_CCM_DATAOUT */
/**
 * @defgroup at_apb_aes_regs_core_CCM_DATAOUT CCM_DATAOUT
 * @brief Contains register fields associated with CCM_DATAOUT. definitions.
 * @{
 */
#ifndef __AES_CCM_DATAOUT_MACRO__
#define __AES_CCM_DATAOUT_MACRO__
 ...
 * @{
 */
#define AES_CCM_DATAOUT__DATA__SHIFT                                          0
#define AES_CCM_DATAOUT__DATA__WIDTH                                         32
#define AES_CCM_DATAOUT__DATA__MASK                                 0xffffffffU
#define AES_CCM_DATAOUT__DATA__READ(src)        ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_DATAOUT__DATA__RESET_VALUE                          0x00000000U
/** @} */
#define AES_CCM_DATAOUT__TYPE                                          uint32_t
#define AES_CCM_DATAOUT__READ                                       0xffffffffU
#define AES_CCM_DATAOUT__PRESERVED                                  0x00000000U
#define AES_CCM_DATAOUT__RESET_VALUE                                0x00000000U

#endif /* __AES_CCM_DATAOUT_MACRO__ */

/** @} end of CCM_DATAOUT */

/* macros for BlueprintGlobalNameSpace::AES_CCM_DATAIN */
/**
 * @defgroup at_apb_aes_regs_core_CCM_DATAIN CCM_DATAIN
 * @brief Contains register fields associated with CCM_DATAIN. definitions.
 * @{
 */
#ifndef __AES_CCM_DATAIN_MACRO__
#define __AES_CCM_DATAIN_MACRO__
 ...
 * @{
 */
#define AES_CCM_DATAIN__DATA__SHIFT                                           0
#define AES_CCM_DATAIN__DATA__WIDTH                                          32
#define AES_CCM_DATAIN__DATA__MASK                                  0xffffffffU
#define AES_CCM_DATAIN__DATA__READ(src)         ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_DATAIN__DATA__WRITE(src)        ((uint32_t)(src) & 0xffffffffU)
#define AES_CCM_DATAIN__DATA__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_CCM_DATAIN__DATA__VERIFY(src) (!(((uint32_t)(src) & ~0xffffffffU)))
#define AES_CCM_DATAIN__DATA__RESET_VALUE                           0x00000000U
/** @} */
#define AES_CCM_DATAIN__TYPE                                           uint32_t
#define AES_CCM_DATAIN__READ                                        0xffffffffU
#define AES_CCM_DATAIN__WRITE                                       0xffffffffU
#define AES_CCM_DATAIN__PRESERVED                                   0x00000000U
#define AES_CCM_DATAIN__RESET_VALUE                                 0x00000000U

#endif /* __AES_CCM_DATAIN_MACRO__ */

/** @} end of CCM_DATAIN */

/* macros for BlueprintGlobalNameSpace::AES_CCM_CTRL */
/**
 * @defgroup at_apb_aes_regs_core_CCM_CTRL CCM_CTRL
 * @brief Contains register fields associated with CCM_CTRL. definitions.
 * @{
 */
#ifndef __AES_CCM_CTRL_MACRO__
#define __AES_CCM_CTRL_MACRO__

/* macros for field go */
/**
 * @defgroup at_apb_aes_regs_core_go_field go_field
 * @brief macros for field go
 * @details go trigger bit (__SELF_CLEARING__)
 * @{
 */
#define AES_CCM_CTRL__GO__SHIFT                                               0
#define AES_CCM_CTRL__GO__WIDTH                                               1
#define AES_CCM_CTRL__GO__MASK                                      0x00000001U
#define AES_CCM_CTRL__GO__READ(src)             ((uint32_t)(src) & 0x00000001U)
#define AES_CCM_CTRL__GO__WRITE(src)            ((uint32_t)(src) & 0x00000001U)
#define AES_CCM_CTRL__GO__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((uint32_t)(src) &\
                    0x00000001U)
#define AES_CCM_CTRL__GO__VERIFY(src)     (!(((uint32_t)(src) & ~0x00000001U)))
#define AES_CCM_CTRL__GO__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(1)
#define AES_CCM_CTRL__GO__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (uint32_t)(0)
#define AES_CCM_CTRL__GO__RESET_VALUE                               0x00000000U
/** @} */

/* macros for field stop */
/**
 * @defgroup at_apb_aes_regs_core_stop_field stop_field
 * @brief macros for field stop
 * @details stop bit (__SELF_CLEARING__)
 * @{
 */
#define AES_CCM_CTRL__STOP__SHIFT                                             1
#define AES_CCM_CTRL__STOP__WIDTH                                             1
#define AES_CCM_CTRL__STOP__MASK                                    0x00000002U
#define AES_CCM_CTRL__STOP__READ(src)    (((uint32_t)(src) & 0x00000002U) >> 1)
#define AES_CCM_CTRL__STOP__WRITE(src)   (((uint32_t)(src) << 1) & 0x00000002U)
#define AES_CCM_CTRL__STOP__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | (((uint32_t)(src) <<\
                    1) & 0x00000002U)
#define AES_CCM_CTRL__STOP__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 1) & ~0x00000002U)))
#define AES_CCM_CTRL__STOP__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(1) << 1)
#define AES_CCM_CTRL__STOP__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((uint32_t)(0) << 1)
#define AES_CCM_CTRL__STOP__RESET_VALUE                             0x00000000U
/** @} */

/* macros for field mic_en */
/**
 * @defgroup at_apb_aes_regs_core_mic_en_field mic_en_field
 * @brief macros for field mic_en
 * @details MIC enable bit
 * @{
 */
#define AES_CCM_CTRL__MIC_EN__SHIFT                                           2
#define AES_CCM_CTRL__MIC_EN__WIDTH                                           1
#define AES_CCM_CTRL__MIC_EN__MASK                                  0x00000004U
#define AES_CCM_CTRL__MIC_EN__READ(src)  (((uint32_t)(src) & 0x00000004U) >> 2)
#define AES_CCM_CTRL__MIC_EN__WRITE(src) (((uint32_t)(src) << 2) & 0x00000004U)
#define AES_CCM_CTRL__MIC_EN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | (((uint32_t)(src) <<\
                    2) & 0x00000004U)
#define AES_CCM_CTRL__MIC_EN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 2) & ~0x00000004U)))
#define AES_CCM_CTRL__MIC_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(1) << 2)
#define AES_CCM_CTRL__MIC_EN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000004U) | ((uint32_t)(0) << 2)
#define AES_CCM_CTRL__MIC_EN__RESET_VALUE                           0x00000000U
/** @} */

/* macros for field pyld_en */
/**
 * @defgroup at_apb_aes_regs_core_pyld_en_field pyld_en_field
 * @brief macros for field pyld_en
 * @details 0=paylod enc/dec skipped
 * @{
 */
#define AES_CCM_CTRL__PYLD_EN__SHIFT                                          3
#define AES_CCM_CTRL__PYLD_EN__WIDTH                                          1
#define AES_CCM_CTRL__PYLD_EN__MASK                                 0x00000008U
#define AES_CCM_CTRL__PYLD_EN__READ(src) (((uint32_t)(src) & 0x00000008U) >> 3)
#define AES_CCM_CTRL__PYLD_EN__WRITE(src) \
                    (((uint32_t)(src)\
                    << 3) & 0x00000008U)
#define AES_CCM_CTRL__PYLD_EN__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | (((uint32_t)(src) <<\
                    3) & 0x00000008U)
#define AES_CCM_CTRL__PYLD_EN__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 3) & ~0x00000008U)))
#define AES_CCM_CTRL__PYLD_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(1) << 3)
#define AES_CCM_CTRL__PYLD_EN__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(0) << 3)
#define AES_CCM_CTRL__PYLD_EN__RESET_VALUE                          0x00000000U
/** @} */

/* macros for field skip_pyld_store */
/**
 * @defgroup at_apb_aes_regs_core_skip_pyld_store_field skip_pyld_store_field
 * @brief macros for field skip_pyld_store
 * @details 0=dec/enc payload is not stored.
 * @{
 */
#define AES_CCM_CTRL__SKIP_PYLD_STORE__SHIFT                                  4
#define AES_CCM_CTRL__SKIP_PYLD_STORE__WIDTH                                  1
#define AES_CCM_CTRL__SKIP_PYLD_STORE__MASK                         0x00000010U
#define AES_CCM_CTRL__SKIP_PYLD_STORE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define AES_CCM_CTRL__SKIP_PYLD_STORE__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define AES_CCM_CTRL__SKIP_PYLD_STORE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define AES_CCM_CTRL__SKIP_PYLD_STORE__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define AES_CCM_CTRL__SKIP_PYLD_STORE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define AES_CCM_CTRL__SKIP_PYLD_STORE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define AES_CCM_CTRL__SKIP_PYLD_STORE__RESET_VALUE                  0x00000000U
/** @} */

/* macros for field dec_n_enc */
/**
 * @defgroup at_apb_aes_regs_core_dec_n_enc_field dec_n_enc_field
 * @brief macros for field dec_n_enc
 * @details 0=decyrption mode, 1=encryption mode
 * @{
 */
#define AES_CCM_CTRL__DEC_N_ENC__SHIFT                                        5
#define AES_CCM_CTRL__DEC_N_ENC__WIDTH                                        1
#define AES_CCM_CTRL__DEC_N_ENC__MASK                               0x00000020U
#define AES_CCM_CTRL__DEC_N_ENC__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000020U) >> 5)
#define AES_CCM_CTRL__DEC_N_ENC__WRITE(src) \
                    (((uint32_t)(src)\
                    << 5) & 0x00000020U)
#define AES_CCM_CTRL__DEC_N_ENC__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | (((uint32_t)(src) <<\
                    5) & 0x00000020U)
#define AES_CCM_CTRL__DEC_N_ENC__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 5) & ~0x00000020U)))
#define AES_CCM_CTRL__DEC_N_ENC__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(1) << 5)
#define AES_CCM_CTRL__DEC_N_ENC__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000020U) | ((uint32_t)(0) << 5)
#define AES_CCM_CTRL__DEC_N_ENC__RESET_VALUE                        0x00000000U
/** @} */
#define AES_CCM_CTRL__TYPE                                             uint32_t
#define AES_CCM_CTRL__READ                                          0x0000003fU
#define AES_CCM_CTRL__WRITE                                         0x0000003fU
#define AES_CCM_CTRL__PRESERVED                                     0x00000000U
#define AES_CCM_CTRL__RESET_VALUE                                   0x00000000U

#endif /* __AES_CCM_CTRL_MACRO__ */

/** @} end of CCM_CTRL */

/* macros for BlueprintGlobalNameSpace::AES_B0_FORMAT_W0 */
/**
 * @defgroup at_apb_aes_regs_core_B0_FORMAT_W0 B0_FORMAT_W0
 * @brief Contains register fields associated with B0_FORMAT_W0. definitions.
 * @{
 */
#ifndef __AES_B0_FORMAT_W0_MACRO__
#define __AES_B0_FORMAT_W0_MACRO__

/* macros for field FIELD */
/**
 * @defgroup at_apb_aes_regs_core_FIELD_field FIELD_field
 * @brief macros for field FIELD
 * @details 32 bits of B0
 * @{
 */
#define AES_B0_FORMAT_W0__FIELD__SHIFT                                        0
#define AES_B0_FORMAT_W0__FIELD__WIDTH                                       32
#define AES_B0_FORMAT_W0__FIELD__MASK                               0xffffffffU
#define AES_B0_FORMAT_W0__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W0__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W0__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B0_FORMAT_W0__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B0_FORMAT_W0__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B0_FORMAT_W0__TYPE                                         uint32_t
#define AES_B0_FORMAT_W0__READ                                      0xffffffffU
#define AES_B0_FORMAT_W0__WRITE                                     0xffffffffU
#define AES_B0_FORMAT_W0__PRESERVED                                 0x00000000U
#define AES_B0_FORMAT_W0__RESET_VALUE                               0x00000000U

#endif /* __AES_B0_FORMAT_W0_MACRO__ */

/** @} end of B0_FORMAT_W0 */

/* macros for BlueprintGlobalNameSpace::AES_B0_FORMAT_W1 */
/**
 * @defgroup at_apb_aes_regs_core_B0_FORMAT_W1 B0_FORMAT_W1
 * @brief Contains register fields associated with B0_FORMAT_W1. definitions.
 * @{
 */
#ifndef __AES_B0_FORMAT_W1_MACRO__
#define __AES_B0_FORMAT_W1_MACRO__
 ...
 * @{
 */
#define AES_B0_FORMAT_W1__FIELD__SHIFT                                        0
#define AES_B0_FORMAT_W1__FIELD__WIDTH                                       32
#define AES_B0_FORMAT_W1__FIELD__MASK                               0xffffffffU
#define AES_B0_FORMAT_W1__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W1__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W1__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B0_FORMAT_W1__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B0_FORMAT_W1__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B0_FORMAT_W1__TYPE                                         uint32_t
#define AES_B0_FORMAT_W1__READ                                      0xffffffffU
#define AES_B0_FORMAT_W1__WRITE                                     0xffffffffU
#define AES_B0_FORMAT_W1__PRESERVED                                 0x00000000U
#define AES_B0_FORMAT_W1__RESET_VALUE                               0x00000000U

#endif /* __AES_B0_FORMAT_W1_MACRO__ */

/** @} end of B0_FORMAT_W1 */

/* macros for BlueprintGlobalNameSpace::AES_B0_FORMAT_W2 */
/**
 * @defgroup at_apb_aes_regs_core_B0_FORMAT_W2 B0_FORMAT_W2
 * @brief Contains register fields associated with B0_FORMAT_W2. definitions.
 * @{
 */
#ifndef __AES_B0_FORMAT_W2_MACRO__
#define __AES_B0_FORMAT_W2_MACRO__
 ...
 * @{
 */
#define AES_B0_FORMAT_W2__FIELD__SHIFT                                        0
#define AES_B0_FORMAT_W2__FIELD__WIDTH                                       32
#define AES_B0_FORMAT_W2__FIELD__MASK                               0xffffffffU
#define AES_B0_FORMAT_W2__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W2__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W2__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B0_FORMAT_W2__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B0_FORMAT_W2__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B0_FORMAT_W2__TYPE                                         uint32_t
#define AES_B0_FORMAT_W2__READ                                      0xffffffffU
#define AES_B0_FORMAT_W2__WRITE                                     0xffffffffU
#define AES_B0_FORMAT_W2__PRESERVED                                 0x00000000U
#define AES_B0_FORMAT_W2__RESET_VALUE                               0x00000000U

#endif /* __AES_B0_FORMAT_W2_MACRO__ */

/** @} end of B0_FORMAT_W2 */

/* macros for BlueprintGlobalNameSpace::AES_B0_FORMAT_W3 */
/**
 * @defgroup at_apb_aes_regs_core_B0_FORMAT_W3 B0_FORMAT_W3
 * @brief Contains register fields associated with B0_FORMAT_W3. definitions.
 * @{
 */
#ifndef __AES_B0_FORMAT_W3_MACRO__
#define __AES_B0_FORMAT_W3_MACRO__
 ...
 * @{
 */
#define AES_B0_FORMAT_W3__FIELD__SHIFT                                        0
#define AES_B0_FORMAT_W3__FIELD__WIDTH                                       32
#define AES_B0_FORMAT_W3__FIELD__MASK                               0xffffffffU
#define AES_B0_FORMAT_W3__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W3__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B0_FORMAT_W3__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B0_FORMAT_W3__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B0_FORMAT_W3__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B0_FORMAT_W3__TYPE                                         uint32_t
#define AES_B0_FORMAT_W3__READ                                      0xffffffffU
#define AES_B0_FORMAT_W3__WRITE                                     0xffffffffU
#define AES_B0_FORMAT_W3__PRESERVED                                 0x00000000U
#define AES_B0_FORMAT_W3__RESET_VALUE                               0x00000000U

#endif /* __AES_B0_FORMAT_W3_MACRO__ */

/** @} end of B0_FORMAT_W3 */

/* macros for BlueprintGlobalNameSpace::AES_B1_FORMAT_W0 */
/**
 * @defgroup at_apb_aes_regs_core_B1_FORMAT_W0 B1_FORMAT_W0
 * @brief Contains register fields associated with B1_FORMAT_W0. definitions.
 * @{
 */
#ifndef __AES_B1_FORMAT_W0_MACRO__
#define __AES_B1_FORMAT_W0_MACRO__

/* macros for field FIELD */
/**
 * @defgroup at_apb_aes_regs_core_FIELD_field FIELD_field
 * @brief macros for field FIELD
 * @details 32 bits of B1
 * @{
 */
#define AES_B1_FORMAT_W0__FIELD__SHIFT                                        0
#define AES_B1_FORMAT_W0__FIELD__WIDTH                                       32
#define AES_B1_FORMAT_W0__FIELD__MASK                               0xffffffffU
#define AES_B1_FORMAT_W0__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W0__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W0__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B1_FORMAT_W0__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B1_FORMAT_W0__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B1_FORMAT_W0__TYPE                                         uint32_t
#define AES_B1_FORMAT_W0__READ                                      0xffffffffU
#define AES_B1_FORMAT_W0__WRITE                                     0xffffffffU
#define AES_B1_FORMAT_W0__PRESERVED                                 0x00000000U
#define AES_B1_FORMAT_W0__RESET_VALUE                               0x00000000U

#endif /* __AES_B1_FORMAT_W0_MACRO__ */

/** @} end of B1_FORMAT_W0 */

/* macros for BlueprintGlobalNameSpace::AES_B1_FORMAT_W1 */
/**
 * @defgroup at_apb_aes_regs_core_B1_FORMAT_W1 B1_FORMAT_W1
 * @brief Contains register fields associated with B1_FORMAT_W1. definitions.
 * @{
 */
#ifndef __AES_B1_FORMAT_W1_MACRO__
#define __AES_B1_FORMAT_W1_MACRO__
 ...
 * @{
 */
#define AES_B1_FORMAT_W1__FIELD__SHIFT                                        0
#define AES_B1_FORMAT_W1__FIELD__WIDTH                                       32
#define AES_B1_FORMAT_W1__FIELD__MASK                               0xffffffffU
#define AES_B1_FORMAT_W1__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W1__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W1__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B1_FORMAT_W1__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B1_FORMAT_W1__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B1_FORMAT_W1__TYPE                                         uint32_t
#define AES_B1_FORMAT_W1__READ                                      0xffffffffU
#define AES_B1_FORMAT_W1__WRITE                                     0xffffffffU
#define AES_B1_FORMAT_W1__PRESERVED                                 0x00000000U
#define AES_B1_FORMAT_W1__RESET_VALUE                               0x00000000U

#endif /* __AES_B1_FORMAT_W1_MACRO__ */

/** @} end of B1_FORMAT_W1 */

/* macros for BlueprintGlobalNameSpace::AES_B1_FORMAT_W2 */
/**
 * @defgroup at_apb_aes_regs_core_B1_FORMAT_W2 B1_FORMAT_W2
 * @brief Contains register fields associated with B1_FORMAT_W2. definitions.
 * @{
 */
#ifndef __AES_B1_FORMAT_W2_MACRO__
#define __AES_B1_FORMAT_W2_MACRO__
 ...
 * @{
 */
#define AES_B1_FORMAT_W2__FIELD__SHIFT                                        0
#define AES_B1_FORMAT_W2__FIELD__WIDTH                                       32
#define AES_B1_FORMAT_W2__FIELD__MASK                               0xffffffffU
#define AES_B1_FORMAT_W2__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W2__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W2__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B1_FORMAT_W2__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B1_FORMAT_W2__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B1_FORMAT_W2__TYPE                                         uint32_t
#define AES_B1_FORMAT_W2__READ                                      0xffffffffU
#define AES_B1_FORMAT_W2__WRITE                                     0xffffffffU
#define AES_B1_FORMAT_W2__PRESERVED                                 0x00000000U
#define AES_B1_FORMAT_W2__RESET_VALUE                               0x00000000U

#endif /* __AES_B1_FORMAT_W2_MACRO__ */

/** @} end of B1_FORMAT_W2 */

/* macros for BlueprintGlobalNameSpace::AES_B1_FORMAT_W3 */
/**
 * @defgroup at_apb_aes_regs_core_B1_FORMAT_W3 B1_FORMAT_W3
 * @brief Contains register fields associated with B1_FORMAT_W3. definitions.
 * @{
 */
#ifndef __AES_B1_FORMAT_W3_MACRO__
#define __AES_B1_FORMAT_W3_MACRO__
 ...
 * @{
 */
#define AES_B1_FORMAT_W3__FIELD__SHIFT                                        0
#define AES_B1_FORMAT_W3__FIELD__WIDTH                                       32
#define AES_B1_FORMAT_W3__FIELD__MASK                               0xffffffffU
#define AES_B1_FORMAT_W3__FIELD__READ(src)      ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W3__FIELD__WRITE(src)     ((uint32_t)(src) & 0xffffffffU)
#define AES_B1_FORMAT_W3__FIELD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xffffffffU) | ((uint32_t)(src) &\
                    0xffffffffU)
#define AES_B1_FORMAT_W3__FIELD__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0xffffffffU)))
#define AES_B1_FORMAT_W3__FIELD__RESET_VALUE                        0x00000000U
/** @} */
#define AES_B1_FORMAT_W3__TYPE                                         uint32_t
#define AES_B1_FORMAT_W3__READ                                      0xffffffffU
#define AES_B1_FORMAT_W3__WRITE                                     0xffffffffU
#define AES_B1_FORMAT_W3__PRESERVED                                 0x00000000U
#define AES_B1_FORMAT_W3__RESET_VALUE                               0x00000000U

#endif /* __AES_B1_FORMAT_W3_MACRO__ */

/** @} end of B1_FORMAT_W3 */

/* macros for BlueprintGlobalNameSpace::AES_pyld_size */
/**
 * @defgroup at_apb_aes_regs_core_pyld_size pyld_size
 * @brief Contains register fields associated with pyld_size. definitions.
 * @{
 */
#ifndef __AES_PYLD_SIZE_MACRO__
#define __AES_PYLD_SIZE_MACRO__

/* macros for field size */
/**
 * @defgroup at_apb_aes_regs_core_size_field size_field
 * @brief macros for field size
 * @details size in (4-byte) words.
 * @{
 */
#define AES_PYLD_SIZE__SIZE__SHIFT                                            0
#define AES_PYLD_SIZE__SIZE__WIDTH                                            8
#define AES_PYLD_SIZE__SIZE__MASK                                   0x000000ffU
#define AES_PYLD_SIZE__SIZE__READ(src)          ((uint32_t)(src) & 0x000000ffU)
#define AES_PYLD_SIZE__SIZE__WRITE(src)         ((uint32_t)(src) & 0x000000ffU)
#define AES_PYLD_SIZE__SIZE__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x000000ffU) | ((uint32_t)(src) &\
                    0x000000ffU)
#define AES_PYLD_SIZE__SIZE__VERIFY(src)  (!(((uint32_t)(src) & ~0x000000ffU)))
#define AES_PYLD_SIZE__SIZE__RESET_VALUE                            0x00000000U
/** @} */
#define AES_PYLD_SIZE__TYPE                                            uint32_t
#define AES_PYLD_SIZE__READ                                         0x000000ffU
#define AES_PYLD_SIZE__WRITE                                        0x000000ffU
#define AES_PYLD_SIZE__PRESERVED                                    0x00000000U
#define AES_PYLD_SIZE__RESET_VALUE                                  0x00000000U

#endif /* __AES_PYLD_SIZE_MACRO__ */

/** @} end of pyld_size */

/* macros for BlueprintGlobalNameSpace::AES_irq_status */
/**
 * @defgroup at_apb_aes_regs_core_irq_status irq_status
 * @brief Contains register fields associated with irq_status. definitions.
 * @{
 */
#ifndef __AES_IRQ_STATUS_MACRO__
#define __AES_IRQ_STATUS_MACRO__
 ...
 * @{
 */
#define AES_IRQ_STATUS__OUTPUT_VALID__SHIFT                                   3
#define AES_IRQ_STATUS__OUTPUT_VALID__WIDTH                                   1
#define AES_IRQ_STATUS__OUTPUT_VALID__MASK                          0x00000008U
#define AES_IRQ_STATUS__OUTPUT_VALID__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000008U) >> 3)
#define AES_IRQ_STATUS__OUTPUT_VALID__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(1) << 3)
#define AES_IRQ_STATUS__OUTPUT_VALID__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(0) << 3)
#define AES_IRQ_STATUS__OUTPUT_VALID__RESET_VALUE                   0x00000000U
/** @} */
 ...
 * @{
 */
#define AES_IRQ_STATUS__INPUT_READY__SHIFT                                    4
#define AES_IRQ_STATUS__INPUT_READY__WIDTH                                    1
#define AES_IRQ_STATUS__INPUT_READY__MASK                           0x00000010U
#define AES_IRQ_STATUS__INPUT_READY__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define AES_IRQ_STATUS__INPUT_READY__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define AES_IRQ_STATUS__INPUT_READY__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define AES_IRQ_STATUS__INPUT_READY__RESET_VALUE                    0x00000000U
/** @} */

/* macros for field ccm_done */
/**
 * @defgroup at_apb_aes_regs_core_ccm_done_field ccm_done_field
 * @brief macros for field ccm_done
 * @details 1= enable irq
 * @{
 */
#define AES_IRQ_STATUS__CCM_DONE__SHIFT                                       7
#define AES_IRQ_STATUS__CCM_DONE__WIDTH                                       1
#define AES_IRQ_STATUS__CCM_DONE__MASK                              0x00000080U
#define AES_IRQ_STATUS__CCM_DONE__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000080U) >> 7)
#define AES_IRQ_STATUS__CCM_DONE__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(1) << 7)
#define AES_IRQ_STATUS__CCM_DONE__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(0) << 7)
#define AES_IRQ_STATUS__CCM_DONE__RESET_VALUE                       0x00000000U
/** @} */
#define AES_IRQ_STATUS__TYPE                                           uint32_t
#define AES_IRQ_STATUS__READ                                        0x00000098U
#define AES_IRQ_STATUS__PRESERVED                                   0x00000000U
#define AES_IRQ_STATUS__RESET_VALUE                                 0x00000000U

#endif /* __AES_IRQ_STATUS_MACRO__ */

/** @} end of irq_status */

/* macros for BlueprintGlobalNameSpace::AES_irq_mask */
/**
 * @defgroup at_apb_aes_regs_core_irq_mask irq_mask
 * @brief Contains register fields associated with irq_mask. definitions.
 * @{
 */
#ifndef __AES_IRQ_MASK_MACRO__
#define __AES_IRQ_MASK_MACRO__

/* macros for field output_valid_mask */
/**
 * @defgroup at_apb_aes_regs_core_output_valid_mask_field output_valid_mask_field
 * @brief macros for field output_valid_mask
 * @details 1= enable irq
 * @{
 */
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__SHIFT                                3
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__WIDTH                                1
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__MASK                       0x00000008U
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000008U) >> 3)
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__WRITE(src) \
                    (((uint32_t)(src)\
                    << 3) & 0x00000008U)
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | (((uint32_t)(src) <<\
                    3) & 0x00000008U)
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 3) & ~0x00000008U)))
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(1) << 3)
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(0) << 3)
#define AES_IRQ_MASK__OUTPUT_VALID_MASK__RESET_VALUE                0x00000000U
/** @} */

/* macros for field input_ready_mask */
/**
 * @defgroup at_apb_aes_regs_core_input_ready_mask_field input_ready_mask_field
 * @brief macros for field input_ready_mask
 * @details 1= enable irq
 * @{
 */
#define AES_IRQ_MASK__INPUT_READY_MASK__SHIFT                                 4
#define AES_IRQ_MASK__INPUT_READY_MASK__WIDTH                                 1
#define AES_IRQ_MASK__INPUT_READY_MASK__MASK                        0x00000010U
#define AES_IRQ_MASK__INPUT_READY_MASK__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define AES_IRQ_MASK__INPUT_READY_MASK__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define AES_IRQ_MASK__INPUT_READY_MASK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define AES_IRQ_MASK__INPUT_READY_MASK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define AES_IRQ_MASK__INPUT_READY_MASK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define AES_IRQ_MASK__INPUT_READY_MASK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define AES_IRQ_MASK__INPUT_READY_MASK__RESET_VALUE                 0x00000000U
/** @} */

/* macros for field ccm_done_mask */
/**
 * @defgroup at_apb_aes_regs_core_ccm_done_mask_field ccm_done_mask_field
 * @brief macros for field ccm_done_mask
 * @details 1= enable irq
 * @{
 */
#define AES_IRQ_MASK__CCM_DONE_MASK__SHIFT                                    7
#define AES_IRQ_MASK__CCM_DONE_MASK__WIDTH                                    1
#define AES_IRQ_MASK__CCM_DONE_MASK__MASK                           0x00000080U
#define AES_IRQ_MASK__CCM_DONE_MASK__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000080U) >> 7)
#define AES_IRQ_MASK__CCM_DONE_MASK__WRITE(src) \
                    (((uint32_t)(src)\
                    << 7) & 0x00000080U)
#define AES_IRQ_MASK__CCM_DONE_MASK__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | (((uint32_t)(src) <<\
                    7) & 0x00000080U)
#define AES_IRQ_MASK__CCM_DONE_MASK__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 7) & ~0x00000080U)))
#define AES_IRQ_MASK__CCM_DONE_MASK__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(1) << 7)
#define AES_IRQ_MASK__CCM_DONE_MASK__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(0) << 7)
#define AES_IRQ_MASK__CCM_DONE_MASK__RESET_VALUE                    0x00000000U
/** @} */
#define AES_IRQ_MASK__TYPE                                             uint32_t
#define AES_IRQ_MASK__READ                                          0x00000098U
#define AES_IRQ_MASK__WRITE                                         0x00000098U
#define AES_IRQ_MASK__PRESERVED                                     0x00000000U
#define AES_IRQ_MASK__RESET_VALUE                                   0x00000000U

#endif /* __AES_IRQ_MASK_MACRO__ */

/** @} end of irq_mask */

/* macros for BlueprintGlobalNameSpace::AES_irq_clr */
/**
 * @defgroup at_apb_aes_regs_core_irq_clr irq_clr
 * @brief Contains register fields associated with irq_clr. definitions.
 * @{
 */
#ifndef __AES_IRQ_CLR_MACRO__
#define __AES_IRQ_CLR_MACRO__

/* macros for field output_valid_clr */
/**
 * @defgroup at_apb_aes_regs_core_output_valid_clr_field output_valid_clr_field
 * @brief macros for field output_valid_clr
 * @details 1= clear irq (__SELF_CLEARING__)
 * @{
 */
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__SHIFT                                  3
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__WIDTH                                  1
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__MASK                         0x00000008U
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000008U) >> 3)
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 3) & 0x00000008U)
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | (((uint32_t)(src) <<\
                    3) & 0x00000008U)
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 3) & ~0x00000008U)))
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(1) << 3)
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000008U) | ((uint32_t)(0) << 3)
#define AES_IRQ_CLR__OUTPUT_VALID_CLR__RESET_VALUE                  0x00000000U
/** @} */

/* macros for field input_ready_clr */
/**
 * @defgroup at_apb_aes_regs_core_input_ready_clr_field input_ready_clr_field
 * @brief macros for field input_ready_clr
 * @details 1= clear irq (__SELF_CLEARING__)
 * @{
 */
#define AES_IRQ_CLR__INPUT_READY_CLR__SHIFT                                   4
#define AES_IRQ_CLR__INPUT_READY_CLR__WIDTH                                   1
#define AES_IRQ_CLR__INPUT_READY_CLR__MASK                          0x00000010U
#define AES_IRQ_CLR__INPUT_READY_CLR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000010U) >> 4)
#define AES_IRQ_CLR__INPUT_READY_CLR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 4) & 0x00000010U)
#define AES_IRQ_CLR__INPUT_READY_CLR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | (((uint32_t)(src) <<\
                    4) & 0x00000010U)
#define AES_IRQ_CLR__INPUT_READY_CLR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 4) & ~0x00000010U)))
#define AES_IRQ_CLR__INPUT_READY_CLR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(1) << 4)
#define AES_IRQ_CLR__INPUT_READY_CLR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000010U) | ((uint32_t)(0) << 4)
#define AES_IRQ_CLR__INPUT_READY_CLR__RESET_VALUE                   0x00000000U
/** @} */

/* macros for field ccm_done_clr */
/**
 * @defgroup at_apb_aes_regs_core_ccm_done_clr_field ccm_done_clr_field
 * @brief macros for field ccm_done_clr
 * @details 1= clear irq (__SELF_CLEARING__)
 * @{
 */
#define AES_IRQ_CLR__CCM_DONE_CLR__SHIFT                                      7
#define AES_IRQ_CLR__CCM_DONE_CLR__WIDTH                                      1
#define AES_IRQ_CLR__CCM_DONE_CLR__MASK                             0x00000080U
#define AES_IRQ_CLR__CCM_DONE_CLR__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00000080U) >> 7)
#define AES_IRQ_CLR__CCM_DONE_CLR__WRITE(src) \
                    (((uint32_t)(src)\
                    << 7) & 0x00000080U)
#define AES_IRQ_CLR__CCM_DONE_CLR__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | (((uint32_t)(src) <<\
                    7) & 0x00000080U)
#define AES_IRQ_CLR__CCM_DONE_CLR__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 7) & ~0x00000080U)))
#define AES_IRQ_CLR__CCM_DONE_CLR__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(1) << 7)
#define AES_IRQ_CLR__CCM_DONE_CLR__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000080U) | ((uint32_t)(0) << 7)
#define AES_IRQ_CLR__CCM_DONE_CLR__RESET_VALUE                      0x00000000U
/** @} */
#define AES_IRQ_CLR__TYPE                                              uint32_t
#define AES_IRQ_CLR__READ                                           0x00000098U
#define AES_IRQ_CLR__WRITE                                          0x00000098U
#define AES_IRQ_CLR__PRESERVED                                      0x00000000U
#define AES_IRQ_CLR__RESET_VALUE                                    0x00000000U

#endif /* __AES_IRQ_CLR_MACRO__ */
...
/* macros for BlueprintGlobalNameSpace::AES_rev_hash */
/**
 * @defgroup at_apb_aes_regs_core_rev_hash rev_hash
 * @brief Contains register fields associated with rev_hash. definitions.
 * @{
 */
#ifndef __AES_REV_HASH_MACRO__
#define __AES_REV_HASH_MACRO__
 ...
 * @{
 */
#define AES_REV_HASH__ID__SHIFT                                               0
#define AES_REV_HASH__ID__WIDTH                                              32
#define AES_REV_HASH__ID__MASK                                      0xffffffffU
#define AES_REV_HASH__ID__READ(src)             ((uint32_t)(src) & 0xffffffffU)
#define AES_REV_HASH__ID__RESET_VALUE                               0xde4878fbU
/** @} */
#define AES_REV_HASH__TYPE                                             uint32_t
#define AES_REV_HASH__READ                                          0xffffffffU
#define AES_REV_HASH__PRESERVED                                     0x00000000U
#define AES_REV_HASH__RESET_VALUE                                   0xde4878fbU

#endif /* __AES_REV_HASH_MACRO__ */

/** @} end of rev_hash */

/* macros for BlueprintGlobalNameSpace::AES_rev_key */
/**
 * @defgroup at_apb_aes_regs_core_rev_key rev_key
 * @brief Contains register fields associated with rev_key. definitions.
 * @{
 */
#ifndef __AES_REV_KEY_MACRO__
#define __AES_REV_KEY_MACRO__
 ...
 * @{
 */
#define AES_REV_KEY__ID__SHIFT                                                0
#define AES_REV_KEY__ID__WIDTH                                               32
#define AES_REV_KEY__ID__MASK                                       0xffffffffU
#define AES_REV_KEY__ID__READ(src)              ((uint32_t)(src) & 0xffffffffU)
#define AES_REV_KEY__ID__RESET_VALUE                                0x52455620U
/** @} */
#define AES_REV_KEY__TYPE                                              uint32_t
#define AES_REV_KEY__READ                                           0xffffffffU
#define AES_REV_KEY__PRESERVED                                      0x00000000U
#define AES_REV_KEY__RESET_VALUE                                    0x52455620U

#endif /* __AES_REV_KEY_MACRO__ */
