...
/* macros for field pgaout_short */
/**
 * @defgroup radio_rx_regs_core_pgaout_short_field pgaout_short_field
 * @brief macros for field pgaout_short
 * @details when =1, short PGA outputs
 * @{
 */
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__SHIFT                               23
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__WIDTH                                1
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__MASK                       0x00800000U
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00800000U) >> 23)
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__WRITE(src) \
                    (((uint32_t)(src)\
                    << 23) & 0x00800000U)
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | (((uint32_t)(src) <<\
                    23) & 0x00800000U)
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 23) & ~0x00800000U)))
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(1) << 23)
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00800000U) | ((uint32_t)(0) << 23)
#define RADIO_RX_ANA_CTRL__PGAOUT_SHORT__RESET_VALUE                0x00000000U
/** @} */

/* macros for field osdac_on_early */
/**
 * @defgroup radio_rx_regs_core_osdac_on_early_field osdac_on_early_field
 * @brief macros for field osdac_on_early
 * @details when =1, OSDACs are enabled early (with adcon_early); otherwise, with rxon
 * @{
 */
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__SHIFT                             24
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__WIDTH                              1
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__MASK                     0x01000000U
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__READ(src) \
                    (((uint32_t)(src)\
                    & 0x01000000U) >> 24)
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__WRITE(src) \
                    (((uint32_t)(src)\
                    << 24) & 0x01000000U)
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | (((uint32_t)(src) <<\
                    24) & 0x01000000U)
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 24) & ~0x01000000U)))
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(1) << 24)
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x01000000U) | ((uint32_t)(0) << 24)
#define RADIO_RX_ANA_CTRL__OSDAC_ON_EARLY__RESET_VALUE              0x00000001U
/** @} */
 ...
 * @{
 */
#define RADIO_RX_ANA_CTRL__RX_SPARE__SHIFT                                   25
#define RADIO_RX_ANA_CTRL__RX_SPARE__WIDTH                                    7
#define RADIO_RX_ANA_CTRL__RX_SPARE__MASK                           0xfe000000U
...
#define RADIO_RX_ANA_CTRL__RESET_VALUE                              0x01200008U
 ...
 * @details TIA peak detector Vref generator bias current, default 1uA
 * @{
 */
 ...
 * @details TIA offset DAC IC bias current for both I and Q channels, default 1uA
 * @{
 */
 ...
 * @details Spare IC bias currents, default 1uA; setting MSB=1 adds 1uA to TIA bias current
 * @{
 */
