...
#undef CMSDK_AT_UART2
#define CMSDK_AT_UART2	CMSDK_AT_UART2_NONSECURE
#define UARTOVF0_IRQn	UART0_OVERFLOW_IRQn
#define UARTOVF1_IRQn	UART1_OVERFLOW_IRQn
#define UARTOVF2_IRQn	UART2_OVERFLOW_IRQn
...
#if defined(CFG_BLE_HOST) && !defined(RWIP_CONFIG_H_)
