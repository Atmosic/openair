...
#define HCI_OCF_LE_READ_ALL_LOCAL_SUP_FEAT           0x87
#define HCI_OCF_LE_READ_ALL_REMOTE_FEAT              0x88
...
#define HCI_OCF_LE_ADD_DEV_MON_ADV_LIST              0x98
#define HCI_OCF_LE_RM_DEV_MON_ADV_LIST               0x99
#define HCI_OCF_LE_CLEAR_MON_ADV_LIST                0x9A
...
#define HCI_OPCODE_LE_READ_ALL_LOCAL_SUP_FEAT        HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_READ_ALL_LOCAL_SUP_FEAT)
#define HCI_OPCODE_LE_READ_ALL_REMOTE_FEAT           HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_READ_ALL_REMOTE_FEAT)
#define HCI_OPCODE_LE_ADD_DEV_MON_ADV_LIST           HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_ADD_DEV_MON_ADV_LIST)
#define HCI_OPCODE_LE_RM_DEV_MON_ADV_LIST            HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_RM_DEV_MON_ADV_LIST)
#define HCI_OPCODE_LE_CLEAR_MON_ADV_LIST             HCI_OPCODE(HCI_OGF_LE_CONTROLLER, HCI_OCF_LE_CLEAR_MON_ADV_LIST)
...
#define HCI_LEN_LE_SET_DECISION_DATA                (3) /* + Length*/
#define HCI_LEN_LE_SET_DECISION_INSTRUCTION         (1) /* + Length*/
#define HCI_LEN_LE_LE_ADD_DEV_MON_ADV_LIST           10
#define HCI_LEN_LE_LE_LE_RM_DEV_MON_ADV_LIST         7
...
/* Version 6.0 */
#define HCI_LE_CIS_EST_V2_EVT                        0x2A
#define HCI_LE_READ_ALL_REMOTE_FEAT_CMPL_EVT         0x2B
...
/* Version 5.3 */
#define HCI_LEN_ENC_CHANGE_V2                        5       /*!< Encryption change event length (version 2). */
...
/* Version 6.0 */
#define HCI_LEN_LE_CIS_EST_V2                        43      /*!< CIS established event length (version 2). */
#define HCI_LEN_LE_READ_ALL_REMOTE_FEAT_CMPL_EVT     254     /*!< Read all remote features complete event length. */
#define HCI_LEN_LE_CS_READ_REMOTE_SUP_CAP_CMPL_EVT   32      /*!< Channel sounding read remote supported capabilities complete event length. */
#define HCI_LEN_LE_CS_READ_REMOTE_FAE_TBL_CMPL_EVT   76      /*!< Channel sounding read remote FAE table complete event length. */
#define HCI_LEN_LE_CS_SECURITY_ENABLE_CMPL_EVT       4       /*!< Channel sounding security enable complete event length. */
#define HCI_LEN_LE_CS_CONFIG_CMPL_EVT                34      /*!< Channel sounding configuration complete event length. */
#define HCI_LEN_LE_CS_PROCEDURE_ENABLE_CMPL_EVT      22      /*!< Channel sounding procedure enable complete event length. */
#define HCI_LEN_LE_CS_SUBEVENT_RESULT_EVT            0       /*!< Channel sounding subevent result event length. */
#define HCI_LEN_LE_CS_SUBEVENT_RESULT_CON_EVT        0       /*!< Channel sounding subevent result continue event length. */
...
#define HCI_SUP_LE_READ_ALL_LOCAL_SUP_FEAT           0x04U    /*!< Byte 47 */
#define HCI_SUP_LE_READ_ALL_REMOTE_FEAT              0x08U    /*!< Byte 47 */
#define HCI_SUP_LE_ADD_DEV_MON_ADV_LIST              0x20U    /*!< Byte 47 */
#define HCI_SUP_LE_RM_DEV_MON_ADV_LIST               0x40U    /*!< Byte 47 */
#define HCI_SUP_LE_CLEAR_MON_ADV_LIST                0x80U    /*!< Byte 47 */
...
/* Version 6.0 */
#define HCI_EVT_MASK_LE_CIS_EST_V2_EVT                      0x02U    /*!< Byte 5 */
#define HCI_EVT_MASK_LE_READ_ALL_REMOTE_FEAT_CMPL_EVT       0x04U    /*!< Byte 5 */
...
/* --- Core Spec 6.0 --- */
#define HCI_LE_CHANNEL_SOUNDING                      0x0000400000000000U   /*!< channel sounding supported. */
#define HCI_LE_SUP_FEAT_CHANNEL_SOUNDING_HOST_SUP    0x0000800000000000U   /*!< Host support for channel sounding supported. */
#define HCI_LE_CHANNEL_SOUNDING_PCT_QUAL_IND         0x0001000000000000U   /*!< Channel Sounding PCT Quality Indication supported. */
...
#define HCI_LE_FEAT_BIT_CHANNEL_SOUNDING_HOST_SUP    47  /*!< Host support for Channel sounding */
...
#define HCI_ADV_PROP_USE_DECISION_PDU_BIT            (1U<<7)  /*!< Enable the decision PDUs in ADV packet */
#define HCI_ADV_PROP_DECISION_WITH_ADVA_BIT          (1U<<8)  /*!< Include AdvA in the extended header of all decision PDUs */
#define HCI_ADV_PROP_DECISION_WITH_ADI_BIT           (1U<<9)  /*!< Include ADI in the extended header of all decision PDUs */
...
/* meaning change after ALTANTA */

/*!< unfiltered scanning policy && Basic filter policy, && No‑decisions mode */
#define HCI_FILT_NONE                                0
/*!< filtered scanning policy && Basic filter policy, && No‑decisions mode */
#define HCI_FILT_WHITE_LIST                          1       /*!< Accept from While List only */
/*!< unfiltered scanning policy && Extended filter policy, && No‑decisions mode */
#define HCI_FILT_RES_INIT                            2       /*!< Accept directed advertisements with RPAs */
/*!< filtered scanning policy && Extended filter policy, && No‑decisions mode */
...
/*
        ...
        Bit 0,
        0 = unfiltered scanning policy
        1 = filtered scanning policy
        Bit 1,
        0 = Basic filter policy
        1 = Extended filter policy

        Bit 2 and 3 Decision scanning filter policy mode:
        0b00 = No‑decisions mode
        0b01 = All‑PDUs mode
        0b11 = Decisions‑only mode
*/
#define HCI_FILT_VAL_0100                               4
#define HCI_FILT_VAL_0101                               5
#define HCI_FILT_VAL_0110                               6
#define HCI_FILT_VAL_0111                               7
#define HCI_FILT_VAL_1000                               8
#define HCI_FILT_VAL_1001                               9
#define HCI_FILT_VAL_1010                              10
#define HCI_FILT_VAL_1011                              11
#define HCI_FILT_VAL_1100                              12
#define HCI_FILT_VAL_1101                              13
#define HCI_FILT_VAL_1110                              14
#define HCI_FILT_VAL_1111                              15
...
#define HCI_FILT_SCAN_BIT_MASK                        0x0F   /*!< Scanning_Filter_Policy in v6.0 */

/*!<
Initiator_Filter_Policy 0 in v6.0
Filter Accept List : Not used, Decision PDUs: Not used, Peer_Address_Type and Peer_Address:Used
*/

#define HCI_FILT_INIT_POLICY_VAL_0           0

/*!<
Initiator_Filter_Policy 1 in v6.0
Filter Accept List : Used, Decision PDUs: Not used, Peer_Address_Type and Peer_Address: Ignored.
*/

#define HCI_FILT_INIT_POLICY_VAL_1           1
/*!<
Initiator_Filter_Policy 2 in v6.0
Filter Accept List is not used to determine which advertiser to connect to. Only
Decision PDUs shall be processed. Peer_Address_Type and Peer_Address shall.
*/
#define HCI_FILT_INIT_POLICY_VAL_2           2

/*!<
Initiator_Filter_Policy 3 in v6.0
Filter Accept List is used to determine which advertiser to connect to. All PDUs
shall be processed. Peer_Address_Type and Peer_Address shall be ignored..
*/

#define HCI_FILT_INIT_POLICY_VAL_3           3

/*!<
Initiator_Filter_Policy 3 in v6.0
All decision PDUs shall be processed.
Filter Accept List is used to determine
which other PDUs to process.Peer_Address_Type and Peer_Address: Ignored
*/
#define HCI_FILT_INIT_POLICY_VAL_4           4


#define HCI_FILT_INIT_MAX                             0x04   /*!< Initiator_Filter_Policy in v6.0 */
...
#define HCI_FRAMING_FRAMED_UNSEGMENTED					     0x02		 /*!< New Framed UnSegmentable */
