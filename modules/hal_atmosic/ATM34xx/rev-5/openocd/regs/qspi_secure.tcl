namespace eval CMSDK_QSPI_SECURE {
    ...
    proc PREFETCH_STATUS_CNT0 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STATUS_CNT1 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STATUS_CNT2 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STATUS_CNT3 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc PREFETCH_STATUS_CNT4 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
    ...
    proc REMOTE_AHB_DBG3 { {base [::CMSDK_QSPI_SECURE::BASE]} } {
