namespace eval CMSDK_GPIO3_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x40104000
    }
    namespace export DATA
    proc DATA { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval DATA {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval DATA {
    ...
    proc DATAOUT { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INENABLE_SET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INENABLE_CLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc OUTENSET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc OUTENCLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc ALTFUNCSET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc ALTFUNCCLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTENSET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTENCLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTTYPESET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTTYPECLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTPOLSET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTPOLCLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc INTSTATUS_CLEAR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PULLUP_ENABLE_SET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PULLUP_ENABLE_CLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PULLDOWN_ENABLE_SET { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PULLDOWN_ENABLE_CLR { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc MASKLOWBYTE { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc MASKHIGHBYTE { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID4 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID5 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID6 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID7 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID0 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID1 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID2 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc PID3 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc CID0 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc CID1 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc CID2 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
    ...
    proc CID3 { {base [::CMSDK_GPIO3_NONSECURE::BASE]} } {
