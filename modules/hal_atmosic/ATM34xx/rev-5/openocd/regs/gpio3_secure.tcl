namespace eval CMSDK_GPIO3_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x50104000
    }
    namespace export DATA
    proc DATA { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval DATA {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval DATA {
    ...
    proc DATAOUT { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INENABLE_SET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INENABLE_CLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc OUTENSET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc OUTENCLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc ALTFUNCSET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc ALTFUNCCLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTENSET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTENCLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTTYPESET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTTYPECLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTPOLSET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTPOLCLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc INTSTATUS_CLEAR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PULLUP_ENABLE_SET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PULLUP_ENABLE_CLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PULLDOWN_ENABLE_SET { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PULLDOWN_ENABLE_CLR { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc MASKLOWBYTE { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc MASKHIGHBYTE { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID4 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID5 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID6 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID7 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID0 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID1 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID2 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc PID3 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc CID0 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc CID1 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc CID2 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
    ...
    proc CID3 { {base [::CMSDK_GPIO3_SECURE::BASE]} } {
