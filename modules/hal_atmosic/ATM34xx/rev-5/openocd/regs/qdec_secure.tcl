namespace eval CMSDK_QDEC_SECURE {
    namespace export BASE
    proc BASE {} {
        return 0x5014c000
    }
    namespace export SETUP_FOR_AXIS_0
    proc SETUP_FOR_AXIS_0 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval SETUP_FOR_AXIS_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
        namespace eval ENABLE_LOOPBACK {
        ...
        namespace eval QSIG_B_LOOPBACK_VAL {
            namespace export SHIFT
            proc SHIFT {} {
                return 1
            }
        ...
        namespace eval QSIG_A_LOOPBACK_VAL {
            namespace export SHIFT
            proc SHIFT {} {
                return 2
            }
        ...
        namespace eval REVERSE_POLARITY {
            namespace export SHIFT
            proc SHIFT {} {
                return 3
            }
        ...
        namespace eval PURGE_ACCUM_POST_READ {
            namespace export SHIFT
            proc SHIFT {} {
                return 4
            }
        ...
        namespace eval PURGE_ERR_POST_READ {
            namespace export SHIFT
            proc SHIFT {} {
                return 5
            }
    ...
    namespace export ACCUM_PURGE_STATUS_FOR_AXIS_0
    proc ACCUM_PURGE_STATUS_FOR_AXIS_0 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x4 }]
    }
    namespace eval ACCUM_PURGE_STATUS_FOR_AXIS_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x4 }]
        }
        namespace eval ACCUM_PURGE_STS {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export ACCUMULATOR_VALUE_FOR_AXIS_0
    proc ACCUMULATOR_VALUE_FOR_AXIS_0 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x8 }]
    }
    namespace eval ACCUMULATOR_VALUE_FOR_AXIS_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x8 }]
        }
        namespace eval ACCUM_VAL {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export ERR_PURGE_STATUS_FOR_AXIS_0
    proc ERR_PURGE_STATUS_FOR_AXIS_0 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0xc }]
    }
    namespace eval ERR_PURGE_STATUS_FOR_AXIS_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0xc }]
        }
        namespace eval ERR_PURGE_STS {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export ERROR_COUNT_FOR_AXIS_0
    proc ERROR_COUNT_FOR_AXIS_0 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x10 }]
    }
    namespace eval ERROR_COUNT_FOR_AXIS_0 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x10 }]
        }
        namespace eval ERR_CNT {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export SETUP_FOR_AXIS_1
    proc SETUP_FOR_AXIS_1 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x14 }]
    }
    namespace eval SETUP_FOR_AXIS_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x14 }]
        }
    ...
    namespace export ACCUM_PURGE_STATUS_FOR_AXIS_1
    proc ACCUM_PURGE_STATUS_FOR_AXIS_1 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x18 }]
    }
    namespace eval ACCUM_PURGE_STATUS_FOR_AXIS_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x18 }]
        }
    ...
    namespace export ACCUMULATOR_VALUE_FOR_AXIS_1
    proc ACCUMULATOR_VALUE_FOR_AXIS_1 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x1c }]
    }
    namespace eval ACCUMULATOR_VALUE_FOR_AXIS_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x1c }]
        }
    ...
    namespace export ERR_PURGE_STATUS_FOR_AXIS_1
    proc ERR_PURGE_STATUS_FOR_AXIS_1 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x20 }]
    }
    namespace eval ERR_PURGE_STATUS_FOR_AXIS_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x20 }]
        }
    ...
    namespace export ERROR_COUNT_FOR_AXIS_1
    proc ERROR_COUNT_FOR_AXIS_1 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x24 }]
    }
    namespace eval ERROR_COUNT_FOR_AXIS_1 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x24 }]
        }
    ...
    namespace export SETUP_FOR_AXIS_2
    proc SETUP_FOR_AXIS_2 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x28 }]
    }
    namespace eval SETUP_FOR_AXIS_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x28 }]
        }
    ...
    namespace export ACCUM_PURGE_STATUS_FOR_AXIS_2
    proc ACCUM_PURGE_STATUS_FOR_AXIS_2 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x2c }]
    }
    namespace eval ACCUM_PURGE_STATUS_FOR_AXIS_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x2c }]
        }
    ...
    namespace export ACCUMULATOR_VALUE_FOR_AXIS_2
    proc ACCUMULATOR_VALUE_FOR_AXIS_2 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x30 }]
    }
    namespace eval ACCUMULATOR_VALUE_FOR_AXIS_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x30 }]
        }
    ...
    namespace export ERR_PURGE_STATUS_FOR_AXIS_2
    proc ERR_PURGE_STATUS_FOR_AXIS_2 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x34 }]
    }
    namespace eval ERR_PURGE_STATUS_FOR_AXIS_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x34 }]
        }
    ...
    namespace export ERROR_COUNT_FOR_AXIS_2
    proc ERROR_COUNT_FOR_AXIS_2 { {base [::CMSDK_QDEC_SECURE::BASE]} } {
        return [expr { [expr $base] + 0x38 }]
    }
    namespace eval ERROR_COUNT_FOR_AXIS_2 {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_QDEC_SECURE::BASE]} } {
            return [expr { [expr $base] + 0x38 }]
        }
    ...
    proc CORE_ID { {base [::CMSDK_QDEC_SECURE::BASE]} } {
    ...
    proc REV_HASH { {base [::CMSDK_QDEC_SECURE::BASE]} } {
    ...
    proc REV_KEY { {base [::CMSDK_QDEC_SECURE::BASE]} } {
