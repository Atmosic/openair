namespace eval CMSDK_WRPR0_NONSECURE {
    ...
    namespace export PSEL_N
    proc PSEL_N { {base [::CMSDK_WRPR0_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x84 }]
    }
    namespace eval PSEL_N {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR0_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x84 }]
        }
        namespace eval P48_SEL {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
    ...
    namespace export PSEL_O
    proc PSEL_O { {base [::CMSDK_WRPR0_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x88 }]
    }
    namespace eval PSEL_O {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_WRPR0_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x88 }]
        }
        namespace eval P52_SEL {
            namespace export SHIFT
            proc SHIFT {} {
                return 0
            }
