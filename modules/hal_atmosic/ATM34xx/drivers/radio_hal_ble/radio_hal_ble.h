...
typedef enum {
    ATM_MAC_BLE_STATUS_SUCCESS,
    ATM_MAC_BLE_STATUS_FAILED,
    ATM_MAC_BLE_STATUS_TIMEOUT,
    ATM_MAC_BLE_STATUS_CRC_FAILED,
    ATM_MAC_BLE_STATUS_MIC_FAILED,
    ATM_MAC_BLE_STATUS_TIMESTAMP_PAST,
    ATM_MAC_BLE_STATUS_TX_UNDERFLOW,
    ATM_MAC_BLE_STATUS_RX_OVERFLOW,
    ATM_MAC_BLE_STATUS_CS_AA_FAILED,
    ATM_MAC_BLE_STATUS_CS_SEQ_FAILED,
} atm_mac_ble_status_t;
...
typedef void (*atm_mac_ble_tx_cpl_cb)(atm_mac_ble_status_t status);
typedef void (*atm_mac_ble_rx_cpl_cb)(atm_mac_ble_status_t status,
    uint32_t start_offset, int8_t rssi);
typedef bool (*atm_mac_ble_cs_cb)(uint32_t *irq_status);
...
/**
 * @brief Call BLE TX complete callback.
 *
...
/**
 * @brief Call BLE RX complete callback.
 *
