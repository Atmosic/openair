...
#ifdef SEC_PRIV_CTRL_APBNSPPCEXP2_UART2_Pos
#define PERIPHERAL_UART2 PERIPHERAL(UART2, AT_, APB, PPCEXP2)
#else
#define PERIPHERAL_UART2
#endif
...
#ifdef SEC_PRIV_CTRL_AHBNSPPCEXP1_GPIO2_Pos
#define ALT_PERIPHERAL_GPIO2 ALT_PERIPHERAL(GPIO2, CMSDK_GPIO2, AHB, PPCEXP1)
#else
#define ALT_PERIPHERAL_GPIO2
#endif
#ifdef SEC_PRIV_CTRL_AHBNSPPCEXP1_GPIO3_Pos
#define ALT_PERIPHERAL_GPIO3 ALT_PERIPHERAL(GPIO3, CMSDK_GPIO3, AHB, PPCEXP1)
#else
#define ALT_PERIPHERAL_GPIO3
#endif
...
#define ALT_PPC_PERIPHERALS \
    ...
    ALT_PERIPHERAL_GPIO2 \
    ALT_PERIPHERAL_GPIO3 \
...
#ifdef SEC_PRIV_CTRL_AHBNSPPCEXP1_GPIO3_Msk
	SEC_PRIV_CTRL_AHBNSPPCEXP1_GPIO3_Msk |
#endif
#ifdef SEC_PRIV_CTRL_AHBNSPPCEXP1_GPIO2_Msk
...
#ifdef SEC_PRIV_CTRL_APBNSPPCEXP2_UART2_Msk
...
#ifdef SEC_PRIV_CTRL_AHBSPPPCEXP1_GPIO3_Msk
	SEC_PRIV_CTRL_AHBSPPPCEXP1_GPIO3_Msk |
#endif
#ifdef SEC_PRIV_CTRL_AHBSPPPCEXP1_GPIO2_Msk
...
#ifdef SEC_PRIV_CTRL_APBSPPPCEXP2_UART2_Msk
...
#ifdef NONSEC_PRIV_CTRL_AHBNSPPPCEXP1_GPIO3_Msk
	NONSEC_PRIV_CTRL_AHBNSPPPCEXP1_GPIO3_Msk |
#endif
#ifdef NONSEC_PRIV_CTRL_AHBNSPPPCEXP1_GPIO2_Msk
...
#ifdef NONSEC_PRIV_CTRL_APBNSPPPCEXP2_UART2_Msk
