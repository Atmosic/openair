...
/**
 * @brief Keep VAUX on during SOC OFF
 * @param[in] enable true/false
 */
void pmu_set_socoff_swreg_override(bool enable);
...
/**
 * @brief Program VSTORE energy_indicators
 * @param[in] enable    1 = Enable / 0 = Disable
 */
void pmu_ignore_vstore_energy_indicators(bool enable);
...
/**
 * @brief Enable/Disable reset due to VDDIO drop
 * @param[in] enable  Flag to enable/disable
 */
