...
#define PMU_WDOG_TIMEOUT CONFIG_PMU_WDOG_TIMEOUT
#endif
#ifndef PMU_WDOG_TIMEOUT
#define PMU_WDOG_TIMEOUT 0
#endif
...
static void pmu_init(void)
{
	...
	.pmu_wdog_timeout = PMU_WDOG_TIMEOUT,
	.boost_src =
#ifdef BOOST_FROM_VHARV_INDUCTOR
...
__FAST void PMU_Handler(void)
{
    ...
    (!defined(CONFIG_SOC_FAMILY_ATM) && !defined(NO_BROWNOUT))
    if (brownout) {
	brwnout_pmu_handler();
    }
#endif
