...
__RWIP_INLINE uint16_t em_ble_txisoptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisoptr_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE void em_ble_txisoptr_pack(int elt_idx, uint8_t txdone, uint8_t txsent, uint16_t nextptr)
{
...
__RWIP_INLINE void em_ble_txisoptr_unpack(int elt_idx, uint8_t* txdone, uint8_t* txsent, uint16_t* nextptr)
{
...
__RWIP_INLINE uint8_t em_ble_txisoptr_txdone_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__RWIP_INLINE void em_ble_txisoptr_txdone_setf(int elt_idx, uint8_t txdone)
{
    ASSERT_ERR((((uint16_t)txdone << 15) & ~((uint16_t)0x00008000)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txisoptr_txsent_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__RWIP_INLINE void em_ble_txisoptr_txsent_setf(int elt_idx, uint8_t txsent)
{
    ASSERT_ERR((((uint16_t)txsent << 14) & ~((uint16_t)0x00004000)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txisoptr_nextptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__RWIP_INLINE void em_ble_txisoptr_nextptr_setf(int elt_idx, uint16_t nextptr)
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txisocnt0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisocnt0_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE uint16_t em_ble_txisocnt0_txpld_cnt0_getf(int elt_idx)
{
...
__RWIP_INLINE void em_ble_txisocnt0_txpld_cnt0_setf(int elt_idx, uint16_t txpldcnt0)
{
...
__RWIP_INLINE uint16_t em_ble_txisocnt1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT1_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisocnt1_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE uint16_t em_ble_txisocnt1_txpld_cnt1_getf(int elt_idx)
{
...
__RWIP_INLINE void em_ble_txisocnt1_txpld_cnt1_setf(int elt_idx, uint16_t txpldcnt1)
{
...
__RWIP_INLINE uint16_t em_ble_txisocnt2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisocnt2_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE void em_ble_txisocnt2_pack(int elt_idx, uint8_t txflushinstant, uint8_t txpldcnt2)
{
...
__RWIP_INLINE void em_ble_txisocnt2_unpack(int elt_idx, uint8_t* txflushinstant, uint8_t* txpldcnt2)
{
...
__RWIP_INLINE uint8_t em_ble_txisocnt2_txflushinstant_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__RWIP_INLINE void em_ble_txisocnt2_txflushinstant_setf(int elt_idx, uint8_t txflushinstant)
{
    ASSERT_ERR((((uint16_t)txflushinstant << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txisocnt2_txpld_cnt2_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000007F)) >> 0);
}

__RWIP_INLINE void em_ble_txisocnt2_txpld_cnt2_setf(int elt_idx, uint8_t txpldcnt2)
{
    ASSERT_ERR((((uint16_t)txpldcnt2 << 0) & ~((uint16_t)0x0000007F)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txisophm0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisophm0_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE void em_ble_txisophm0_pack(int elt_idx, uint8_t txisom0rfu, uint8_t txmd, uint8_t txsn, uint8_t txnesn)
{
...
__RWIP_INLINE void em_ble_txisophm0_unpack(int elt_idx, uint8_t* txisom0rfu, uint8_t* txmd, uint8_t* txsn, uint8_t* txnesn)
{
...
__RWIP_INLINE uint8_t em_ble_txisophm0_txisom0rfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__RWIP_INLINE void em_ble_txisophm0_txisom0rfu_setf(int elt_idx, uint8_t txisom0rfu)
{
    ASSERT_ERR((((uint16_t)txisom0rfu << 5) & ~((uint16_t)0x000000E0)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txisophm0_txmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__RWIP_INLINE void em_ble_txisophm0_txmd_setf(int elt_idx, uint8_t txmd)
{
    ASSERT_ERR((((uint16_t)txmd << 4) & ~((uint16_t)0x00000010)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txisophm0_txsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__RWIP_INLINE void em_ble_txisophm0_txsn_setf(int elt_idx, uint8_t txsn)
{
    ASSERT_ERR((((uint16_t)txsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txisophm0_txnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__RWIP_INLINE void em_ble_txisophm0_txnesn_setf(int elt_idx, uint8_t txnesn)
{
    ASSERT_ERR((((uint16_t)txnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txcisph_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txcisph_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE void em_ble_txcisph_pack(int elt_idx, uint8_t txcisrfu1, uint8_t txcisnpi, uint8_t txcisrfu0, uint8_t txcie, uint8_t txsn, uint8_t txnesn)
{
...
__RWIP_INLINE void em_ble_txcisph_unpack(int elt_idx, uint8_t* txcisrfu1, uint8_t* txcisnpi, uint8_t* txcisrfu0, uint8_t* txcie, uint8_t* txsn, uint8_t* txnesn)
{
...
__RWIP_INLINE uint8_t em_ble_txcisph_txcisrfu1_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__RWIP_INLINE void em_ble_txcisph_txcisrfu1_setf(int elt_idx, uint8_t txcisrfu1)
{
    ASSERT_ERR((((uint16_t)txcisrfu1 << 7) & ~((uint16_t)0x00000080)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txcisph_txcisnpi_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__RWIP_INLINE void em_ble_txcisph_txcisnpi_setf(int elt_idx, uint8_t txcisnpi)
{
    ASSERT_ERR((((uint16_t)txcisnpi << 6) & ~((uint16_t)0x00000040)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txcisph_txcisrfu0_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__RWIP_INLINE void em_ble_txcisph_txcisrfu0_setf(int elt_idx, uint8_t txcisrfu0)
{
    ASSERT_ERR((((uint16_t)txcisrfu0 << 5) & ~((uint16_t)0x00000020)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txcisph_txcie_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__RWIP_INLINE void em_ble_txcisph_txcie_setf(int elt_idx, uint8_t txcie)
{
    ASSERT_ERR((((uint16_t)txcie << 4) & ~((uint16_t)0x00000010)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txcisph_txsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__RWIP_INLINE void em_ble_txcisph_txsn_setf(int elt_idx, uint8_t txsn)
{
    ASSERT_ERR((((uint16_t)txsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txcisph_txnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXCISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__RWIP_INLINE void em_ble_txcisph_txnesn_setf(int elt_idx, uint8_t txnesn)
{
    ASSERT_ERR((((uint16_t)txnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txbisph_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXBISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txbisph_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE void em_ble_txbisph_pack(int elt_idx, uint8_t txbisrfu, uint8_t txcstf, uint8_t txcssn)
{
...
__RWIP_INLINE void em_ble_txbisph_unpack(int elt_idx, uint8_t* txbisrfu, uint8_t* txcstf, uint8_t* txcssn)
{
...
__RWIP_INLINE uint8_t em_ble_txbisph_txbisrfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXBISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000C0)) >> 6);
}

__RWIP_INLINE void em_ble_txbisph_txbisrfu_setf(int elt_idx, uint8_t txbisrfu)
{
    ASSERT_ERR((((uint16_t)txbisrfu << 6) & ~((uint16_t)0x000000C0)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txbisph_txcstf_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXBISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__RWIP_INLINE void em_ble_txbisph_txcstf_setf(int elt_idx, uint8_t txcstf)
{
    ASSERT_ERR((((uint16_t)txcstf << 5) & ~((uint16_t)0x00000020)) == 0);
...
__RWIP_INLINE uint8_t em_ble_txbisph_txcssn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXBISPH_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000001C)) >> 2);
}

__RWIP_INLINE void em_ble_txbisph_txcssn_setf(int elt_idx, uint8_t txcssn)
{
    ASSERT_ERR((((uint16_t)txcssn << 2) & ~((uint16_t)0x0000001C)) == 0);
...
__RWIP_INLINE uint16_t em_ble_txisobufptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOBUFPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__RWIP_INLINE void em_ble_txisobufptr_set(int elt_idx, uint16_t value)
{
...
__RWIP_INLINE uint16_t em_ble_txisobufptr_getf(int elt_idx)
{
...
__RWIP_INLINE void em_ble_txisobufptr_setf(int elt_idx, uint16_t txisobufptr)
{
