...
#define REG_EM_IDX_GET(elem, addr) (((((uint32_t)addr)<<2) - (EM_##elem##_OFFSET))/(REG_EM_##elem##_SIZE))
...
#define EM_RF_FREQ_TABLE_LEN  (80u * RF_FREQ_TABLE_ELT_SIZE)
#define EM_RF_VCO_TABLE_LEN (80u * RF_VCO_TABLE_ELT_SIZE)
#elif BLE_EMB_PRESENT
/// Requires 40 x words for Frequency table + potential VCO sub-band table
#define EM_RF_FREQ_TABLE_LEN  (40u * RF_FREQ_TABLE_ELT_SIZE)
#define EM_RF_VCO_TABLE_LEN (40u * RF_VCO_TABLE_ELT_SIZE)
