namespace eval CMSDK_RCOS_CAL_NONSECURE {
    namespace export BASE
    proc BASE {} {
        return 0x4015c000
    }
    namespace export CAL_CTRL
    proc CAL_CTRL { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
        return [expr { [expr $base] + 0x0 }]
    }
    namespace eval CAL_CTRL {
        namespace export REG_ADDR
        proc REG_ADDR { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
            return [expr { [expr $base] + 0x0 }]
        }
    ...
    proc SLOW_CLK_SET { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc SLOW_CLK_CNT { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc FAST_CLK_CNT { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc SOURCE_CLK_SEL { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc FORCE_RESET { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc STAT { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_STATUS { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc INTERRUPT_MASK { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc SET_INTERRUPT { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc RESET_INTERRUPT { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
    ...
    proc CORE_ID { {base [::CMSDK_RCOS_CAL_NONSECURE::BASE]} } {
