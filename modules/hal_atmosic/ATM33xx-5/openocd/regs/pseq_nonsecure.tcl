namespace eval CMSDK_PSEQ_NONSECURE {
    ...
    proc XTAL_BITS0 { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc XTAL_BITS1 { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    namespace eval PMU_INTERRUPT {
        ...
        namespace eval CLEAR_RE_SI_DET {
            namespace export SHIFT
            proc SHIFT {} {
                return 24
            }
        ...
        namespace eval CLEAR_FE_SI_DET {
            namespace export SHIFT
            proc SHIFT {} {
                return 29
            }
    ...
    proc SYSRAM_SSRS_CFG { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
    ...
    proc RADIO_STATUS { {base [::CMSDK_PSEQ_NONSECURE::BASE]} } {
