namespace eval CMSDK_NVM_NONSECURE {
    ...
    proc CTRL { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc DATA0 { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc DATA1 { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_SP_VQ { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_HP_VQ { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_SP_PG { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_HP_PG { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_HP_CK { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_S_PGM { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_H_PGM { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_CKHP { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_CKLP { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_SPS_CK { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_SR_CK { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_HR_CK { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_CKLR { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_CKHR { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
    ...
    proc T_SRS_CK { {base [::CMSDK_NVM_NONSECURE::BASE]} } {
