...
CFLAGS += $(if $(ENA_LL_FEAT_PAWR),\
            -DENA_LL_FEAT_PAWR,\
            $(call D4_OPT,PD50,$(DEFAULT_DIS_LL_FEAT_PAWR),-DENA_LL_FEAT_PAWR))

CFLAGS += $(if $(ENA_LL_FEAT_PAST),\
            -DENA_LL_FEAT_PAST,\
            $(call D4_OPT,PD50,$(DEFAULT_DIS_LL_FEAT_PAST),-DENA_LL_FEAT_PAST))

CFLAGS += $(if $(ENA_LL_FEAT_SLV_PER_ADV),\
            -DENA_LL_FEAT_SLV_PER_ADV,\
            $(call D4_OPT,PD50,$(DEFAULT_DIS_LL_FEAT_SLV_PER_ADV),-DENA_LL_FEAT_SLV_PER_ADV))
