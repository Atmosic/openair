...
#if (BLE_SERVER_PRF || BLE_CLIENT_PRF || !defined(CFG_USER))
#include "ke_msg.h"
#include "prf_types.h"
...
#if (BLE_BATT_SERVER || !defined(CFG_USER))
/**
 ****************************************************************************************
...
#if (BLE_BATT_CLIENT || !defined(CFG_USER))
/**
 ****************************************************************************************
...
#if (BLE_CLIENT_PRF || !defined(CFG_USER))
/**
 ****************************************************************************************
...
void prf_gatt_write(prf_env_t *prf_env, uint8_t conidx,
                    uint16_t handle, uint8_t const *value, uint16_t length, uint8_t operation);
...
#if (BLE_CLIENT_PRF || BLE_TIP_SERVER || BLE_AN_SERVER || BLE_PAS_SERVER || !defined(CFG_USER))
 ...
 ****************************************************************************************
 */
uint8_t prf_unpack_date_time(uint8_t const *packed_date, struct prf_date_time* date_time);

#endif /* (BLE_SERVER_PRF || BLE_CLIENT_PRF) */

#if ((BLE_CGM_SERVER || BLE_CGM_CLIENT || !defined(CFG_USER)))
/**
 ****************************************************************************************
