...
/// ATMOSIC Airfuel WPT Profile Server Role
#if defined(CFG_PRF_AFWPTS)
#define BLE_AFWPT_SERVER      1
#else
#define BLE_AFWPT_SERVER      0
#endif // defined(CFG_PRF_AFWPTS)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
        ...
        || BLE_AGP_SERVER || BLE_DTP_SERVER || BLE_ATVV_SERVER || BLE_AFWPT_SERVER \
	)
...
/// ATMOSIC DT Profile Server Role
#define BLE_DTP_SERVER              0
/// ATMOSIC AirFuel WPT Profile Server Tole
#define BLE_AFWPT_SERVER            0
