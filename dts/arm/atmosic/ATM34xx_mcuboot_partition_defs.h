...
#else
#define ATM_APP_OFFSET  ATM_SLOT2_OFFSET
// APP image size in external flash less any trailer reservation
#define ATM_APP_SIZE (ATM_SLOT2_SIZE - ATM_SLOT2_TRAILER_RSVD_SIZE)
#endif
...
#else
#define ATM_SLOT2_TRAILER_RSVD_OFFSET (ATM_APP_OFFSET + ATM_APP_SIZE)
#endif
#else // ATM_FAST_CODE_SIZE
#if (ATM_SPE_SIZE)
