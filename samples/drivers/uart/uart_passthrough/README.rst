...
.. code-block:: bash
    ...
    west build -p always -b <BOARD> openair/samples/drivers/uart/uart_passthrough --sysbuild -T samples.drivers.uart.uart_passthrough.atm

Flash command:

.. code-block:: bash

    west flash --no-rebuild --device <DEVICE_ID> --jlink [--fast_load]
