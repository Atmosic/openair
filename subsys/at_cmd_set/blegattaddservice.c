...
#define CMD_NAME      "BLEGATTADDSERVICE"
#define CMD_PARM_FMT  "A(2~2),A(16~16)"
#define CMD_PARM_DESC "<sec_prop>,<uuid>"
#define CMD_PARM_NUM  2

LOG_MODULE_REGISTER(blegattaddservice, CONFIG_AT_CMD_SET_LOG_LEVEL);
...
static void fn_cmd_handler(at_cmd_param_t *param)
{
	...
	at_cmd_result_t result = at_cmd_gatt_dyn_add_service(sec_prop, uuid);
