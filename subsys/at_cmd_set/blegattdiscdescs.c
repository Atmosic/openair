...
#define CMD_NAME      "BLEGATTDISCDESCS"
...
#define RSP_PARM_FMT  "B,W,A(2~16)"
#define RSP_PARM_NUM  3

LOG_MODULE_REGISTER(blegattdiscdescs, CONFIG_AT_CMD_SET_LOG_LEVEL);
				...
				uint8_t uuid_len)
{
	...
	at_cmd_resp(ch, at_all, cmd, 0, RSP_PARM_NUM, conidx, handle, uuid, (uint16_t)uuid_len);
}
