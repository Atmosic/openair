...
static void pwm_atm_pm_constraint_set(const struct device *dev, uint32_t channel)
{
...
static void pwm_atm_pm_constraint_release(const struct device *dev, uint32_t channel)
{
