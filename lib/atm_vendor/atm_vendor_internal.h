...
#define VND_OPCODE(ogf, ocf) ((ocf) | ((ogf) << 8))
...
typedef enum {
    VND_OCF_RD_MEM = 0x01,
    VND_OCF_WR_MEM,
    VND_OCF_SET_PREF_S_LAT = 0x13,
    VND_OCF_SET_TX_POWER = 0x1A,
...
// Set Prefer Slave Latency (0xFC13)
#define VS_SET_PREF_SLAVE_LATENCY_CMD_OCF VND_OCF_SET_PREF_S_LAT
#define VS_SET_PREF_SLAVE_LATENCY_CMD_OGF VND_OGF_SB1
#define VS_SET_PREF_SLAVE_LATENCY_CMD_LEN 0x04

// Set Connection TX Power (0xFC1A)
...
// 32K PIN Output (0xFC34)
#define XTAL_32K_PIN_OUT_CMD_OCF VND_OCF_XTAL_32K_PIN_OUTPUT
#define XTAL_32K_PIN_OUT_CMD_OGF VND_OGF_SB1
#define XTAL_32K_PIN_OUT_CMD_LEN 0x01
...
struct vendor_handler {
    ...
    uint8_t cmd_len;
    bool check_cmd_len;
    void (*cmd_hdlr)(uint8_t const *buf);
...
#ifdef CFG_VND_XTAL_32K_PIN_OUT
#define XTAL_32K_PIN_OUT_CMD 1

typedef struct {
    xtal_32k_pin_t pin;
} xtal_32k_pin_out_cmd_t;
#else
#define XTAL_32K_PIN_OUT_CMD 0
#endif
