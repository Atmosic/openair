...
class AtmispBinaryRunner(ZephyrBinaryRunner):
    ...
    def do_add_parser(cls, parser):
        ...
        # optional argument(s)
        parser.add_argument('--erase_all', default=False, required=False, action='store_true',
                            help='Erase all')
        parser.add_argument('--erase_flash', default=False, required=False, action='store_true',
                            help='Erase flash')
        parser.add_argument('--erase_rram', default=False, required=False, action='store_true',
                            help='Erase RRAM')
    ...
    def do_create(cls, cfg, args):
        ...
        return AtmispBinaryRunner(cfg, device=args.device, atm_plat=args.atm_plat,
            ...
            erase_all=args.erase_all, erase_rram=args.erase_rram)
